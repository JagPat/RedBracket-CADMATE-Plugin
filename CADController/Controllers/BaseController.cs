...
namespace CADController.Controllers
{
    public abstract class BaseController
    {
        ...
        public ObjectDataSpecs objectData = new ObjectDataSpecs();
        public RelationshipDataSpecs relObjectData = new RelationshipDataSpecs();
      //  public DataTable SearchDrawingList = null;
      //  public Hashtable DrawingProperty = new Hashtable();
        //public WordDocManager wordDocMgr = new WordDocManager();
        //public void objItemInfo;
    //    public ItemInformation objItemInfo;
     //   public DrawingInfo drawingInfo;
    //    public SearchResult searchResult;
      //  public ObjectDataSpecs ObjectDataInfo;
        public IConnector objConnector = PLMConnectorFactory.getPLMConnector("Aras");

        public RBConnector ObjRBC = new RBConnector();
     //   public PLMObject itemObject = new PLMObject();
      //  public RelationshipNavigatorRequest drawingRel = new RelationshipNavigatorRequest();
      //  public List<RelationshipNavigatorRequest> relationship = new List<RelationshipNavigatorRequest>(); 
      //  public List<PLMObject> plmObjectList = new List<PLMObject>();
