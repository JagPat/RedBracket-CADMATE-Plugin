...
public:
  ...
  GcBr::ErrorStatus getArea(double& area, const double* tolRequired = NULL, double* tolAchieved = NULL) const;
  ...
  GcBr::ErrorStatus getSurfaceAsTrimmedNurbs(Gsoft::UInt32& numNurbs, GcGeExternalBoundedSurface**& ppNurbs) const;
