...
public:
  ...
  virtual TiffFormatCodec::TiffId getTiffId() const
  {
    return mTiffId;
  }
...
class GTIL_EXPORT TiffPhotometricInterpretation : public Gtil::FormatCodecExclusivePropertySetInterface,
                                                  public TiffProperty
{
public:
  enum Interpretation
...
public:
  TiffPageInformation(
    Gtil::StringBuffer* pDoc, Gtil::StringBuffer* pPage, int nPage, int nPages, double* pX, double* pY);
