...
#  define Gtil_min(a, b) (((a) < (b)) ? (a) : (b))
  ...
  typedef struct _GTIL_DATA128
  {
    ...
    bool operator==(const struct _GTIL_DATA128& rhs) const
    {
      return (value.ui.a == rhs.value.ui.a && value.ui.b == rhs.value.ui.b && value.ui.c == rhs.value.ui.c &&
              value.ui.d == rhs.value.ui.d);
    }
    bool operator!=(const struct _GTIL_DATA128& rhs) const
    {
      return (value.ui.a != rhs.value.ui.a || value.ui.b != rhs.value.ui.b || value.ui.c != rhs.value.ui.c ||
