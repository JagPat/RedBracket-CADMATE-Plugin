...
public:
  ...
  virtual void outputArc(
    Edge* edge, const Point3d& center, double radius, double startAngle, double endAngle, bool isVisible) = NULL;
};
...
public:
  ...
  virtual void outputTriStrip(Edge* edgeArray[], int arrayLength, bool firstTriangleIsCcw) = NULL;
};
