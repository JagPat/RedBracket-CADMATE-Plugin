...
public:
  ...
  {
    return new UnspecifiedSurface(*this);
  }
...
public:
  ...
  TorusSurface(const Line3d& axis, double majRadius, double minRadius, int majApprox, int minApprox, Body* b);
