...
public:
  ...
  double dist(Vector3d v) const
  {
    return (*this - v).length();
  }
  double distSqrd(Vector3d v) const
  {
    return (*this - v).lengthSqrd();
  }
  double distRect(Vector3d v) const
  {
    return (*this - v).lengthRect();
  }

  bool isEqual(Vector3d v, double epsSqrd = epsNorSqrd()) const
  {
    return (distSqrd(v) <= epsSqrd);
  }
  bool isEqualRect(Vector3d v, double epsRect = epsNor()) const
  {
  ...
  Vector2d toVector2d(int i1, int i2) const
  {
    return Vector2d((*this)[i1], (*this)[i2]);
  }
  Vector2d toVector2d(int dropCoord) const;

  operator GcGeVector3d&()
  {
    return *((GcGeVector3d*)this);
  }
  operator const GcGeVector3d&() const
  {
    return *((const GcGeVector3d*)this);
  }

  static Vector3d& cast(GcGeVector3d& v)
  {
    return *(Vector3d*)&v;
  }

  Vector3d(const GcGeVector3d& v)
  {
    *this = *(Vector3d*)&v;
  }
...
inline Vector3d& asVector3d(GcGeVector3d& v)
{
  return *(Vector3d*)&v;
}
