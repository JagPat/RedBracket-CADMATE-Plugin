...
public:
  ...
  operator GcGeMatrix3d&()
  {
    return *((GcGeMatrix3d*)this);
  }
  operator const GcGeMatrix3d&() const
  {
    return *((const GcGeMatrix3d*)this);
  }

  static Transf3d& cast(GcGeMatrix3d& m)
  {
    return *(Transf3d*)&m;
  }
  Transf3d(const GcGeMatrix3d& m)
  {
    *this = *(Transf3d*)&m;
  }
...
{
  c[0][1] = c[0][2] = c[0][3] = c[1][0] = c[1][2] = c[1][3] = c[2][0] = c[2][1] = c[2][3] = c[3][0] = c[3][1] =
    c[3][2] = 0.0;
