...
public:
  ...
  Face(const Point3d plg[],
       ...
       bool checkPlanarity,
       Body*);
  Face(Point3d p[], int numEdges, int type, bool checkPlanarity, Body*, Edge** createdEdges = NULL);
  ...
  void massProperties(const Body&, bool dae, bool dbe, double& perimeter, double& area, Point3d& centroid) const;
  ...
  void insertHoles(const std::vector<Face*>& holeFaces, Body* pBody, std::vector<Face*>& faces);
