...
class GE_DLLEXPIMPORT GcGeNurbCurve2d : public GcGeSplineEnt2d
{
public:
  GcGeNurbCurve2d();
  ...
  GcGeNurbCurve2d(int degree,
                  ...
                  Gsoft::Boolean isPeriodic = Gsoft::kFalse);
  GcGeNurbCurve2d(int degree, const GcGePolyline2d& fitPolyline, Gsoft::Boolean isPeriodic = Gsoft::kFalse);
  ...
  GcGeNurbCurve2d(const GcGePoint2dArray& fitPoints,
                  ...
                  const GcGeTol& fitTolerance = GcGeContext::gTol);
  GcGeNurbCurve2d(const GcGePoint2dArray& fitPoints, const GcGeTol& fitTolerance = GcGeContext::gTol);
  GcGeNurbCurve2d(const GcGePoint2dArray& fitPoints,
  ...
  GcGeNurbCurve2d(const GcGeCurve2d& curve, double epsilon = GcGeContext::gTol.equalPoint());
  ...
  Gsoft::Boolean getParamsOfC1Discontinuity(GcGeDoubleArray& params, const GcGeTol& tol = GcGeContext::gTol) const;
  Gsoft::Boolean getParamsOfG1Discontinuity(GcGeDoubleArray& params, const GcGeTol& tol = GcGeContext::gTol) const;
  ...
  Gsoft::Boolean setFitTangents(const GcGeVector2d& startTangent, const GcGeVector2d& endTangent);
  ...
  GcGeNurbCurve2d& setFitData(const GcGeKnotVector& fitKnots,
                              ...
                              const GcGeTol& fitTol = GcGeContext::gTol,
                              Gsoft::Boolean isPeriodic = Gsoft::kFalse);
  GcGeNurbCurve2d& setFitData(int degree, const GcGePoint2dArray& fitPoints, const GcGeTol& fitTol = GcGeContext::gTol);
