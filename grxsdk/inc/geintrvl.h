...
public:
  ...
  GE_DLLEXPIMPORT GcGeInterval(Gsoft::Boolean boundedBelow, double bound, double tol = 1.e-12);
  ...
  GE_DLLEXPIMPORT Gsoft::Boolean isOverlapAtUpper(const GcGeInterval& otherInterval, GcGeInterval& overlap) const;
  ...
  friend GE_DLLEXPIMPORT Gsoft::Boolean operator>(double val, const GcGeInterval& intrvl);
