...
public:
  ...
  virtual void getFacets(const GcRxObject* pO,
                         const GcRxMemberQueryContext* pContext,
                         GcArray<const GcRxClass*>& facets) = 0;
};
...
public:
  ...
  virtual void goodbye(const GcRxMember* pMember)
  {
    (pMember);
  }
};
...
public:
  ...
  static Gcad::ErrorStatus addOverrule(GcRxMember* pOverruledSubject,
                                       GcRxMemberOverrule* pOverrule,
