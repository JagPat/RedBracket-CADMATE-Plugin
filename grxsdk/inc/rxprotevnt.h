...
#define gcrxProtocolReactors \
  GcRxProtocolReactorManagerFactory::cast(gcrxServiceDictionary->at(GCRX_PROTOCOL_REACTOR_MANAGER))

#define GCRX_PROTOCOL_REACTOR_MANAGER_AT(gcrxClass) gcrxProtocolReactors->createReactorManager(gcrxClass)
