...
#define PROP_DISP_ENTRY2(dispid,            \
                         progid,            \
                         lpLeftIconRes,     \
                         lpLeftIconType,    \
                         lpEllipsisBmpRes,  \
...
#define END_PERPROPDISPLAY_MAP2()                                                                             \
  {                                                                                                           \
    -1, NULL, NULL, (UINT)PICTYPE_UNINITIALIZED, NULL, (UINT)PICTYPE_UNINITIALIZED, TEXTCOLOR_DEFAULT, false, \
      (DWORD)-1, -1                                                                                           \
  }                                                                                                           \
  }                                                                                                           \
  ;                                                                                                           \
...
public:
  ...
  STDMETHOD(dropCallback)(GcDbEntity* pEntity)
  {
    return E_NOTIMPL;
  }
  ...
  STDMETHOD(EndEdit)(VARIANT_BOOL bEditCancelled)
  {
    return E_NOTIMPL;
  }
  ...
  STDMETHOD(GetContextMenu)(INT_PTR nContextFlag, DWORD_PTR hMenu, UINT idCmdFirst, UINT idCmdLast, DWORD_PTR* pFlag)
  {
    return E_NOTIMPL;
  }
  STDMETHOD(GetCommandString)(UINT idCmd, BSTR* pbstrHelpText)
  {
    return E_NOTIMPL;
  }
  STDMETHOD(InvokeCommand)(UINT idCmd, DWORD_PTR hWnd)
  {
    return E_NOTIMPL;
  }
  ...
  STDMETHOD(EndMultipleEdit)(VARIANT tools, VARIANT stockToolIds, VARIANT_BOOL bEditCancelled)
  {
    return E_NOTIMPL;
  }

  STDMETHOD(MultipleEdit)(VARIANT tools, VARIANT stockToolIds, LONG_PTR hWndParent, VARIANT_BOOL* pRet)
  {
    return E_NOTIMPL;
  }

  STDMETHOD(Customize)
  (int nContextFlag, DWORD_PTR hMenu, UINT idCmdFirst, UINT idCmdLast, GUID* pPaletteId, DWORD* pFlag)
  {
    return E_NOTIMPL;
  }
  STDMETHOD(GetMenuHelp)(UINT idCmd, BSTR* pbstrHelpText)
  {
    return E_NOTIMPL;
  }

  STDMETHOD(InvokeMenuCommand)(UINT idCmd, GUID* pPaletteId, DWORD_PTR hWnd, DWORD* pFlag)
  {
    return E_NOTIMPL;
  }
  ...
  STDMETHOD(GetEllipsisBitMap)(VARIANT varId, IUnknown __RPC_FAR* __RPC_FAR* pBitMap)
  {
    return E_NOTIMPL;
  }

  STDMETHOD(GetPropHelpProc)(VARIANT varId, LONG __RPC_FAR* pHelpProc)
  {
    return E_NOTIMPL;
  }
  ...
  HRESULT PutToolProperty(int index, VARIANT vValue)
  {
    ...
    return pDisp->Invoke(
      m_ToolMap[index - 1].dispId, IID_NULL, LOCALE_USER_DEFAULT, wflags, &dispparams, NULL, NULL, NULL);
  }
  ...
  BOOL GetUnknownArrays(int nCount, IUnknown** pObjUnkArray, VARIANT* pStatUnkArray, VARIANT* pDynPMUnkArrays)
  {
    if (nCount < 1)
      return FALSE;
  ...
  BOOL GetAttribute(MSXML::IXMLDOMNode* pNode, LPCWSTR pszAttName, MSXML::IXMLDOMAttribute** ppChild)
  {
    if (ppChild == NULL)
      return FALSE;
  ...
  BOOL GetChildNode(MSXML::IXMLDOMNode* pNode, LPCWSTR pszNodeName, MSXML::IXMLDOMNode** ppChild)
  {
    try
    {
      if (ppChild == NULL)
  ...
  BOOL AddChildNode(MSXML::IXMLDOMNode* pNode, LPCWSTR pszChildNodeName, short nNodeType, MSXML::IXMLDOMNode** ppChild)
  {
    try
    {
      if (ppChild == NULL)
  ...
  inline BOOL GetAttributeValue(MSXML::IXMLDOMNode* pNode, LPCWSTR pszAttName, WCHAR (&pszValue)[nSize])
  {
    return GetAttributeValue(pNode, pszAttName, pszValue, nSize);
  }

  BOOL GetAttributeValue(MSXML::IXMLDOMNode* pNode, LPCWSTR pszAttName, LPWSTR pszValue, size_t nSize)
  {
    if (pNode == NULL || pszAttName == NULL)
      return FALSE;
  ...
  inline BOOL SetAttributeValue(MSXML::IXMLDOMNode* pNode, LPCWSTR pszAttName, double fValue)
  {
  ...
  virtual BOOL LoadPropertyValue(MSXML::IXMLDOMNode* pNode, int index)
  {
    ...
    if (dispColor == index)
    {
      ...
      if (GetChildNode(pNode, L"TrueColor", &pColorNode))
      {
        ...
        m_Color.setNames(wcslen(sColorName) ? sColorName : pNullName, wcslen(sColorBook) ? sColorBook : pNullName);
      }
      return TRUE;
    }
  ...
  GcTcTool* CreateToolATC(GcTcPackage* pPalette,
                          LPCWSTR szToolNameOverride = NULL,
                          ...
                          BOOL bImageFile = FALSE)
  {
    ...
    try
    {
      ...
      if (szToolImageOverride)
      {
        if (bImageFile)
          hBitmap =
            (HBITMAP)::LoadImage(NULL, szToolImageOverride, IMAGE_BITMAP, 0, 0, LR_CREATEDIBSECTION | LR_LOADFROMFILE);
        else
  ...
  {
    GcadToolImpl<TT, T, pclsid, szToolName, szToolImage>* pThisTool =
      (GcadToolImpl<TT, T, pclsid, szToolName, szToolImage>*)pGcadToolImpl;
  ...
  GcTcPackage* GetCustomShapePackage(GcTcCatalog* pCatalog, LPCWSTR szPackageName)
  {
    if (!pCatalog)
      return NULL;
  ...
  GcTcPackage* GetCustomShapePackage(GcTcCatalog* pCatalog, GUID szPackageID)
  {
    if (!pCatalog)
      return NULL;
    GcTcPackage* pPackage = NULL;
