...
public:
  ...
  virtual Gcad::ErrorStatus checkIn(GcDbObjectId transId, GcDbIdMapping& errorMap, bool keepObjs = false) = 0;

  virtual Gcad::ErrorStatus abortLongTransaction(GcDbObjectId transId, bool keepObjs = false) = 0;
