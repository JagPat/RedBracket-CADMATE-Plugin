...
DEFINE_GUID(IID_IOPMPropertyExtension, 0xbd2ecd8e, 0x0233, 0x44ff, 0xa4, 0x10, 0x1b, 0x8a, 0xd6, 0x5d, 0x3e, 0x57);
...
DEFINE_GUID(IID_IOPMPropertyExpander, 0x4bd84ec4, 0x00ca, 0x4f3c, 0xb0, 0xf5, 0xd2, 0x06, 0xc0, 0x2a, 0xb9, 0x36);
...
interface DECLSPEC_UUID("4BD84EC4-00CA-4F3C-B0F5-D206C02AB936") IOPMPropertyExpander : public IUnknown
{
  ...
  virtual HRESULT STDMETHODCALLTYPE GetElementStrings(
    DISPID dispID, OPMLPOLESTR __RPC_FAR * pCaStringsOut, OPMDWORD __RPC_FAR * pCaCookiesOut) = 0;
...
DEFINE_GUID(IID_IOPMPropertyExpander2, 0x84931618, 0x7e1a, 0x47de, 0xad, 0xb2, 0xd5, 0x60, 0x37, 0x31, 0xc7, 0x4e);
interface DECLSPEC_UUID("84931618-7E1A-47DE-ADB2-D5603731C74E") IOPMPropertyExpander2 : public IUnknown
{
  ...
  virtual HRESULT STDMETHODCALLTYPE GetElementValue(
    DISPID dispID, IUnknown * pUnk, DWORD dwCookie, VARIANT * pVarOut) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetElementValue(DISPID dispID, IUnknown * pUnk, DWORD dwCookie, VARIANT VarIn) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetElementStrings(
    DISPID dispID, IUnknown * pUnk, OPMLPOLESTR __RPC_FAR * pCaStringsOut, OPMDWORD __RPC_FAR * pCaCookiesOut) = 0;
...
DEFINE_GUID(
  IID_IOPMPropertyExpanderExpression, 0xc53a9535, 0xef52, 0x458a, 0xad, 0x9e, 0x56, 0x22, 0xca, 0x0c, 0x1d, 0xed);
...
interface DECLSPEC_UUID("C53A9535-EF52-458A-AD9E-5622CA0C1DED") IOPMPropertyExpanderExpression : public IUnknown
{
  ...
  virtual HRESULT STDMETHODCALLTYPE ExpressionAllowed(
    DISPID dispID, IUnknown * pUnk, DWORD dwCookie, BOOL * pAllowed) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE get_Expression(
    DISPID dispID, IUnknown * pUnk, DWORD dwCookie, BSTR * expression) = 0;
};
