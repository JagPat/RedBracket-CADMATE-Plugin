...
class GE_DLLEXPIMPORT GcGeNurbCurve3d : public GcGeSplineEnt3d
{
public:
  GcGeNurbCurve3d();
  ...
  GcGeNurbCurve3d(int degree,
                  ...
                  Gsoft::Boolean isPeriodic = Gsoft::kFalse);
  GcGeNurbCurve3d(int degree, const GcGePolyline3d& fitPolyline, Gsoft::Boolean isPeriodic = Gsoft::kFalse);
  ...
  GcGeNurbCurve3d(const GcGePoint3dArray& fitPoints,
                  ...
                  const GcGeTol& fitTolerance = GcGeContext::gTol);
  GcGeNurbCurve3d(const GcGePoint3dArray& fitPoints, const GcGeTol& fitTolerance = GcGeContext::gTol);
  GcGeNurbCurve3d(const GcGePoint3dArray& fitPoints,
  ...
  GcGeNurbCurve3d& setFitData(const GcGeKnotVector& fitKnots,
                              ...
                              const GcGeTol& fitTol = GcGeContext::gTol,
                              Gsoft::Boolean isPeriodic = Gsoft::kFalse);
  GcGeNurbCurve3d& setFitData(int degree, const GcGePoint3dArray& fitPoints, const GcGeTol& fitTol = GcGeContext::gTol);
