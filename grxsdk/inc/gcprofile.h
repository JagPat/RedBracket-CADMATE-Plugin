...
public:
  ...
  virtual void ProfileRegistryKey(GCHAR*& strRegProfileKey, const GCHAR* strProfileName) = 0;
  ...
  virtual Gcad::ErrorStatus FixedProfileStorage(GcApProfileStorage*& pStore, BOOL bCreateIfNotExists = TRUE) = 0;
  virtual int ProfileListNames(GcApProfileNameArray& nameList) = 0;
  virtual Gcad::ErrorStatus ProfileExport(const GCHAR* strProfileName, const GCHAR* exportFileName) = 0;
...
public:
  ...
  virtual Gcad::ErrorStatus CreateNode(const GCHAR* pszNodePath, IUnknown*& pUnknown) = 0;
  virtual Gcad::ErrorStatus GetNode(const GCHAR* pszNodePath, IUnknown*& pUnknown) = 0;
  virtual Gcad::ErrorStatus ReplaceNode(const GCHAR* pszNodePath, IUnknown* pUnknown) = 0;
