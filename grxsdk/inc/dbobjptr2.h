...
GCCORE_PORT Gcad::ErrorStatus accessGcDbObjectForRead(
  GcDbObject*& pObj, GcDbObjectId id, GcRxClass* (*pfDesc)(), bool& bWasOpened, bool bOpenErased);

template<class GCDB_CLASS>
inline Gcad::ErrorStatus accessGcDbObjectForRead(GCDB_CLASS*& pObj,
                                                 GcDbObjectId id,
                                                 bool& bWasOpened,
                                                 bool bOpenErased = false)
{
  return ::accessGcDbObjectForRead((GcDbObject*&)pObj, id, &GCDB_CLASS::desc, bWasOpened, bOpenErased);
};

template<>
inline Gcad::ErrorStatus accessGcDbObjectForRead<GcDbObject>(GcDbObject*& pObj,
                                                             GcDbObjectId id,
                                                             bool& bWasOpened,
                                                             bool bOpenErased)
{
  return ::accessGcDbObjectForRead(pObj, id, nullptr, bWasOpened, bOpenErased);
}
...
public:
  ...
  ReadableGcDbObject(GCDB_CLASS*& pObj, GcDbObjectId id, bool bOpenErased, bool enableNow = true)
  {
    if (enableNow)
  ...
  void enableRead(GCDB_CLASS*& pObj, GcDbObjectId id, bool bOpenErased)
  {
    revertRead();
    pObj = NULL;
    if (Gcad::eNotOpenForRead == mEs)
    {
      mEs = accessGcDbObjectForRead(pObj, id, mbWasOpened, bOpenErased);
...
private:
  ...
  ReadableGcDbObject(GcDbObjectId id, bool bOpenErased, bool enableNow = true) : mpObj(NULL), mEs(Gcad::eNotOpenForRead)
  {
    if (enableNow)
...
GCCORE_PORT Gcad::ErrorStatus accessGcDbObjectForWrite(
  GcDbObject* pObj, bool& bWasNotifyEnabled, bool& bWasWriteEnabled, int& readCountClosed, bool openOnLockedLayer);

GCCORE_PORT Gcad::ErrorStatus revertGcDbObjectFromWrite(
  GcDbObject* pObj, Gcad::ErrorStatus accessStatus, bool bWasNotifyEnabled, bool bWasWriteEnabled, int readCountClosed);

class WritableGcDbObject
{
public:
  WritableGcDbObject() : mbOpenOnLockedLayer(false)
  {
  }
  ...
  bool enableWrite()
  {
    ...
    if (NULL == mpObj)
      return false;
    mEs = accessGcDbObjectForWrite(mpObj, mbWasNotifyEnabled, mbWasWriteEnabled, mReadCountClosed, mbOpenOnLockedLayer);
    return isWritable();
  };
  ...
  void revertWrite()
  {
    if ((NULL != mpObj) && !mpObj->objectId().isNull())
      mEs = revertGcDbObjectFromWrite(mpObj, mEs, mbWasNotifyEnabled, mbWasWriteEnabled, mReadCountClosed);
    forget();
  };
...
template<class GCDB_CLASS>
inline GcDbSmartObjectPointer<GCDB_CLASS>::GcDbSmartObjectPointer() : mReadable(), mWritable()
{
}

template<class GCDB_CLASS>
inline GcDbSmartObjectPointer<GCDB_CLASS>::GcDbSmartObjectPointer(GcDbObjectId objId,
                                                                  GcDb::OpenMode mode,
                                                                  bool openErased,
                                                                  bool openOnLockedLayer)
  : mReadable(objId, openErased), mWritable(mReadable.object(), GcDb::kForWrite == mode, openOnLockedLayer)
{
}

template<class GCDB_CLASS>
inline GcDbSmartObjectPointer<GCDB_CLASS>::~GcDbSmartObjectPointer()
{
  mpObj = NULL;
}

template<class GCDB_CLASS>
inline Gcad::ErrorStatus GcDbSmartObjectPointer<GCDB_CLASS>::open(GcDbObjectId objId,
                                                                  GcDb::OpenMode mode,
                                                                  bool openErased,
                                                                  bool openOnLockedLayer)
{
...
template<class GCDB_CLASS>
inline const GCDB_CLASS* GcDbSmartObjectPointer<GCDB_CLASS>::object() const
{
...
template<class GCDB_CLASS>
inline GCDB_CLASS* GcDbSmartObjectPointer<GCDB_CLASS>::object()
{
  DbObjPtr_Assert(mReadable.object() == NULL || mReadable.isReadable());
  return mReadable.object();
}
...
template<class GCDB_CLASS>
inline const GCDB_CLASS* GcDbSmartObjectPointer<GCDB_CLASS>::operator->() const
{
  return object();
}

template<class GCDB_CLASS>
inline GCDB_CLASS* GcDbSmartObjectPointer<GCDB_CLASS>::operator->()
{
  return object();
}

template<class GCDB_CLASS>
inline GcDbSmartObjectPointer<GCDB_CLASS>::operator const GCDB_CLASS*() const
{
  return object();
}
...
#if DBOBJPTR_EXPOSE_PTR_REF
template<class GCDB_CLASS>
inline GcDbSmartObjectPointer<GCDB_CLASS>::operator GCDB_CLASS*&()
{
  mWritable.forget();
...
template<class GCDB_CLASS>
inline Gcad::ErrorStatus GcDbSmartObjectPointer<GCDB_CLASS>::openStatus() const
{
  return (mWritable.isWritable() || ((mWritable.statusCode() != Gcad::eNullObjectPointer) &&
...
template<class GCDB_CLASS>
inline Gcad::ErrorStatus GcDbSmartObjectPointer<GCDB_CLASS>::acquire(GCDB_CLASS*& pObjToAcquire)
{
  closeInternal();
...
template<class GCDB_CLASS>
inline Gcad::ErrorStatus GcDbSmartObjectPointer<GCDB_CLASS>::release(GCDB_CLASS*& pReleasedObj)
{
...
template<class GCDB_CLASS>
inline Gcad::ErrorStatus GcDbSmartObjectPointer<GCDB_CLASS>::close()
{
  closeInternal();
  return Gcad::eOk;
}
...
template<class GCDB_CLASS>
inline Gcad::ErrorStatus GcDbSmartObjectPointer<GCDB_CLASS>::create()
{
...
template<class GCDB_CLASS>
inline Gcad::ErrorStatus GcDbSmartObjectPointer<GCDB_CLASS>::closeInternal()
{
...
template<class GCDB_CLASS>
inline GcDbSmartObjectPointer<GCDB_CLASS>::GcDbSmartObjectPointer(GCDB_CLASS* pObject)
{
  acquire(pObject);
}

template<class GCDB_CLASS>
inline void GcDbSmartObjectPointer<GCDB_CLASS>::operator=(GCDB_CLASS* pObject)
{
  acquire(pObject);
}
