...
namespace GcEdSymbolUtilities
{
  ...
  public:
    ...
    virtual Gcad::PromptStatus getCompatibleSymbolString(GCHAR*& pResponse,
                                                         const GCHAR* prompt,
                                                         GcDbDatabase* pDb) const = 0;

    virtual Gcad::PromptStatus getSymbolString(GCHAR*& pResponse,
                                               const GCHAR* prompt,
...
#define GCEDSYMUTIL_SERVICESNAME_WITH_VERSION(n, v) GCEDSYMUTIL_SERVICESNAME_WITH_VERSION_1(n, v)
#define GCEDSYMUTIL_SERVICES_NAME \
  GCEDSYMUTIL_SERVICESNAME_WITH_VERSION(servicesPtr, GCEDSYMUTIL_SERVICES_CURRENT_VERSION)
