...
public:
  GcDbText();
  GcDbText(const GcGePoint3d& position,
           const GCHAR* text,
...
public:
  ...
  GcDbAttributeDefinition(const GcGePoint3d& position,
                          const GCHAR* text,
                          const GCHAR* tag,
                          const GCHAR* prompt,
                          GcDbObjectId style = GcDbObjectId::kNull);
...
public:
  GcDbAttribute();
  GcDbAttribute(const GcGePoint3d& position,
                const GCHAR* text,
                const GCHAR* tag,
                GcDbObjectId style = GcDbObjectId::kNull);
  ~GcDbAttribute();
  ...
  Gcad::ErrorStatus setAttributeFromBlock(const GcDbAttributeDefinition* pAttdef, const GcGeMatrix3d& blkXform);
...
public:
  GcDbBlockReference();
  GcDbBlockReference(const GcGePoint3d& position, GcDbObjectId blockTableRec);
  ~GcDbBlockReference();
  ...
  Gcad::ErrorStatus openAttribute(GcDbAttribute*&, GcDbObjectId, GcDb::OpenMode, bool openErasedOne = false);
  ...
  Gcad::ErrorStatus geomExtentsBestFit(GcDbExtents& extents,
...
public:
  GcDbMInsertBlock();
  GcDbMInsertBlock(const GcGePoint3d& position,
...
public:
  ...
  GcDb2dVertex(const GcGePoint3d& position,
               double bulge = 0,
               double startWidth = 0,
               double endWidth = 0,
               double tangent = 0,
...
public:
  GcDbFaceRecord();
  GcDbFaceRecord(Gsoft::Int16 vtx0, Gsoft::Int16 vtx1, Gsoft::Int16 vtx2, Gsoft::Int16 vtx3);
  ~GcDbFaceRecord();
  GCDB_DECLARE_MEMBERS(GcDbFaceRecord);

  Gcad::ErrorStatus getVertexAt(Gsoft::UInt16 faceIdx, Gsoft::Int16& vtxIdx) const;
  Gcad::ErrorStatus setVertexAt(Gsoft::UInt16 faceIdx, Gsoft::Int16 vtxIdx);
  Gcad::ErrorStatus isEdgeVisibleAt(Gsoft::UInt16 faceIndex, Gsoft::Boolean& visible) const;
...
public:
  ...
  GcDb2dPolyline(GcDb::Poly2dType type,
  ...
  Gcad::ErrorStatus splineFit(GcDb::Poly2dType splineType, Gsoft::Int16 splineSegs);
  ...
  Gcad::ErrorStatus insertVertexAt(const GcDb2dVertex* pIndexVert, GcDb2dVertex* pNewVertex);
  Gcad::ErrorStatus insertVertexAt(GcDbObjectId& newVertId, const GcDbObjectId& indexVertId, GcDb2dVertex* pNewVertex);
  Gcad::ErrorStatus openVertex(GcDb2dVertex*&, GcDbObjectId vertId, GcDb::OpenMode, bool openErasedOne = false) const;
  Gcad::ErrorStatus openSequenceEnd(GcDbSequenceEnd*&, GcDb::OpenMode);
...
public:
  ...
  GcDb3dPolyline(GcDb::Poly3dType, GcGePoint3dArray& vertices, Gsoft::Boolean closed = Gsoft::kFalse);
  ...
  Gcad::ErrorStatus insertVertexAt(const GcDb3dPolylineVertex* pIndexVert, GcDb3dPolylineVertex* pNewVertex);
  Gcad::ErrorStatus insertVertexAt(GcDbObjectId& newVertId,
                                   const GcDbObjectId& indexVertId,
                                   GcDb3dPolylineVertex* pNewVertex);
  Gcad::ErrorStatus openVertex(GcDb3dPolylineVertex*&, GcDbObjectId vertId, GcDb::OpenMode, bool openErasedOne = false);
  Gcad::ErrorStatus openSequenceEnd(GcDbSequenceEnd*&, GcDb::OpenMode);
  GcDbObjectIterator* vertexIterator() const;
...
public:
  GcDbArc();
  GcDbArc(const GcGePoint3d& center, double radius, double startAngle, double endAngle);
  GcDbArc(const GcGePoint3d& center, const GcGeVector3d& normal, double radius, double startAngle, double endAngle);
  ~GcDbArc();
...
public:
  ...
  Gcad::ErrorStatus getOffsetCurvesGivenPlaneNormal(const GcGeVector3d& normal,
                                                    double offsetDist,
...
public:
  ...
  Gcad::ErrorStatus openVertex(GcDbPolygonMeshVertex*&,
                               GcDbObjectId vertId,
                               GcDb::OpenMode,
...
public:
  GcDbSolid();
  GcDbSolid(const GcGePoint3d& pt0, const GcGePoint3d& pt1, const GcGePoint3d& pt2, const GcGePoint3d& pt3);
  GcDbSolid(const GcGePoint3d& pt0, const GcGePoint3d& pt1, const GcGePoint3d& pt2);
  ~GcDbSolid();
...
public:
  GcDbTrace();
  GcDbTrace(const GcGePoint3d& pt0, const GcGePoint3d& pt1, const GcGePoint3d& pt2, const GcGePoint3d& pt3);
  ~GcDbTrace();
...
public:
  GcDbShape();
  GcDbShape(const GcGePoint3d& position, double size, double rotation = 0, double widthFactor = 0);
  ~GcDbShape();
...
public:
  ...
  Gcad::ErrorStatus setFastZoomOn()
  {
    return Gcad::eOk;
  }
  Gcad::ErrorStatus setFastZoomOff()
  {
    return Gcad::eOk;
  }
  ...
  void subObjModified(const GcDbObject* pDbObj, const GcDbObject* pSubObj) override;
