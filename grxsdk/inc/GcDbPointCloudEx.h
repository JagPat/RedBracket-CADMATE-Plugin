...
public:
  ...
  Gcad::ErrorStatus getPointDataByPointCount(IGcDbPointCloudDataBuffer*& pointData,
                                             Gsoft::UInt32 pointCount,
                                             IGcDbPointCloudSpatialFilter* pSpatialFilter,
                                             IGcDbPointCloudAttributeFilter* pAttributeFilter,
                                             Gsoft::UInt32 dataTypes,
                                             Gsoft::UInt32 maxPointLimitation) const;

  Gcad::ErrorStatus traverseAllPointData(IGcDbPointCloudPointProcessor* processor,
                                         IGcDbPointCloudSpatialFilter* pSpatialFilter,
                                         Gsoft::UInt32 dataTypes,
                                         int LODLevel) const;
  ...
  Gcad::ErrorStatus getCandidatePlane(const class CPoint& pt,
                                      GcGePlane& result,
                                      double& distToEdge,
                                      double& objWidth,
                                      double& objHeight,
                                      void*& context) const;
  Gcad::ErrorStatus getCylinderAt(const GcGeMatrix3d& viewXform,
  ...
  Gcad::ErrorStatus getPointDataByPrecision(IGcDbPointCloudDataBuffer*& pointData,
                                            double distPrecision,
                                            IGcDbPointCloudSpatialFilter* pSpatialFilter = NULL,
                                            IGcDbPointCloudAttributeFilter* pAttributeFilter = NULL,
                                            Gsoft::UInt32 dataTypes = 0,
                                            Gsoft::UInt32 maxPointLimitation = 1000000uLL) const;

  Gcad::ErrorStatus getEstimatedPointCountByPrecision(unsigned long long& pointCount,
                                                      double distPrecision,
                                                      IGcDbPointCloudSpatialFilter* pSpatialFilter = NULL,
                                                      IGcDbPointCloudAttributeFilter* pAttributeFilter = NULL) const;
  ...
  Gcad::ErrorStatus getCylinderAt(const GcGeMatrix3d& viewXform,
                                  const GcGePoint3d& pickPt,
                                  GcPointCloudExtractedCylinder& extractedCylinder);
  Gcad::ErrorStatus detectPointBelonger(const GcGePoint3d& ptInWCS,
                                        GcString& scanGuid,
                                        Gsoft::UInt16& segmentIndex) const;
  Gcad::ErrorStatus getPointDataBySegment(IGcDbPointCloudDataBuffer*& pointData,
                                          const GcString& scanGuid,
                                          Gsoft::UInt16 nSegmentIndex,
                                          Gsoft::UInt32 nExpectedCount) const;
  Gcad::ErrorStatus getPointDataByPointCount(IGcDbPointCloudDataBuffer*& pointData,
                                             Gsoft::UInt32 pointCount,
                                             const GcArray<GcString>& arrScanGuids,
                                             IGcDbPointCloudSpatialFilter* pSpatialFilter,
                                             IGcDbPointCloudAttributeFilter* pAttributeFilter,
                                             Gsoft::UInt32 dataTypes,
                                             Gsoft::UInt32 maxPointLimitation) const;
  Gcad::ErrorStatus traverseAllPointData(IGcDbPointCloudPointProcessor* processor,
                                         ...
                                         Gsoft::UInt32 dataTypes,
                                         int LODLevel,
                                         const GcArray<GcString>& arrScanGuids) const;
