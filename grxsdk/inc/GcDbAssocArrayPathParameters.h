...
public:
  ...
  DBCONSTRAINTS_PORT GcDbAssocArrayPathParameters(double itemSpacing = 1,
                                                  double rowSpacing = 1,
  ...
  DBCONSTRAINTS_PORT Gcad::ErrorStatus setItemSpacing(double offset,
                                                      const GcString& expression = GcString(),
                                                      const GcString& evaluatorId = GcString(),
                                                      GcString& errorMessage = dummyString());
  ...
  DBCONSTRAINTS_PORT Gcad::ErrorStatus setStartOffset(double startOffset,
                                                      const GcString& expression = GcString(),
                                                      const GcString& evaluatorId = GcString(),
                                                      GcString& errorMessage = dummyString());
  DBCONSTRAINTS_PORT Gcad::ErrorStatus setEndOffset(double endOffset,
                                                    const GcString& expression = GcString(),
                                                    const GcString& evaluatorId = GcString(),
                                                    GcString& errorMessage = dummyString());
