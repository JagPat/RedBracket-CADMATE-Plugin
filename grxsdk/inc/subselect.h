...
public:
  ...
  virtual bool selectEntity(const GcGePoint3d& wvpt,
  ...
  virtual SubSelectStatus subSelectEntity(const GcGePoint3d& wpt1,
  ...
  virtual SubSelectStatus subSelectEntity(const resbuf* pResbuf,
                                          bool bAugment,
                                          bool bIsInPickfirstSet,
                                          bool bEvery,
                                          const GcGiViewport* pCurVP,
