...
#define GCTCUI_CVSTYLE_NO_OPERATIONS                                                                             \
  (GCTCUI_CVSTYLE_NO_CUT | GCTCUI_CVSTYLE_NO_COPY | GCTCUI_CVSTYLE_NO_PASTE | GCTCUI_CVSTYLE_NO_REFRESH |        \
   GCTCUI_CVSTYLE_NO_REMOVE | GCTCUI_CVSTYLE_NO_RENAME | GCTCUI_CVSTYLE_NO_PROPERTIES | GCTCUI_CVSTYLE_NO_HELP | \
...
#define GCTCUI_DDO_ACCEPT_ALL_ITEMS                                                                               \
  (GCTCUI_DDO_ACCEPT_TOOL | GCTCUI_DDO_ACCEPT_STOCKTOOL | GCTCUI_DDO_ACCEPT_PALETTE | GCTCUI_DDO_ACCEPT_PACKAGE | \
   GCTCUI_DDO_ACCEPT_CATEGORY | GCTCUI_DDO_ACCEPT_CATALOG | GCTCUI_DDO_ACCEPT_FILES)
...
public:
  ...
  BOOL Create(
    DWORD dwWndStyle, DWORD dwCatalogViewStyle, const RECT& rect, CWnd* pParent, UINT nID = GCTCUI_IDW_CATALOGVIEW);
