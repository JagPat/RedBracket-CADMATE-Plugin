...
#  define GET_OPM_PERINSTANCE_CREATE_PROTOCOL()   \
    OPMPerInstancePropertyExtensionFactory::cast( \
      GcDbDatabase::desc()->queryX(OPMPerInstancePropertyExtensionFactory::desc()))
...
public:
  ...
  virtual OPMPropertyExtension* CreateOPMObjectProtocol(GcRxClass* pClass, LONG lReserved = 0) = 0;
  virtual OPMPropertyExtension* CreateOPMCommandProtocol(const GCHAR* pGlobalCommand, LONG lReserved = 0) = 0;
  ...
  virtual LONG GetPropertyClassArray(GcRxClass* pClass, IDynamicProperty** pPropertyArray) = 0;
  virtual BOOL GetPropertyCountEx(GcRxClass* pClass, LONG* pPropCount) = 0;
  virtual LONG GetPropertyClassArray(GcRxClass* pClass, IUnknown** pPropertyArray) = 0;
};
...
interface DECLSPEC_UUID("10405817-B139-4823-92A3-CBCD589B9555") IDynamicPropertyNotify : public IUnknown
{
  BEGIN_INTERFACE
...
interface DECLSPEC_UUID("543B208B-5794-49A0-B954-1C611AE5EE1B") IDynamicPropertyNotify2 : public IUnknown
{
  BEGIN_INTERFACE
...
interface DECLSPEC_UUID("0D719069-D834-4E87-A33A-94F0439F3414") IDynamicProperty : public IUnknown
{
  BEGIN_INTERFACE
  ...
  STDMETHOD(IsPropertyEnabled)(THIS_ LONG_PTR objectID, BOOL * pbEnabled) PURE;
  ...
  STDMETHOD(GetCurrentValueData)(THIS_ LONG_PTR objectID, VARIANT * pvarData) PURE;
  STDMETHOD(SetCurrentValueData)(THIS_ LONG_PTR objectID, const VARIANT varData) PURE;
...
interface DECLSPEC_UUID("EECC66E7-AFA2-4296-A62C-C08FCAF718A9") IDynamicProperty2 : public IUnknown
{
  BEGIN_INTERFACE
  ...
  STDMETHOD(GetGUID)(THIS_ GUID * propGUID) PURE;
  STDMETHOD(GetDisplayName)(THIS_ BSTR * bstrName) PURE;
  STDMETHOD(IsPropertyEnabled)(THIS_ IUnknown * pUnk, BOOL * pbEnabled) PURE;
  STDMETHOD(IsPropertyReadOnly)(THIS_ BOOL * pbReadonly) PURE;
  STDMETHOD(GetDescription)(THIS_ BSTR * bstrName) PURE;

  STDMETHOD(GetCurrentValueName)(THIS_ BSTR * pbstrName) PURE;
  STDMETHOD(GetCurrentValueType)(THIS_ VARTYPE * pVarType) PURE;
  STDMETHOD(GetCurrentValueData)(THIS_ IUnknown * pUnk, VARIANT * pvarData) PURE;
  STDMETHOD(SetCurrentValueData)(THIS_ IUnknown * pUnk, const VARIANT varData) PURE;
...
interface DECLSPEC_UUID("D9760FCD-9D66-4BFE-AB0E-9A6550951E18") IDynamicEnumProperty : public IUnknown
{
  BEGIN_INTERFACE
  ...
  STDMETHOD(GetPropValueName)(THIS_ LONG index, BSTR * valueName) PURE;
  STDMETHOD(GetPropValueData)(THIS_ LONG index, VARIANT * valueName) PURE;
};
...
interface DECLSPEC_UUID("353F45C6-F17E-4F98-9B5A-4B25E2C6CE49") IDynamicDialogProperty : public IUnknown
{
  BEGIN_INTERFACE
...
interface DECLSPEC_UUID("7FDD1FA7-4001-4A27-8B28-073ED84FD0FD") IPropertyManager : public IUnknown
{
  BEGIN_INTERFACE
  STDMETHOD(QueryInterface)(THIS_ REFIID riid, LPVOID FAR * ppvObj) PURE;
  STDMETHOD_(ULONG, AddRef)(THIS) PURE;
  ...
  STDMETHOD(GetDynamicProperty)(THIS_ LONG index, IDynamicProperty * *pProperty) PURE;
  STDMETHOD(GetDynamicPropertyByName)(THIS_ BSTR propName, IDynamicProperty * *pProperty) PURE;
  STDMETHOD(GetDynamicPropertyCount)(THIS_ LONG * count) PURE;
  STDMETHOD(GetDynamicClassInfo)(THIS_ IUnknown * pObj, ITypeInfo * *pptiDynamic, DWORD * dwCookie) PURE;
};
...
interface DECLSPEC_UUID("8E32EFFA-569B-42BB-B621-D1DA91740826") IPropertyManager2 : public IUnknown
{
  BEGIN_INTERFACE
  STDMETHOD(QueryInterface)(THIS_ REFIID riid, LPVOID FAR * ppvObj) PURE;
  STDMETHOD_(ULONG, AddRef)(THIS) PURE;
  ...
  STDMETHOD(GetDynamicProperty)(THIS_ LONG index, IUnknown * *pDynPropObj) PURE;
  STDMETHOD(GetDynamicPropertyByName)(THIS_ BSTR propName, IUnknown * *pDynPropObj) PURE;
...
interface DECLSPEC_UUID("6B17A109-451F-460F-B9DE-986C538749C7") IPropertySource : public IUnknown
{
  BEGIN_INTERFACE
...
interface DECLSPEC_UUID("7F943EF6-E596-436D-BB16-65790657C172") IFilterableProperty : public IUnknown
{
  BEGIN_INTERFACE
  STDMETHOD(QueryInterface)(THIS_ REFIID riid, LPVOID FAR * ppvObj) PURE;
  STDMETHOD_(ULONG, AddRef)(THIS) PURE;
  ...
  STDMETHOD(ShowFilterableProperty)(THIS_ DISPID dispID, GcFilterablePropertyContext context, BOOL * pbShow) PURE;
};
...
interface DECLSPEC_UUID("13FC8D4D-E549-41E1-ADB0-06FF6175BCA4") IFilterablePropertySource : public IUnknown
{
  BEGIN_INTERFACE
  STDMETHOD(QueryInterface)(THIS_ REFIID riid, LPVOID FAR * ppvObj) PURE;
  STDMETHOD_(ULONG, AddRef)(THIS) PURE;
...
DEFINE_GUID(
  IID_IFilterableMultiplePropertySource, 0xa27aee79, 0x80d7, 0x4b71, 0xbb, 0x4a, 0xc6, 0xc0, 0x23, 0xce, 0xa1, 0xa7);

interface DECLSPEC_UUID("A27AEE79-80D7-4B71-BB4A-C6C023CEA1A7") IFilterableMultiplePropertySource : public IUnknown
{
  BEGIN_INTERFACE
  STDMETHOD(QueryInterface)(THIS_ REFIID riid, LPVOID FAR * ppvObj) PURE;
  STDMETHOD_(ULONG, AddRef)(THIS) PURE;
...
DEFINE_GUID(
  IID_IFilterableSubtypePropertySource, 0xda1e83eb, 0x6255, 0x46a9, 0xbb, 0xb4, 0xfb, 0xdc, 0x2a, 0x79, 0xcf, 0x16);

interface DECLSPEC_UUID("DA1E83EB-6255-46A9-BBB4-FBDC2A79CF16") IFilterableSubtypePropertySource : public IUnknown
{
  BEGIN_INTERFACE
  STDMETHOD(QueryInterface)(THIS_ REFIID riid, LPVOID FAR * ppvObj) PURE;
  STDMETHOD_(ULONG, AddRef)(THIS) PURE;
  ...
  STDMETHOD(GetSubtypeName)(THIS_ BSTR bstrSubtypeGUID, BSTR * bstrSubtypeName) PURE;

  STDMETHOD(GetSubtypeProperties)(THIS_ BSTR bstrSubtypeGUID, VARIANT * pPropertyArray) PURE;

  STDMETHOD(GetObjectSubtype)(THIS_ IUnknown * pObject, BSTR * bstrSubtypeGUID) PURE;
};
