...
class GE_DLLEXPIMPORT GcGeEntity2d
{
public:
  ~GcGeEntity2d();
  ...
  Gsoft::Boolean isEqualTo(const GcGeEntity2d& entity, const GcGeTol& tol = GcGeContext::gTol) const;
  GcGeEntity2d& transformBy(const GcGeMatrix2d& xfm);
  GcGeEntity2d& translateBy(const GcGeVector2d& translateVec);
  GcGeEntity2d& rotateBy(double angle, const GcGePoint2d& wrtPoint = GcGePoint2d::kOrigin);
  GcGeEntity2d& mirror(const GcGeLine2d& line);
  GcGeEntity2d& scaleBy(double scaleFactor, const GcGePoint2d& wrtPoint = GcGePoint2d::kOrigin);
...
inline GcGeEntity2d* GcGeEntity2d::newEntity2d(GcGeImpEntity3d* impEnt) const
{
