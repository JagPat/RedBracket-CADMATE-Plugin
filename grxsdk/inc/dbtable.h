...
public:
  ...
  GSOFT_DEPRECATED virtual GcDb::LineWeight gridLineWeight(GcDb::GridLineType gridlineType,
                                                           GcDb::RowType type = GcDb::kDataRow) const;
  GSOFT_DEPRECATED virtual Gcad::ErrorStatus setGridLineWeight(GcDb::LineWeight lwt, int nBorders, int nRows);

  GSOFT_DEPRECATED virtual GcCmColor gridColor(GcDb::GridLineType gridlineType,
                                               GcDb::RowType type = GcDb::kDataRow) const;
  GSOFT_DEPRECATED virtual Gcad::ErrorStatus setGridColor(const GcCmColor& color, int nBorders, int nRows);

  GSOFT_DEPRECATED virtual GcDb::Visibility gridVisibility(GcDb::GridLineType gridlineType,
                                                           GcDb::RowType type = GcDb::kDataRow) const;
  ...
  virtual Gcad::ErrorStatus getCellExtents(int row, int col, bool isOuterCell, GcGePoint3dArray& pts) const;
  ...
  Gcad::ErrorStatus getDataType(int row, int col, GcValue::DataType& nDataType, GcValue::UnitType& nUnitType) const;
  Gcad::ErrorStatus setDataType(int row, int col, GcValue::DataType nDataType, GcValue::UnitType nUnitType);
  GcValue value(int row, int col) const;
  Gcad::ErrorStatus setValue(int row, int col, const GcValue& val);
  Gcad::ErrorStatus setValue(int row, int col, const wchar_t* pszText, GcValue::ParseOption nOption);
  ...
  virtual Gcad::ErrorStatus textString(int row, int col, GcValue::FormatOption nOption, GcString& sText) const;
  virtual Gcad::ErrorStatus setTextString(int row, int col, const GCHAR* text);
  ...
  virtual Gcad::ErrorStatus setTextStyle(int row, int col, const GcDbObjectId& id);
  ...
  virtual Gcad::ErrorStatus setBlockTableRecordId(int row, int col, const GcDbObjectId& blkId, bool autoFit = false);
  ...
  virtual Gcad::ErrorStatus getBlockAttributeValue(int row, int col, const GcDbObjectId& attdefId, GCHAR*& value) const;
  virtual Gcad::ErrorStatus setBlockAttributeValue(int row, int col, const GcDbObjectId& attdefId, const GCHAR* value);

  virtual GcCmColor gridColor(int row, int col, GcDb::CellEdgeMask iEdge) const;
  virtual Gcad::ErrorStatus setGridColor(int row, int col, short nEdges, const GcCmColor& color);

  virtual GcDb::Visibility gridVisibility(int row, int col, GcDb::CellEdgeMask iEdge) const;
  virtual Gcad::ErrorStatus setGridVisibility(int row, int col, short nEdges, GcDb::Visibility value);

  virtual GcDb::LineWeight gridLineWeight(int row, int col, GcDb::CellEdgeMask iEdge) const;
  virtual Gcad::ErrorStatus setGridLineWeight(int row, int col, short nEdges, GcDb::LineWeight value);
  ...
  virtual bool isMergedCell(
    int row, int col, int* minRow = NULL, int* maxRow = NULL, int* minCol = NULL, int* maxCol = NULL) const;
  ...
  virtual Gcad::ErrorStatus getCellExtents(
    int row, int col, double& cellWidth, double& cellHeight, bool bAdjustForMargins) const;
  ...
  Gcad::ErrorStatus moveContent(int nRow, int nCol, int nFromIndex, int nToIndex);
  ...
  GcValue value(int row, int col, int nContent, GcValue::FormatOption nOption) const;
  Gcad::ErrorStatus setValue(int row, int col, int nContent, const GcValue& val);
  Gcad::ErrorStatus setValue(int row, int col, int nContent, const GcValue& val, GcValue::ParseOption nOption);
  Gcad::ErrorStatus setValue(int row, int col, int nContent, const wchar_t* pszText, GcValue::ParseOption nOption);
  GcString dataFormat(int row, int col) const;
  GcString dataFormat(int row, int col, int nContent) const;
  Gcad::ErrorStatus setDataFormat(int row, int col, const GCHAR* pszFormat);
  Gcad::ErrorStatus setDataFormat(int row, int col, int nContent, const GCHAR* pszFormat);
  GcString textString(int row, int col, int nContent) const;
  Gcad::ErrorStatus textString(int row, int col, int nContent, GcValue::FormatOption nOption, GcString& sText) const;
  Gcad::ErrorStatus setTextString(int row, int col, int nContent, const GCHAR* text);
  bool hasFormula(int nRow, int nCol, int nContent) const;
  GcString getFormula(int nRow, int nCol, int nContent) const;
  Gcad::ErrorStatus setFormula(int nRow, int nCol, int nContent, const GCHAR* pszFormula);
  GcDbObjectId fieldId(int row, int col, int nContent) const;
  Gcad::ErrorStatus setFieldId(int row, int col, int nContent, const GcDbObjectId& fieldId, GcDb::CellOption nFlag);
  GcDbObjectId blockTableRecordId(int row, int col, int nContent) const;
  Gcad::ErrorStatus setBlockTableRecordId(int row, int col, int nContent, const GcDbObjectId& blkId, bool autoFit);
  Gcad::ErrorStatus getBlockAttributeValue(
    int row, int col, int nContent, const GcDbObjectId& attdefId, GCHAR*& value) const;
  Gcad::ErrorStatus setBlockAttributeValue(
    int row, int col, int nContent, const GcDbObjectId& attdefId, const GCHAR* value);
  int getCustomData(int nRow, int nCol) const;
  Gcad::ErrorStatus setCustomData(int nRow, int nCol, int nData);
  Gcad::ErrorStatus getCustomData(int nRow, int nCol, const GCHAR* pszKey, GcValue* pData) const;
  Gcad::ErrorStatus setCustomData(int nRow, int nCol, const GCHAR* pszKey, const GcValue* pData);
  ...
  Gcad::ErrorStatus setMargin(int nRow, int nCol, GcDb::CellMargin nMargins, double fMargin);
  GcGePoint3d attachmentPoint(int row, int col, int content) const;
  GcCmColor contentColor(int row, int col, int nContent) const;
  Gcad::ErrorStatus setContentColor(int row, int col, int nContent, const GcCmColor& color);
  Gcad::ErrorStatus getDataType(
    int row, int col, int nContent, GcValue::DataType& nDataType, GcValue::UnitType& nUnitType) const;
  Gcad::ErrorStatus setDataType(
    int row, int col, int nContent, GcValue::DataType nDataType, GcValue::UnitType nUnitType);
  GcDbObjectId textStyle(int row, int col, int nContent) const;
  Gcad::ErrorStatus setTextStyle(int row, int col, int nContent, const GcDbObjectId& id);
  double textHeight(int row, int col, int nContent) const;
  Gcad::ErrorStatus setTextHeight(int row, int col, int nContent, double height);
  ...
  Gcad::ErrorStatus setRotation(int row, int col, int nContent, double fAngle);
  bool isAutoScale(int row, int col, int nContent) const;
  Gcad::ErrorStatus setAutoScale(int row, int col, int nContent, bool autoFit);
  double scale(int row, int col, int nContent) const;
  Gcad::ErrorStatus setScale(int row, int col, int nContent, double scale);
  ...
  GcDb::GridProperty getOverride(int nRow, int nCol, GcDb::GridLineType nGridLineType) const;
  Gcad::ErrorStatus setOverride(int nRow, int nCol, int nContent, GcDb::CellProperty nOverride);
  Gcad::ErrorStatus setOverride(int nRow, int nCol, GcDb::GridLineType nGridLineType, GcDb::GridProperty nOverride);
  Gcad::ErrorStatus removeAllOverrides(int nRow, int nCol);
  GcDb::GridLineStyle gridLineStyle(int nRow, int nCol, GcDb::GridLineType nGridLineType) const;
  Gcad::ErrorStatus setGridLineStyle(int nRow,
                                     int nCol,
                                     GcDb::GridLineType nGridLineTypes,
                                     GcDb::GridLineStyle nLineStyle);
  GcDb::LineWeight gridLineWeight(int nRow, int nCol, GcDb::GridLineType nGridLineType) const;
  Gcad::ErrorStatus setGridLineWeight(int nRow,
                                      int nCol,
                                      GcDb::GridLineType nGridLineTypes,
                                      GcDb::LineWeight nLineWeight);
  GcDbObjectId gridLinetype(int nRow, int nCol, GcDb::GridLineType nGridLineType) const;
  Gcad::ErrorStatus setGridLinetype(int nRow,
                                    int nCol,
                                    GcDb::GridLineType nGridLineTypes,
                                    const GcDbObjectId& idLinetype);
  GcCmColor gridColor(int nRow, int nCol, GcDb::GridLineType nGridLineType) const;
  Gcad::ErrorStatus setGridColor(int nRow, int nCol, GcDb::GridLineType nGridlineTypes, const GcCmColor& color);
  GcDb::Visibility gridVisibility(int nRow, int nCol, GcDb::GridLineType nGridLineType) const;
  Gcad::ErrorStatus setGridVisibility(int nRow,
                                      int nCol,
                                      GcDb::GridLineType nGridLineTypes,
                                      GcDb::Visibility nVisibility);
  double gridDoubleLineSpacing(int nRow, int nCol, GcDb::GridLineType nGridLineType) const;
  Gcad::ErrorStatus setGridDoubleLineSpacing(int nRow, int nCol, GcDb::GridLineType nGridLineTypes, double fSpacing);
  ...
  Gcad::ErrorStatus getDataLink(int nRow, int nCol, GcDbDataLink*& pDataLink, GcDb::OpenMode mode) const;
  int getDataLink(const GcCellRange* pRange, GcDbObjectIdArray& dataLinkIds) const;
  Gcad::ErrorStatus setDataLink(int nRow, int nCol, const GcDbObjectId& idDataLink, bool bUpdate);
  ...
  Gcad::ErrorStatus updateDataLink(int nRow, int nCol, GcDb::UpdateDirection nDir, GcDb::UpdateOption nOption);
