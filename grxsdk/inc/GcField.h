...
public:
  ...
  virtual Gcad::ErrorStatus compile(GcDbField* pField, GcDbDatabase* pDb, GcFdFieldResult* pResult);
  virtual Gcad::ErrorStatus evaluate(GcDbField* pField, int nContext, GcDbDatabase* pDb, GcFdFieldResult* pResult);
  virtual Gcad::ErrorStatus format(GcDbField* pField, GcString& sValue);
  virtual Gcad::ErrorStatus format(GcDbField* pField, GCHAR*& pszValue) final;
...
inline Gcad::ErrorStatus GcFdFieldEvaluator::format(GcDbField* pField, GCHAR*& pszValue)
{
  GcString sValue;
...
public:
  ...
  virtual GcFdFieldEvaluator* getEvaluator(const GCHAR* pszEvalId);
  virtual GcFdFieldEvaluator* findEvaluator(GcDbField* pField, const GCHAR*& pszEvalId);
...
public:
  ...
  GcFdFieldEvaluator* findEvaluator(GcDbField* pField, const GCHAR*& pszEvalId);
...
public:
  ...
  virtual Gcad::ErrorStatus setEvaluationStatus(int nStatus, int dwErrCode = 0, const GCHAR* pszMsg = NULL);
};
...
public:
  ...
  virtual Gcad::ErrorStatus beginEvaluateFields(int nContext, GcDbDatabase* pDb);
  virtual Gcad::ErrorStatus endEvaluateFields(int nContext, GcDbDatabase* pDb);
};
