...
class GE_DLLEXPIMPORT GcGeLineSeg2d : public GcGeLinearEnt2d
{
public:
  GcGeLineSeg2d();
  ...
  GcGeLineSeg2d& set(
    const GcGeCurve2d& curve1, const GcGeCurve2d& curve2, double& param1, double& param2, Gsoft::Boolean& success);
  GcGeLineSeg2d& set(const GcGeCurve2d& curve, const GcGePoint2d& point, double& param, Gsoft::Boolean& success);
