...
public:
  ...
  GCPL_PORT int messageBox(const GCHAR* pText, const GCHAR* pCaption, unsigned int uType, int defaultReturn) override;
  GCPL_PORT void info(GCPL_ULONG_PTR category,
                      const unsigned int specific,
                      const GCHAR* pLocation,
                      const GCHAR* pContextData,
                      const GCHAR* pRevision) override;
  GCPL_PORT ErrorResult warning(GCPL_ULONG_PTR category,
                                const unsigned int specific,
                                const GCHAR* pLocation,
                                const GCHAR* pContextData,
                                const GCHAR* pRevision) override;
  GCPL_PORT void severeError(GCPL_ULONG_PTR category,
                             const unsigned int specific,
                             const GCHAR* pLocation,
                             const GCHAR* pContextData,
                             const GCHAR* pRevision) override;
  GCPL_PORT ErrorResult error(GCPL_ULONG_PTR category,
                              const unsigned int specific,
                              const GCHAR* pLocation,
                              const GCHAR* pContextData,
                              const GCHAR* pRevision) override;
  GCPL_PORT ErrorResult ariError(GCPL_ULONG_PTR category,
                                 const unsigned int specific,
                                 const GCHAR* pLocation,
                                 const GCHAR* pContextData,
                                 const GCHAR* pRevision) override;
  GCPL_PORT void terminalError(GCPL_ULONG_PTR category,
                               const unsigned int specific,
                               const GCHAR* pLocation,
                               const GCHAR* pContextData,
                               const GCHAR* pRevision) override;
