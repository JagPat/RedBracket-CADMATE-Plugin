...
template<rsize_t N>
errno_t strcpy_s(char (&s1)[N], const char* s2)
{
...
template<size_t N>
errno_t wcscpy_s(wchar_t (&s1)[N], const wchar_t* s2)
{
...
inline rsize_t wcsnlen_s(wchar_t const* str, rsize_t strsz)
{
  ...
  return count > strsz ? strsz : count;
}
...
template<size_t N>
errno_t wcsncpy_s(wchar_t (&s1)[N], const wchar_t* s2, rsize_t s2Num)
{
  wcsncpy(s1, s2, s2Num);
  return 0;
}
...
template<size_t N>
errno_t wcscat_s(wchar_t (&s1)[N], const wchar_t* s2)
{
  wcscat(s1, s2);
  return 0;
}
...
template<rsize_t N>
errno_t wcsncat_s(wchar_t (&s1)[N], const wchar_t* s2, rsize_t s2Num)
{
...
template<size_t N>
int sprintf_s(char (&s)[N], const char* format, ...)
{
  va_list args;
  va_start(args, format);
  int retVal = vsnprintf(s, N, format, args);
...
template<size_t N>
int swprintf_s(wchar_t (&s)[N], const wchar_t* format, ...)
{
  va_list args;
  va_start(args, format);
  int retVal = vswprintf(s, N, format, args);
...
template<size_t N>
int vswprintf_s(wchar_t (&s)[N], const wchar_t* format, va_list args)
{
...
inline errno_t fopen_s(FILE** _Stream, char const* _FileName, char const* _Mode)
{
  if (_Stream)
  {
