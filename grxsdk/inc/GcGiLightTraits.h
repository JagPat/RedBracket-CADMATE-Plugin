...
public:
  ...
  void setGroundColor(const GcCmColor& color)
  {
    return setGroundColorImp(color);
  }
  GcCmColor groundColor() const
  {
    return groundColorImp();
  }

  void setNightColor(const GcCmColor& color)
  {
    setNightColorImp(color);
  }
  GcCmColor nightColor() const
  {
  ...
  bool setSolarDiskSamples(Gsoft::UInt16 samples)
  {
    return setSolarDiskSamplesImp(samples);
  }
  Gsoft::UInt16 solarDiskSamples() const
  {
    return solarDiskSamplesImp();
  }

  bool setSunDirection(const GcGeVector3d& sundir)
  {
    return setSunDirectionImp(sundir);
  }
  const GcGeVector3d& sunDirection() const
  {
