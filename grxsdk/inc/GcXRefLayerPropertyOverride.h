...
public:
  ...
  GCDB_PORT static Gcad::ErrorStatus addXRefLayerOverride(const GcDbObjectId& hostLayerId,
                                                          XRefLayerPropertyOverrideType property);
  GCDB_PORT static Gcad::ErrorStatus removeXRefLayerOverride(const GcDbObjectId& hostLayerId,
                                                             XRefLayerPropertyOverrideType property);
  GCDB_PORT static Gcad::ErrorStatus removeXRefLayerOverride(GcDbDatabase* pHostDb,
                                                             XRefLayerPropertyOverrideType property);
