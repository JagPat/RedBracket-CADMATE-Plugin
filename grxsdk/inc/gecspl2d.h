...
class GE_DLLEXPIMPORT GcGeCubicSplineCurve2d : public GcGeSplineEnt2d
{
public:
  GcGeCubicSplineCurve2d();
  GcGeCubicSplineCurve2d(const GcGeCubicSplineCurve2d& spline);
  GcGeCubicSplineCurve2d(const GcGePoint2dArray& fitPnts, const GcGeTol& tol = GcGeContext::gTol);
  ...
  GcGeCubicSplineCurve2d(const GcGeCurve2d& curve, double epsilon = GcGeContext::gTol.equalPoint());
