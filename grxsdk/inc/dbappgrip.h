...
public:
  ...
  virtual Gcad::ErrorStatus moveGripPointsAt(const GcDbVoidPtrArray& gripAppData,
...
public:
  ...
  virtual Gcad::ErrorStatus getInsertionPoints(const GcDbBlockTableRecord* pBlock,
