...
{
public:
  virtual void doFilter(const IGcPcDataBuffer& inBuffer, IGcPcDataBuffer& outBuffer) = 0;
};
...
DBPOINTCLOUDOBJ_PORT Gcad::ErrorStatus gcdbCreatePointCloudEntity(GcDbEntity*& newPointCloud,
...
DBPOINTCLOUDOBJ_PORT Gcad::ErrorStatus gcdbAttachPointCloudExEntity(GcDbObjectId& newPointCloudExId,
...
DBPOINTCLOUDOBJ_PORT Gcad::ErrorStatus gcdbAttachPointCloudEntity(GcDbObjectId& newPointCloudId,
                                                                  const GcString& indexFile,
                                                                  const GcString& sourceFile,
                                                                  GcGePoint3d& location,
                                                                  double scale = 1.0,
...
DBPOINTCLOUDOBJ_PORT Gcad::ErrorStatus gcdbModifyPointCloudDataView(GcDbEntity* pEnt, IGcPcPointFilter* pFilter);

DBPOINTCLOUDOBJ_PORT Gcad::ErrorStatus gcdbResetPointCloudDataView(GcDbEntity* pEnt);

DBPOINTCLOUDOBJ_PORT Gcad::ErrorStatus gcdbProcessPointCloudData(GcDbEntity* pEnt,
...
DBPOINTCLOUDOBJ_PORT Gcad::ErrorStatus gcdbSetPointCloudFilter(GcDbEntity* pEnt, IPointCloudFilter* pFilter);
