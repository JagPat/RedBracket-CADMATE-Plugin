...
inline GcDbDimData::GcDbDimData()
  : mpDim(NULL), mBitFlags(0), mpSetDimValueFunc(NULL), mpAppData(NULL), mpSetCustomStringFunc(NULL)
{
}
...
inline GcDbDimension* GcDbDimData::dimension() const
{
  return mpDim;
}

inline Gcad::ErrorStatus GcDbDimData::setDimension(GcDbDimension* pDim)
{
  mpDim = pDim;
  return Gcad::eOk;
}

inline GcDbObjectId GcDbDimData::ownerId() const
{
  return mOwnerId;
}

inline Gcad::ErrorStatus GcDbDimData::setOwnerId(const GcDbObjectId& objId)
{
  mOwnerId = objId;
  return Gcad::eOk;
}

inline unsigned int GcDbDimData::bitFlags() const
{
  return mBitFlags;
}

inline Gcad::ErrorStatus GcDbDimData::setBitFlags(unsigned int flags)
{
  mBitFlags = flags;
  return Gcad::eOk;
}

inline bool GcDbDimData::isDimFocal() const
{
  return !!(mBitFlags & kDimFocal);
}

inline Gcad::ErrorStatus GcDbDimData::setDimFocal(bool focal)
{
  if (focal)
    mBitFlags |= kDimFocal;
  else
...
inline bool GcDbDimData::isDimEditable() const
{
  return !!(mBitFlags & kDimEditable);
}

inline Gcad::ErrorStatus GcDbDimData::setDimEditable(bool editable)
{
  if (editable)
...
inline bool GcDbDimData::isDimInvisible() const
{
  return !!(mBitFlags & kDimInvisible);
}

inline Gcad::ErrorStatus GcDbDimData::setDimInvisible(bool invisible)
{
  if (invisible)
...
inline bool GcDbDimData::isDimHideIfValueIsZero() const
{
  return !!(mBitFlags & kDimHideIfValueIsZero);
}

inline Gcad::ErrorStatus GcDbDimData::setDimHideIfValueIsZero(bool hide)
{
  if (hide)
...
inline bool GcDbDimData::isDimResultantLength() const
{
  return !!(mBitFlags & kDimResultantLength);
}

inline Gcad::ErrorStatus GcDbDimData::setDimResultantLength(bool bValue)
{
  if (bValue)
...
inline bool GcDbDimData::isDimDeltaLength() const
{
  return !!(mBitFlags & kDimDeltaLength);
}

inline Gcad::ErrorStatus GcDbDimData::setDimDeltaLength(bool bValue)
{
  if (bValue)
...
inline bool GcDbDimData::isDimResultantAngle() const
{
  return !!(mBitFlags & kDimResultantAngle);
}

inline Gcad::ErrorStatus GcDbDimData::setDimResultantAngle(bool bValue)
{
  if (bValue)
...
inline bool GcDbDimData::isDimDeltaAngle() const
{
  return !!(mBitFlags & kDimDeltaAngle);
}

inline Gcad::ErrorStatus GcDbDimData::setDimDeltaAngle(bool bValue)
{
  if (bValue)
...
inline bool GcDbDimData::isDimRadius() const
{
  return !!(mBitFlags & kDimRadius);
}

inline Gcad::ErrorStatus GcDbDimData::setDimRadius(bool bValue)
{
  if (bValue)
...
inline bool GcDbDimData::isCustomDimValue() const
{
  return !!(mBitFlags & kDimCustomValue);
}

inline Gcad::ErrorStatus GcDbDimData::setCustomDimValue(bool custom)
{
  if (custom)
...
inline bool GcDbDimData::isConstrained() const
{
  return !!(mBitFlags & kDimConstrained);
}

inline Gcad::ErrorStatus GcDbDimData::setConstrain(bool bValue)
{
  if (bValue)
...
inline bool GcDbDimData::isCustomString() const
{
  return !!(mBitFlags & kDimCustomString);
}

inline Gcad::ErrorStatus GcDbDimData::setCustomString(bool bValue)
{
  if (bValue)
...
inline void* GcDbDimData::appData() const
{
  return mpAppData;
}

inline Gcad::ErrorStatus GcDbDimData::setAppData(void* appData)
{
  mpAppData = appData;
  return Gcad::eOk;
}

inline DimDataSetValueFuncPtr GcDbDimData::dimValueFunc() const
{
  return mpSetDimValueFunc;
}

inline Gcad::ErrorStatus GcDbDimData::setDimValueFunc(DimDataSetValueFuncPtr funcPtr)
{
  mpSetDimValueFunc = funcPtr;
  return Gcad::eOk;
}

inline DimDataSetCustomStringFuncPtr GcDbDimData::customStringFunc() const
{
  return mpSetCustomStringFunc;
}

inline Gcad::ErrorStatus GcDbDimData::setCustomStringFunc(DimDataSetCustomStringFuncPtr funcPtr)
{
