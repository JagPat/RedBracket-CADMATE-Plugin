...
class GE_DLLEXPIMPORT GcGeLinearEnt3d : public GcGeCurve3d
{
public:
  ...
  Gsoft::Boolean isOn(const GcGePlane& plane, const GcGeTol& tol = GcGeContext::gTol) const;

  Gsoft::Boolean isParallelTo(const GcGeLinearEnt3d& line, const GcGeTol& tol = GcGeContext::gTol) const;
  Gsoft::Boolean isParallelTo(const GcGePlanarEnt& plane, const GcGeTol& tol = GcGeContext::gTol) const;
  Gsoft::Boolean isPerpendicularTo(const GcGeLinearEnt3d& line, const GcGeTol& tol = GcGeContext::gTol) const;
  Gsoft::Boolean isPerpendicularTo(const GcGePlanarEnt& plane, const GcGeTol& tol = GcGeContext::gTol) const;
  Gsoft::Boolean isColinearTo(const GcGeLinearEnt3d& line, const GcGeTol& tol = GcGeContext::gTol) const;
