...
typedef GcArray<GcDbHandle, GcArrayObjectCopyReallocator<GcDbHandle>> GcDbHandleArrayPtRef;
...
public:
  ...
  virtual Gcad::ErrorStatus wblockClone(GcRxObject* pOwnerObject,
                                        ...
                                        GcDbIdMapping&,
                                        Gsoft::Boolean isPrimary = Gsoft::kTrue) const
  {
  ...
  static Gcad::ErrorStatus dwgInFields(GcDbDwgFiler* filer, GcDbDatabase* pDb, GcDbPointRef*& pPointRef);
  static Gcad::ErrorStatus dwgOutFields(GcDbDwgFiler* filer, GcDbDatabase* pDb, const GcDbPointRef* pPointRef);
  static Gcad::ErrorStatus dxfInFields(GcDbDxfFiler* filer, GcDbDatabase* pDb, GcDbPointRef*& pPointRef);
  static Gcad::ErrorStatus dxfOutFields(GcDbDxfFiler* filer, GcDbDatabase* pDb, const GcDbPointRef* pPointRef);
  static GcDbEntity* subentPtr(const GcDbFullSubentPath& objPath,
                               bool& isCloned,
                               bool& reverseArc,
                               bool& isStandAloneArc);
...
public:
  ...
  bool isXrefObj(GcDbObjectIdArray& ids1, GcDbObjectIdArray& ids2, bool isMainObj = true) const override;
  ...
  Gcad::ErrorStatus evalPoint(GcDbPointRef::OsnapType ospType, const GcGePoint3d& lastPt, GcGePoint3d& pt);
