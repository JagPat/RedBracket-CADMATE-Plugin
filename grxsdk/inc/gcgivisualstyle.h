...
public:
  ...
  virtual bool setTrait(Property prop, const GcGiVariant* pVal, Operation op = GcGiVisualStyleOperations::kSet);
  virtual bool setTrait(Property prop, int nVal, Operation op = GcGiVisualStyleOperations::kSet);
  virtual bool setTrait(Property prop, bool bVal, Operation op = GcGiVisualStyleOperations::kSet);
  virtual bool setTrait(Property prop, double dVal, Operation op = GcGiVisualStyleOperations::kSet);
  virtual bool setTrait(
    Property prop, double red, double green, double blue, Operation op = GcGiVisualStyleOperations::kSet);
  virtual bool setTrait(Property prop, const GcCmColor* pColor, Operation op = GcGiVisualStyleOperations::kSet);
  virtual bool setTrait(GcGiVisualStyleProperties::Property prop,
                        const GcString* pStr,
                        GcGiVisualStyleOperations::Operation op = GcGiVisualStyleOperations::kSet);
  virtual const GcGiVariant& trait(Property prop, Operation* pOp = NULL) const;
  virtual Operation operation(Property prop) const;
  virtual bool setTraitFlag(Property flagProp, Gsoft::UInt32 flagVal, bool bEnable = true);
  virtual bool traitFlag(Property flagProp, Gsoft::UInt32 flagVal) const;
