...
public:
  GcGeTorus();
  GcGeTorus(double majorRadius, double minorRadius, const GcGePoint3d& origin, const GcGeVector3d& axisOfSymmetry);
  ...
  GcGeTorus& set(double majorRadius, double minorRadius, const GcGePoint3d& origin, const GcGeVector3d& axisOfSymmetry);
