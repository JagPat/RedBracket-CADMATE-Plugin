...
public:
  CGdUiTabMainDialog(UINT idd, CWnd* pParent = NULL, HINSTANCE hDialogResource = NULL);
...
public:
  ...
  void SetInitialTabIndex(LPCTSTR strTabIndex)
  {
    m_strTabIndex = strTabIndex;
  }
...
public:
  BOOL AddTab(int iPos, LPCTSTR tabName, UINT uTemplateID, CGdUiTabChildDialog* pDialog);
  BOOL AddTab(int iPos, UINT uTabStringID, UINT uTemplateID, CGdUiTabChildDialog* pDialog);
