...
class GE_DLLEXPIMPORT GcGeCurve2d : public GcGeEntity2d
{
public:
  void getInterval(GcGeInterval& intrvl) const;
  void getInterval(GcGeInterval& intrvl, GcGePoint2d& start, GcGePoint2d& end) const;
  GcGeCurve2d& reverseParam();
  GcGeCurve2d& setInterval();
  Gsoft::Boolean setInterval(const GcGeInterval& intrvl);

  double distanceTo(const GcGePoint2d& pnt, const GcGeTol& = GcGeContext::gTol) const;
  double distanceTo(const GcGeCurve2d&, const GcGeTol& tol = GcGeContext::gTol) const;

  GcGePoint2d closestPointTo(const GcGePoint2d& pnt, const GcGeTol& tol = GcGeContext::gTol) const;
  ...
  Gsoft::Boolean isOn(const GcGePoint2d& pnt, const GcGeTol& tol = GcGeContext::gTol) const;
  Gsoft::Boolean isOn(const GcGePoint2d& pnt, double& param, const GcGeTol& tol = GcGeContext::gTol) const;
  Gsoft::Boolean isOn(double param, const GcGeTol& tol = GcGeContext::gTol) const;

  double paramOf(const GcGePoint2d& pnt, const GcGeTol& tol = GcGeContext::gTol) const;
  ...
  Gsoft::Boolean isLinear(GcGeLine2d& line, const GcGeTol& tol = GcGeContext::gTol) const;
  ...
  Gsoft::Boolean isDegenerate(GcGeEntity2d*& pConvertedEntity, const GcGeTol& tol = GcGeContext::gTol) const;

  void getSplitCurves(double param, GcGeCurve2d*& piece1, GcGeCurve2d*& piece2) const;
  ...
  GcGePoint2d evalPoint(double param, int numDeriv, GcGeVector2dArray& derivArray) const;
