...
GCGS_PORT Gsoft::Boolean gcgsGetDisplayInfo(int& drawingWidth, int& drawingHeight, int& aspectWidth, int& aspectHeight);

GCGS_PORT Gsoft::Boolean gcgsGetViewportInfo(int viewportNumber, int& left, int& bottom, int& right, int& top);
...
{
public:
  virtual Gsoft::Boolean getSize(int& width, int& height, int& depth) const = 0;

  virtual Gsoft::Boolean getColorMap(int index, Gsoft::UInt8& red, Gsoft::UInt8& green, Gsoft::UInt8& blue) const = 0;
...
GCGS_PORT Gsoft::Boolean gcgsSetViewParameters(
  int viewportNumber, const GcGsView* pView, bool bRegenRequired, bool bRescaleRequired, bool bSyncRequired = false);
...
public:
  ...
  virtual bool testView(GcGePoint3d const& target, double dFieldHeight) = 0;
};
...
GCGS_PORT Gsoft::Boolean gcgsDrawableModified(GcGiDrawable* pDrawable, GcGiDrawable* pParentDrawable);
GCGS_PORT Gsoft::Boolean gcgsDrawableErased(GcGiDrawable* pDrawable, GcGiDrawable* pParentDrawable);
