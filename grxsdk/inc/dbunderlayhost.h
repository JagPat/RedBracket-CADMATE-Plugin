...
public:
  ...
  virtual Gcad::ErrorStatus getOsnapPoints(const GcGeMatrix3d& modelToWorld,
                                           ...
                                           GcDbIntArray& geomIds) const = 0;
  virtual GcDbEntity* getSubEntityAtGsMarker(const GcGeMatrix3d& modelToWorld,
                                             Gsoft::GsMarker gsSelectionMark) const = 0;
  ...
  virtual Gsoft::UInt32 underlayLayerCount() const
  {
    return 0;
  }
...
{
public:
  virtual Gcad::ErrorStatus getFile(const GCHAR* fullPath, const wchar_t* password, GcDbUnderlayFile*& pFile) const = 0;
  virtual Gcad::ErrorStatus getFile(IGcReadStream* pFileStream,
                                    const wchar_t* password,
                                    GcDbUnderlayFile*& pFile) const = 0;

  static void getAdjustedColor(GcGeVector3d& rgbResult,
