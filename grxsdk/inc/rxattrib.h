...
public:
  ...
  GCBASE_PORT static Gcad::ErrorStatus loadString(const GcRxObject* pClass,
                                                  unsigned int id,
...
public:
  ...
  GCBASE_PORT static const GcRxPropertyBase* parseReference(const GCHAR* path,
                                                            const GcRxObject* pObject,
