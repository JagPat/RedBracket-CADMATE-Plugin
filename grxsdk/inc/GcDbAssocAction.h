...
public:
  ...
  DBCONSTRAINTS_PORT Gcad::ErrorStatus removeDependency(const GcDbObjectId& dependencyId, bool alsoEraseIt);
  ...
  DBCONSTRAINTS_PORT void getDependentActionsToEvaluate(
  ...
  DBCONSTRAINTS_PORT Gcad::ErrorStatus addParam(const GcString& paramName,
  ...
  DBCONSTRAINTS_PORT Gcad::ErrorStatus valueParamInputVariables(const GcString& paramName,
                                                                GcDbObjectIdArray& variableIds) const;

  DBCONSTRAINTS_PORT Gcad::ErrorStatus setValueParamControlledObjectDep(const GcString& paramName,
                                                                        const GcDbObjectId& controlledObjectDepId);
