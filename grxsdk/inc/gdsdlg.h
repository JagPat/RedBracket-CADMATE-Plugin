...
#define TILE_STR_LIMIT 2035
  ...
  GCCORE_PORT int gds_new_dialog(const GCHAR* dlgname, int dcl_id, CLIENTFUNC def_callback, gds_hdlg* hdlg);
  GCCORE_PORT int gds_new_positioned_dialog(
    const GCHAR* dlgname, int dcl_id, CLIENTFUNC def_callback, int x, int y, gds_hdlg* hdlg);
  ...
  GCCORE_PORT int gds_done_positioned_dialog(gds_hdlg hdlg, int status, int* x_result, int* y_result);
  ...
  GCCORE_PORT int gds_get_tile(gds_hdlg hdlg, const GCHAR* key, GCHAR* value, int maxlen);
  GCCORE_PORT int gds_get_attr(gds_hdlg hdlg, const GCHAR* key, GCHAR* attr, GCHAR* value, int len);
  ...
  GCCORE_PORT int gds_dimensions_tile(gds_hdlg hdlg, const GCHAR* key, short* cx, short* cy);
  ...
  GCCORE_PORT int gds_slide_image(short x1, short y1, short x2, short y2, const GCHAR* slnam);
