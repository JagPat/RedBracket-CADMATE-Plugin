...
BOOL GCAD_PORT GdUiShowBalloonTip(CWnd* owner, CWnd* control, LPCTSTR text, BOOL beep);
BOOL GCAD_PORT GdUiShowBalloonTip(CWnd* owner, CWnd* control, CRect& rect, LPCTSTR text, BOOL beep);
