...
public:
  ...
  virtual Gcad::ErrorStatus getDataType(GcValue::DataType& nDataType, GcValue::UnitType& nUnitType) const;
  ...
  virtual Gcad::ErrorStatus setDataType(GcValue::DataType nDataType, GcValue::UnitType nUnitType);
  ...
  virtual GcCmColor gridColor(GcDb::GridLineType gridLineType, GcDb::RowType rowType = GcDb::kDataRow) const;
  ...
  Gcad::ErrorStatus copyCellStyle(const GcDbTableStyle* pSrc,
                                  const GCHAR* pszSrcCellStyle,
                                  const GCHAR* pszTargetCellStyle);
  ...
  Gcad::ErrorStatus getDataType(GcValue::DataType& nDataType,
                                GcValue::UnitType& nUnitType,
                                const GCHAR* pszCellStyle) const;
  ...
  Gcad::ErrorStatus setGridLineWeight(GcDb::LineWeight lineWeight,
                                      GcDb::GridLineType gridLineTypes,
                                      const GCHAR* pszCellStyle);
  ...
  Gcad::ErrorStatus setGridVisibility(GcDb::Visibility visible,
                                      GcDb::GridLineType gridLineTypes,
                                      const GCHAR* pszCellStyle);
  double gridDoubleLineSpacing(GcDb::GridLineType gridLineType, const GCHAR* pszCellStyle) const;
  Gcad::ErrorStatus setGridDoubleLineSpacing(double fSpacing,
                                             GcDb::GridLineType gridLineTypes,
                                             const GCHAR* pszCellStyle);
  GcDb::GridLineStyle gridLineStyle(GcDb::GridLineType gridLineType, const GCHAR* pszCellStyle) const;
  Gcad::ErrorStatus setGridLineStyle(GcDb::GridLineStyle nLineStyle,
                                     GcDb::GridLineType gridLineTypes,
                                     const GCHAR* pszCellStyle);
  GcDbObjectId gridLinetype(GcDb::GridLineType gridLineType, const GCHAR* pszCellStyle) const;
  Gcad::ErrorStatus setGridLinetype(const GcDbObjectId& id,
                                    GcDb::GridLineType gridLineTypes,
                                    const GCHAR* pszCellStyle);
  Gcad::ErrorStatus getGridProperty(GcGridProperty& gridProp,
                                    GcDb::GridLineType nGridLineTypes,
                                    const GCHAR* pszCellStyle) const;
  Gcad::ErrorStatus setGridProperty(const GcGridProperty& gridProp,
                                    GcDb::GridLineType nGridLineTypes,
                                    const GCHAR* pszCellStyle);
  ...
  Gcad::ErrorStatus setTemplate(GcDbTableTemplate* pTemplate,
                                GcDb::MergeCellStyleOption nOption,
                                GcDbObjectId& templateId);
