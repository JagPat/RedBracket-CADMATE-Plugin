...
public:
  ...
  Gcad::ErrorStatus get(int& uDegree,
                        int& vDegree,
                        bool& rational,
                        int& uNumControlPoints,
                        int& vNumControlPoints,
  ...
  Gcad::ErrorStatus set(int uDegree,
                        int vDegree,
                        bool rational,
                        int uNumControlPoints,
                        int vNumControlPoints,
  ...
  Gcad::ErrorStatus evaluate(double u,
                             double v,
                             GcGePoint3d& pos,
                             GcGeVector3d& uDeriv,
                             GcGeVector3d& vDeriv,
                             GcGeVector3d& uuDeriv,
                             GcGeVector3d& uvDeriv,
                             GcGeVector3d& vvDeriv) const;
  Gcad::ErrorStatus evaluate(
    double u, double v, int derivDegree, GcGePoint3d& point, GcGeVector3dArray& derivatives) const;
  ...
  Gcad::ErrorStatus modifyPositionAndTangent(
    double u, double v, const GcGePoint3d& point, const GcGeVector3d* uDeriv = NULL, const GcGeVector3d* vDeriv = NULL);
