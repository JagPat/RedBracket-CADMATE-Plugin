...
GCCORE_PORT bool gcedGetCurrentColorsEx(GcColorSettings* pColorSettings, GcColorSettingsEx* pColorSettingsEx);
GCCORE_PORT bool gcedSetCurrentColorsEx(GcColorSettings* pColorSettings, GcColorSettingsEx* pColorSettingsEx);
GCCORE_PORT bool gcedGetSystemColorsEx(GcColorSettings* pColorSettings, GcColorSettingsEx* pColorSettingsEx);
...
GCCORE_PORT void gcedPatternReset();
...
typedef HBITMAP (*GcedCommandBitmapQueryFn)(const wchar_t* cmdName, const COLORREF& backgroundColor);
...
GCAD_PORT HBITMAP gcedGetBitmapForCommand(const wchar_t* cmdName, const COLORREF& backgroundColor);
GCAD_PORT HBITMAP gcedGetCachedBitmapForCommand(const wchar_t* cmdName, const COLORREF& backgroundColor);
GCAD_PORT bool gcedGetToolTipInfoForCommand(const GCHAR* cmdName, GcCommandToolTipInfo* pInfo);
