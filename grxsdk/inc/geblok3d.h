...
class GE_DLLEXPIMPORT GcGeBoundBlock3d : public GcGeEntity3d
{
public:
  GcGeBoundBlock3d();
  GcGeBoundBlock3d(const GcGePoint3d& base,
                   const GcGeVector3d& dir1,
                   const GcGeVector3d& dir2,
                   const GcGeVector3d& dir3);
  GcGeBoundBlock3d(const GcGeBoundBlock3d& block);

  void getMinMaxPoints(GcGePoint3d& point1, GcGePoint3d& point2) const;
  void get(GcGePoint3d& base, GcGeVector3d& dir1, GcGeVector3d& dir2, GcGeVector3d& dir3) const;
  GcGeBoundBlock3d& set(const GcGePoint3d& point1, const GcGePoint3d& point2);
