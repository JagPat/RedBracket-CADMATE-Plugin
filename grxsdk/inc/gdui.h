...
int GCAD_PORT
GdUiAlertDialog(LPCTSTR captionText, LPCTSTR msg0Text, LPCTSTR button0Text, LPCTSTR button1Text, UINT defButton = 0);
int GCAD_PORT GdUiDataValidationLevel();
BOOL GCAD_PORT GdUiFindContextHelpFullPath(LPCTSTR fileName, CString& fullPath);
