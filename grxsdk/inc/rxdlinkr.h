...
public:
  ...
  virtual GcadApp::ErrorStatus registerApp(GcadApp::LoadReasons alr,
                                           const GCHAR* logicalName,
                                           void* entryPoint = nullptr) = 0;
  virtual GcadApp::ErrorStatus unregisterApp(const GCHAR* logicalName) = 0;
};

#define gcrxDynamicLinker GcRxDynamicLinker::cast(gcrxSysRegistry()->at(GCRX_DYNAMIC_LINKER))
