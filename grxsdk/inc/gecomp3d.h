...
class GE_DLLEXPIMPORT GcGeCompositeCurve3d : public GcGeCurve3d
{
public:
  GcGeCompositeCurve3d();
  GcGeCompositeCurve3d(const GcGeVoidPointerArray& curveList);
  GcGeCompositeCurve3d(const GcGeVoidPointerArray& curveList, const GcGeIntArray& isOwnerOfCurves);
  ...
  GcGeCompositeCurve3d& setCurveList(const GcGeVoidPointerArray& curveList, const GcGeIntArray& isOwnerOfCurves);
