...
public:
  ...
  virtual bool GetEntityNode(GcDbObjectId id, GcDbObjectIdArray objIds, int& nodeId) const = 0;
  ...
  virtual bool add3DDwfAttribute(const wchar_t* category,
                                 const wchar_t* name,
                                 const wchar_t* ns,
                                 const wchar_t* nsUrl,
                                 const wchar_t* attName,
