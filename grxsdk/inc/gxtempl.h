...
public:
  ...
  {
    return GcOpmGetCategoryName(
      reinterpret_cast<IUnknown*>(this), GetResourceInstance(), T::GetOPMPropertyMap(), propcat, lcid, pbstrName);
  }
  ...
  {
    return GcOpmGetPredefinedStrings(reinterpret_cast<IUnknown*>(this),
                                     GetResourceInstance(),
                                     T::GetOPMPropertyMap(),
                                     dispID,
                                     pCaStringsOut,
  ...
  {
    return GcOpmGetPredefinedValue(
      reinterpret_cast<IUnknown*>(this), T::GetOPMPropertyMap(), dispID, dwCookie, pVarOut);
  }

  STDMETHODIMP GetDisplayName(DISPID dispID, BSTR* pBstr)
  {
    return GcOpmGetDisplayName(
      reinterpret_cast<IUnknown*>(this), GetResourceInstance(), T::GetOPMPropertyMap(), dispID, pBstr);
  }
...
template<class T>
class CProxy_GcadObjectEvents : public IConnectionPointImpl<T, &IID_IGcadObjectEvents, CComDynamicUnkArray>
{
public:
...
class ATL_NO_VTABLE IGcadBaseObjectImpl : public IGcadBaseObject,
...
public:
  ...
  STDMETHOD(SetObjectId)(GcDbObjectId& objId, GcDbObjectId ownerId = GcDbObjectId::kNull, GCHAR* keyName = NULL)
  {
    if (!m_objId.isNull())
      return E_FAIL;
...
template<class T, const CLSID* pclsid>
class ATL_NO_VTABLE IGcadBaseObject2Impl : public IGcadBaseObject2, public IGcadBaseObjectImpl<T, pclsid>
{
public:
  ...
  STDMETHOD(AddToDb)(GcDbObjectId& objId, GcDbObjectId ownerId = GcDbObjectId::kNull, GCHAR* keyName = NULL)
  {
    return E_NOTIMPL;
  }

  STDMETHOD(CreateObject)(GcDbObjectId ownerId = GcDbObjectId::kNull, GCHAR* keyName = NULL)
  {
    return E_NOTIMPL;
  }
...
class ATL_NO_VTABLE IGcadObjectDispatchImpl : public IDispatchImpl<T, piid, plibid, wMajor, wMinor, tihclass>,
...
public:
  ...
  STDMETHOD(get_Database)(IGcadDatabase** pDatabase)
  {
    ...
    if (SUCCEEDED(hr))
    {
      hr = pDispatch->QueryInterface(IID_IGcadDatabase, reinterpret_cast<LPVOID*>(pDatabase));
    }
  ...
  {
    HRESULT hr =
      _tih.Invoke((IDispatch*)this, dispidMember, riid, lcid, wFlags, pdispparams, pvarResult, pexcepinfo, puArgErr);
    if (hr == DISP_E_MEMBERNOTFOUND && wFlags == DISPATCH_PROPERTYPUTREF)
    {
      HRESULT hr2 = _tih.Invoke((IDispatch*)this,
                                dispidMember,
                                riid,
                                lcid,
...
public:
  ...
  STDMETHODIMP ArrayRectangular(
    int numRows, int numCols, int numLvls, double disRows, double disCols, double disLvls, VARIANT* pArrayObjs)
  {
...
class ATL_NO_VTABLE IGcadBaseDatabaseImpl : public IGcadBaseDatabase
{
public:
...
template<class C,
         ...
         WORD wMinor = 0,
         class tihclass = CComTypeInfoHolder>
class ATL_NO_VTABLE IGcadBaseSubEntityImpl : public IDispatchImpl<T, piid, plibid, wMajor, wMinor, tihclass>,
...
template<class T>
class ATL_NO_VTABLE IGcPiPropCommandButtonsImpl : public IGcPiPropCommandButtons
{
public:
  ...
  {
    return GcOpmGetCommandButtons(
      reinterpret_cast<IUnknown*>(this), GetResourceInstance(), GetCmdBtnVector(), pCmdBtns);
  }
};

#  define IPerPropertyDisplayImpl IGcPiPropertyDisplayImpl
template<class T>
class ATL_NO_VTABLE IGcPiPropertyDisplayImpl : public IGcPiPropertyDisplay
{
public:
  ...
  {
    return GcOpmGetPropertyIcon(
      reinterpret_cast<IUnknown*>(this), GetResourceInstance(), GetPerPropDisplayVector(), Id, ppIcon);
  }
  ...
  {
    return GcOpmIsPropFullView(
      reinterpret_cast<IUnknown*>(this), GetPerPropDisplayVector(), Id, pbVisible, pIntegralHeight);
  }
...
template<class T>
class ATL_NO_VTABLE IGcPiCategorizePropertiesImpl : public IGcPiCategorizeProperties
{
public:
  ...
  {
    HRESULT hr;
    hr = GcOpmGetCategoryName(
      reinterpret_cast<IUnknown*>(this), GetResourceInstance(), T::GetOPMPropertyMap(), propcat, lcid, pbstrName);
    if (hr == S_FALSE)
    {
      hr = GcOpmGetCategoryName(
        reinterpret_cast<IUnknown*>(this), GetResourceInstance(), GetCategoryVector(), propcat, lcid, pbstrName);
    }
    return hr;
  }
  ...
  {
    return GcOpmGetCategoryDescription(
      reinterpret_cast<IUnknown*>(this), GetResourceInstance(), GetCategoryVector(), propcat, lcid, pbstrDesc);
  }
  ...
  {
    return GcOpmGetCategoryCommandButtons(
      reinterpret_cast<IUnknown*>(this), GetResourceInstance(), GetCmdBtnVector(), CatID, pCatCmdBtns);
  }
};
...
public:
  ...
  virtual HRESULT CreateNewObject(GcDbObjectId& objId, GcDbObjectId& ownerId, GCHAR* keyName)
  {
    return E_NOTIMPL;
  }
