...
public:
  ...
  Gcad::ErrorStatus transformToLonLatAlt(const GcGePoint3d& dwgPt, GcGePoint3d& geoPt) const;
  Gcad::ErrorStatus transformToLonLatAlt(double x, double y, double z, double& lon, double& lat, double& alt) const;
  Gcad::ErrorStatus transformFromLonLatAlt(const GcGePoint3d& geoPt, GcGePoint3d& dwgPt) const;
  Gcad::ErrorStatus transformFromLonLatAlt(double lon, double lat, double alt, double& x, double& y, double& z) const;
...
GCDB_PORT Gcad::ErrorStatus gcdbGetGeoDataTransform(
  GcDbDatabase* pDbSource, GcDbDatabase* pDbTarget, GcGePoint3d& insertionPt, double& rotation, double& scale);
