...
public:
  ...
  DBCONSTRAINTS_PORT GcDbAssocArrayRectangularParameters(double columnSpacing = 1,
                                                         double rowSpacing = 1,
  ...
  DBCONSTRAINTS_PORT Gcad::ErrorStatus setColumnCount(int nColumns,
                                                      const GcString& expression = GcString(),
                                                      const GcString& evaluatorId = GcString(),
                                                      GcString& errorMessage = dummyString());
  DBCONSTRAINTS_PORT Gcad::ErrorStatus setColumnSpacing(double offset,
                                                        const GcString& expression = GcString(),
                                                        const GcString& evaluatorId = GcString(),
                                                        GcString& errorMessage = dummyString());
  DBCONSTRAINTS_PORT Gcad::ErrorStatus setAxesAngle(double axesAngle,
                                                    const GcString& expression = GcString(),
                                                    const GcString& evaluatorId = GcString(),
                                                    GcString& errorMessage = dummyString());
