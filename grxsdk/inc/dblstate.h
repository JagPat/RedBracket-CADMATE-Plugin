...
public:
  ...
  enum LayerStateMask
  {
    ...
    kAll = kOn | kFrozen | kLocked | kPlot | kNewViewport | kColor | kLineType | kLineWeight | kPlotStyle |
...
public:
  ...
  virtual void layerStateCreated(const GCHAR* layerStateName, const GcDbObjectId& layerStateId);
  virtual void layerStateCompareFailed(const GCHAR* layerStateName, const GcDbObjectId& layerStateId);
  virtual void layerStateToBeRestored(const GCHAR* layerStateName, const GcDbObjectId& layerStateId);
  virtual void layerStateRestored(const GCHAR* layerStateName, const GcDbObjectId& layerStateId);
  virtual void abortLayerStateRestore(const GCHAR* layerStateName, const GcDbObjectId& layerStateId);
  virtual void layerStateToBeDeleted(const GCHAR* layerStateName, const GcDbObjectId& layerStateId);
  virtual void layerStateDeleted(const GCHAR* layerStateName);
  virtual void abortLayerStateDelete(const GCHAR* layerStateName, const GcDbObjectId& layerStateId);
  virtual void layerStateToBeRenamed(const GCHAR* oldLayerStateName, const GCHAR* newLayerStateName);
  virtual void layerStateRenamed(const GCHAR* oldLayerStateName, const GCHAR* newLayerStateName);
  virtual void abortLayerStateRename(const GCHAR* oldLayerStateName, const GCHAR* newLayerStateName);
};
