...
public:
  ...
  DBCONSTRAINTS_PORT Gcad::ErrorStatus getCommonConstraints(GcConstrainedGeometry* pOtherConsGeom,
                                                            GcArray<GcGeomConstraint*>& apConstraints) const;
...
public:
  ...
  DBCONSTRAINTS_PORT GcConstrainedImplicitPoint(GcGraphNode::Id constrCurvId,
                                                GcDb::ImplicitPointType ptype,
                                                int index = -1);
...
public:
  ...
  DBCONSTRAINTS_PORT virtual void getConstrainedImplicitPoints(
    GcArray<GcConstrainedImplicitPoint*>& apImplicitPoints) const;
...
public:
  ...
  DBCONSTRAINTS_PORT explicit GcConstrained2PointsConstructionLine(const GcGePoint3d& point1,
