...
GCCORE_PORT int gcedSSSubentAdd(const GcDbFullSubentPath& subentity, const gds_name sname, gds_name result);

GCCORE_PORT int gcedSSSubentDel(const GcDbFullSubentPath& subentity, const gds_name ss);

GCCORE_PORT int gcedSSSubentMemb(const GcDbFullSubentPath& subentity, const gds_name ss);
