...
class GcGraphNode : public GcRxObject, public GcHeapOperators
{
public:
  ...
  DBCONSTRAINTS_PORT virtual Gcad::ErrorStatus nodeToBeMovedNotification(GcGraph* pGraph,
                                                                         GcArray<GcGraphNode*>& otherNodesToMove);
