...
template<class T>
void GcArrayValidateParams(bool bSameBuffer, T* pDest, size_t nBufLen, const T* pSource, size_t nCount)
{
...
template<class T>
class GcArrayMemCopyReallocator
{
public:
...
template<class T>
class GcArrayObjectCopyReallocator
{
public:
  static void copyItems(T* pDest, size_t nBufLen, const T* pSource, size_t nCount)
  {
...
template<typename T, typename R = typename GcArrayItemCopierSelector<T, std::is_trivial<T>::value>::allocator>
class GcArray
{
public:
  ...
  enum
  {
    eUsesMemCopy = std::is_same < R,
    GcArrayMemCopyReallocator<T> > ::value
  };
...
inline bool GcArray<T, R>::contains(const T& value, int start) const
{
  return this->findFrom(value, start) != -1;
}

template<class T, class R>
inline int GcArray<T, R>::length() const
{
  return mLogicalLen;
}

template<class T, class R>
inline bool GcArray<T, R>::isEmpty() const
{
  return mLogicalLen == 0;
}

template<class T, class R>
inline int GcArray<T, R>::logicalLength() const
{
  return mLogicalLen;
}

template<class T, class R>
inline int GcArray<T, R>::physicalLength() const
{
  return mPhysicalLen;
}

template<class T, class R>
inline int GcArray<T, R>::growLength() const
{
  return mGrowLen;
}

template<class T, class R>
inline const T* GcArray<T, R>::asArrayPtr() const
{
  return mpArray;
}

template<class T, class R>
inline T* GcArray<T, R>::asArrayPtr()
{
  return mpArray;
}

template<class T, class R>
inline bool GcArray<T, R>::isValid(int i) const
{
  return i >= 0 && i < mLogicalLen;
}

template<class T, class R>
inline T& GcArray<T, R>::operator[](int i)
{
  GC_ARRAY_ASSERT(this->isValid(i));
  return mpArray[i];
}

template<class T, class R>
inline const T& GcArray<T, R>::operator[](int i) const
{
  GC_ARRAY_ASSERT(this->isValid(i));
  return mpArray[i];
}
...
template<class T, class R>
inline const T& GcArray<T, R>::at(int i) const
{
  GC_ARRAY_ASSERT(this->isValid(i));
  return mpArray[i];
}
...
template<class T, class R>
inline GcArray<T, R>& GcArray<T, R>::setAt(int i, const T& value)
{
  GC_ARRAY_ASSERT(this->isValid(i));
  mpArray[i] = value;
  return *this;
...
template<class T, class R>
inline T& GcArray<T, R>::first()
{
  GC_ARRAY_ASSERT(!this->isEmpty());
  return mpArray[0];
}

template<class T, class R>
inline const T& GcArray<T, R>::first() const
{
  GC_ARRAY_ASSERT(!this->isEmpty());
  return mpArray[0];
}
...
template<class T, class R>
inline const T& GcArray<T, R>::last() const
{
  GC_ARRAY_ASSERT(!this->isEmpty());
  return mpArray[mLogicalLen - 1];
}
...
template<class T, class R>
inline int GcArray<T, R>::append(const T& value)
{
...
template<class T, class R>
inline int GcArray<T, R>::append(T&& value)
{
  return this->appendMove(value);
}

template<class T, class R>
inline int GcArray<T, R>::appendMove(T& value)
{
...
template<class T, class R>
inline GcArray<T, R>& GcArray<T, R>::removeFirst()
{
...
template<class T, class R>
inline GcArray<T, R>& GcArray<T, R>::removeLast()
{
  GC_ARRAY_ASSERT(!isEmpty());
  if (!isEmpty())
    mLogicalLen--;
...
template<class T, class R>
inline GcArray<T, R>& GcArray<T, R>::removeAll()
{
...
template<class T, class R>
inline GcArray<T, R>& GcArray<T, R>::setGrowLength(int glen)
{
  GC_ARRAY_ASSERT(glen > 0);
  mGrowLen = glen;
  return *this;
}

template<class T, class R>
inline GcArray<T, R>::GcArray(int physicalLength, int growLength)
  : mpArray(nullptr), mPhysicalLen(0), mLogicalLen(0), mGrowLen(growLength)
{
...
template<class T, class R>
inline GcArray<T, R>::GcArray(const GcArray<T, R>& src)
  : mpArray(nullptr), mPhysicalLen(0), mLogicalLen(0), mGrowLen(src.mGrowLen)
{
  this->copyOtherIntoThis(src);
}

template<class T, class R>
inline GcArray<T, R>::GcArray(GcArray<T, R>&& src)
  : mpArray(nullptr), mPhysicalLen(0), mLogicalLen(0), mGrowLen(src.mGrowLen)
{
...
template<class T, class R>
inline GcArray<T, R>::~GcArray()
{
  this->setPhysicalLength(0);
}

template<class T, class R>
inline GcArray<T, R>& GcArray<T, R>::operator=(const GcArray<T, R>& src)
{
  if (this != &src)
    this->copyOtherIntoThis(src);
  return *this;
...
template<class T, class R>
inline GcArray<T, R>& GcArray<T, R>::operator=(GcArray<T, R>&& src)
{
  if (this != &src)
  {
    this->setPhysicalLength(0);
...
template<class T, class R>
bool GcArray<T, R>::operator==(const GcArray<T, R>& cpr) const
{
...
template<class T, class R>
GcArray<T, R>& GcArray<T, R>::setAll(const T& value)
{
  for (int i = 0; i < mLogicalLen; i++)
  {
    mpArray[i] = value;
...
template<class T, class R>
GcArray<T, R>& GcArray<T, R>::append(const GcArray<T, R>& otherArray)
{
...
template<class T, class R>
inline void GcArray<T, R>::copyOtherIntoThis(const GcArray<T, R>& otherArray)
{
...
template<class T, class R>
inline void GcArray<T, R>::moveOtherIntoThis(GcArray<T, R>& otherArray)
{
  GC_ARRAY_ASSERT(this != &otherArray);
...
template<class T, class R>
GcArray<T, R>& GcArray<T, R>::appendMove(GcArray<T, R>& otherArray)
{
  GC_ARRAY_ASSERT(this != &otherArray);
  if (this != &otherArray)
  {
...
template<class T, class R>
GcArray<T, R>& GcArray<T, R>::insertAt(int index, const T& value)
{
...
template<class T, class R>
GcArray<T, R>& GcArray<T, R>::insertAt(int index, T&& value)
{
  return this->insertAtMove(index, value);
}

template<class T, class R>
GcArray<T, R>& GcArray<T, R>::insertAtMove(int index, T& value)
{
  GC_ARRAY_ASSERT(index >= 0);
  GC_ARRAY_ASSERT(index <= mLogicalLen);
  GC_ARRAY_ASSERT(mLogicalLen <= mPhysicalLen);
...
template<class T, class R>
void GcArray<T, R>::insertSpace(int nIndex)
{
...
template<class T, class R>
GcArray<T, R>& GcArray<T, R>::removeAt(int index)
{
...
template<class T, class R>
GcArray<T, R>& GcArray<T, R>::removeSubArray(int startIndex, int endIndex)
{
...
template<class T, class R>
bool GcArray<T, R>::find(const T& value, int& index, int start) const
{
...
template<class T, class R>
int GcArray<T, R>::find(const T& value) const
{
  return this->findFrom(value, 0);
}

template<class T, class R>
int GcArray<T, R>::findFrom(const T& value, int start) const
{
...
template<class T, class R>
GcArray<T, R>& GcArray<T, R>::setLogicalLength(int n)
{
  GC_ARRAY_ASSERT(n >= 0);
  if (n < 0)
    n = 0;
  ...
  {
    const int growth =
      (mPhysicalLen * sizeof(T)) < GCARRAY_GROWTH_THRESHOLD ? mPhysicalLen : GCARRAY_GROWTH_THRESHOLD / sizeof(T);
...
template<class T, class R>
GcArray<T, R>& GcArray<T, R>::setPhysicalLength(int n)
{
...
template<class T, class R>
GcArray<T, R>& GcArray<T, R>::reverse()
{
...
template<class T, class R>
GcArray<T, R>& GcArray<T, R>::swap(int i1, int i2)
{
...
template<class T, class R>
bool GcArray<T, R>::remove(const T& value, int start)
{
