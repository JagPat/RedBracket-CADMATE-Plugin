...
public:
  ...
  DBCONSTRAINTS_PORT explicit GcDbAssocEdgePersSubentId(int vertexIdentifier1, int vertexIdentifier2);
  ...
  DBCONSTRAINTS_PORT bool isEqualTo(const GcDbEntity* pEntity,
                                    GcDbDatabase* pDatabase,
                                    const GcDbAssocPersSubentId* pOther) const override;
