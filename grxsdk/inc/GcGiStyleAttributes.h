...
inline GcGiStyleAttributes::GcGiStyleAttributes(const GcGiStyleAttributes& source)
{
...
inline GcCmEntityColor& GcGiStyleAttributes::getColorAttribute()
{
  return m_colorAttribute;
}

inline const GcCmEntityColor& GcGiStyleAttributes::getColorAttribute() const
{
  return m_colorAttribute;
}

inline void GcGiStyleAttributes::setColorAttribute(const GcCmEntityColor& color)
{
  m_colorAttribute = color;
}

inline GcDbObjectId GcGiStyleAttributes::linetypeObjectId() const
{
  return m_idLinetype;
}

inline void GcGiStyleAttributes::setLinetypeObjectId(const GcDbObjectId& newId)
{
  m_idLinetype = newId;
}

inline GcDbObjectId GcGiStyleAttributes::plotStyleNameId() const
{
  return m_idPlotstyle;
}

inline void GcGiStyleAttributes::setPlotStyleName(const GcDbObjectId& newId)
{
  m_idPlotstyle = newId;
}
