...
public:
  ...
  virtual Gcad::ErrorStatus generateNextNewLayoutName(GcString& sName, GcDbDatabase* useDb = nullptr) = 0;
  ...
  virtual Gcad::ErrorStatus createLayoutFromTemplate(const GCHAR* newLayoutName,
                                                     GcDbObjectId& newLayoutId,
                                                     const GCHAR* templatePath,
