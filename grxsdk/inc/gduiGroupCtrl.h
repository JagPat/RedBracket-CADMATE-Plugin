...
{
  GdUiBmpBtnData() : pBmp(NULL), pImage(NULL), fcnPtr(NULL), tooltip(""), dwCookie(0){};
...
public:
  ...
  virtual bool AddBmpBtnToHeader(LPCTSTR pszResName, GdUiBmpBtnFcnPtr fcnPtr, DWORD& dwCookie, LPCTSTR pszToolTip);

  virtual bool AddBmpBtnToHeader(CBitmap* pBmp, GdUiBmpBtnFcnPtr fcnPtr, DWORD& dwCookie, LPCTSTR pszToolTip);
...
private:
  ...
  bool addBmpBtnToHeader(
    LPCTSTR strResId, CBitmap* pBmp, void* pImage, GdUiBmpBtnFcnPtr fcnPtr, DWORD& dwCookie, LPCTSTR pszToolTip);
