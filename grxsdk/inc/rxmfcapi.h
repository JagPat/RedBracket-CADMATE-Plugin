...
#  ifdef _GSOFT_WINDOWS_
GCAD_PORT BOOL gcedRegisterStatusBarMenuItem(GcStatusBarMenuItem* pItem, GcStatusBarMenuItem::GcStatusBarType nType);
GCAD_PORT BOOL gcedUnregisterStatusBarMenuItem(GcStatusBarMenuItem* pItem, GcStatusBarMenuItem::GcStatusBarType nType);
GCAD_PORT BOOL gcedSetStatusBarPaneID(GcPane* pPane, GcStatusBarMenuItem::GcStatusBarType nType, int nID);
#  endif
