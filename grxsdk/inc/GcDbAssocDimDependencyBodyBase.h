...
public:
  ...
  DBCONSTRAINTS_PORT explicit GcDbAssocDimDependencyBodyBase(
  ...
  DBCONSTRAINTS_PORT Gcad::ErrorStatus getVariableNameAndExpression(GcString& name,
                                                                    GcString& expression,
  ...
  DBCONSTRAINTS_PORT Gcad::ErrorStatus setEntityNameAndExpression(const GcString& name,
                                                                  const GcString& expression,
                                                                  const GcString& value);
  ...
  DBCONSTRAINTS_PORT static Gcad::ErrorStatus getNameAndExpressionFromEntityText(const GcString& entityText,
  ...
  DBCONSTRAINTS_PORT Gcad::ErrorStatus entityAttachmentPointMoved(
    const GcArray<GcDbSubentGeometry>& newAttachedGeometries, double measurement = 0.0);
