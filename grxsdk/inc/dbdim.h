...
namespace GcDmUtil
{
  ...
  GCDB_PORT Gcad::ErrorStatus findArrowId(const GCHAR* pName, GcDbObjectId& blockId, GcDbDatabase* pDb = 0);
  GCDB_PORT Gcad::ErrorStatus getArrowId(const GCHAR* pName, GcDbObjectId& blockId, GcDbDatabase* pDb = 0);
};
...
public:
  ...
  GcDbOrdinateDimension(Gsoft::Boolean useXAxis,
...
public:
  ...
  GcDbAlignedDimension(const GcGePoint3d& xLine1Point,
...
public:
  ...
  GcDbRotatedDimension(double rotation,
...
public:
  ...
  GcDb3PointAngularDimension(const GcGePoint3d& centerPoint,
                             const GcGePoint3d& xLine1Point,
                             const GcGePoint3d& xLine2Point,
...
public:
  ...
  GcDb2LineAngularDimension(const GcGePoint3d& xLine1Start,
...
public:
  GcDbRadialDimension();
  GcDbRadialDimension(const GcGePoint3d& center,
...
public:
  ...
  GcDbDiametricDimension(const GcGePoint3d& chordPoint,
...
public:
  GcDbArcDimension();
  GcDbArcDimension(const GcGePoint3d& centerPoint,
                   const GcGePoint3d& xLine1Point,
                   const GcGePoint3d& xLine2Point,
                   const GcGePoint3d& arcPoint,
                   const GCHAR* dimText = NULL,
...
public:
  ...
  GcDbRadialDimensionLarge(const GcGePoint3d& center,
                           const GcGePoint3d& chordPoint,
