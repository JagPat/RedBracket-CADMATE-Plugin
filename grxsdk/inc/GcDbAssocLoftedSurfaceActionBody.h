...
public:
  ...
  Gcad::ErrorStatus getContinuity(ProfileType type,
                                  int& continuity,
                                  GcString& expression = dummyString(),
                                  GcString& evaluatorId = dummyString()) const;
  Gcad::ErrorStatus setContinuity(ProfileType type,
                                  int continuity,
                                  const GcString& expression = GcString(),
                                  const GcString& evaluatorId = GcString());

  Gcad::ErrorStatus getBulge(ProfileType type,
                             double& bulge,
                             GcString& expression = dummyString(),
                             GcString& evaluatorId = dummyString()) const;
  Gcad::ErrorStatus setBulge(ProfileType type,
                             double bulge,
                             const GcString& expression = GcString(),
                             const GcString& evaluatorId = GcString());
