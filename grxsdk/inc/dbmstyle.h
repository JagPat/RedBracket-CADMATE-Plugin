...
public:
  ...
  Gcad::ErrorStatus addElement(
    int& index, double offset, const GcCmColor& color, GcDbObjectId linetypeId, bool checkIfReferenced = true);
  Gcad::ErrorStatus removeElementAt(int elem);

  int numElements() const;

  Gcad::ErrorStatus setElement(int& elem, double offset, const GcCmColor& color, GcDbObjectId linetypeId);
  Gcad::ErrorStatus getElementAt(int elem, double& offset, GcCmColor& color, GcDbObjectId& linetypeId) const;
