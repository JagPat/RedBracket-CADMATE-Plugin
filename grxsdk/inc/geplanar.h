...
class GE_DLLEXPIMPORT GcGePlanarEnt : public GcGeSurface
{
public:
  ...
  Gsoft::Boolean isParallelTo(const GcGeLinearEnt3d& linEnt, const GcGeTol& tol = GcGeContext::gTol) const;
  Gsoft::Boolean isParallelTo(const GcGePlanarEnt& otherPlnEnt, const GcGeTol& tol = GcGeContext::gTol) const;

  Gsoft::Boolean isPerpendicularTo(const GcGeLinearEnt3d& linEnt, const GcGeTol& tol = GcGeContext::gTol) const;
  Gsoft::Boolean isPerpendicularTo(const GcGePlanarEnt& linEnt, const GcGeTol& tol = GcGeContext::gTol) const;

  Gsoft::Boolean isCoplanarTo(const GcGePlanarEnt& otherPlnEnt, const GcGeTol& tol = GcGeContext::gTol) const;
