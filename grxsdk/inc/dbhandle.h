...
inline GcDbHandle::GcDbHandle(Gsoft::UInt64 val)
{
  this->set64BitVal(val);
}

inline GcDbHandle& GcDbHandle::operator=(const GcDbHandle& handle)
{
...
inline GcDbHandle& GcDbHandle::operator=(Gsoft::UInt64 val)
{
  this->set64BitVal(val);
  return *this;
}

inline GcDbHandle GcDbHandle::operator+(const GcDbHandle& handle) const
{
...
inline GcDbHandle GcDbHandle::operator+(Gsoft::ULongPtr val) const
{
  GcDbHandle tHandle(*this);
...
inline bool GcDbHandle::operator>(const GcDbHandle& handle) const
{
  return this->get64BitVal() > handle.get64BitVal();
}

inline int GcDbHandle::compare(const GcDbHandle& handle) const
{
...
inline bool GcDbHandle::isNull(void) const
{
...
inline bool GcDbHandle::isOne(void) const
{
  return this->get64BitVal() == 1;
}

inline GcDbHandle& GcDbHandle::operator++(void)
{
...
inline void GcDbHandle::increment(void)
{
  this->set64BitVal(get64BitVal() + 1);
}

inline void GcDbHandle::decrement(void)
{
  this->set64BitVal(get64BitVal() - 1);
}

inline GcDbHandle GcDbHandle::operator++(int)
{
