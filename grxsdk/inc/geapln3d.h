...
class GE_DLLEXPIMPORT GcGeAugPolyline3d : public GcGePolyline3d
{
public:
  GcGeAugPolyline3d();
  GcGeAugPolyline3d(const GcGeAugPolyline3d& apline);
  GcGeAugPolyline3d(const GcGeKnotVector& knots, const GcGePoint3dArray& cntrlPnts, const GcGeVector3dArray& vecBundle);
  GcGeAugPolyline3d(const GcGePoint3dArray& cntrlPnts, const GcGeVector3dArray& vecBundle);
  GcGeAugPolyline3d(const GcGeCurve3d& curve, double fromParam, double toParam, double apprEps);
