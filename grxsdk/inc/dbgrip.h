...
typedef bool (*GripWorldDrawPtr)(GcDbGripData* pThis,
                                 GcGiWorldDraw* pWd,
                                 const GcDbObjectId& entId,
                                 GcDbGripOperations::DrawType type,
                                 GcGePoint3d* imageGripPoint,
                                 double dGripSize);

typedef void (*GripViewportDrawPtr)(GcDbGripData* pThis,
                                    GcGiViewportDraw* pWd,
                                    const GcDbObjectId& entId,
                                    GcDbGripOperations::DrawType type,
                                    GcGePoint3d* imageGripPoint,
                                    int gripSize);

typedef void (*GripOpStatusPtr)(GcDbGripData* pThis, const GcDbObjectId& entId, GcDbGripOperations::GripStatus stat);
...
typedef void (*GripDimensionPtr)(GcDbGripData* pThis,
                                 const GcDbObjectId& entId,
                                 double dimScale,
                                 GcDbDimDataPtrArray& dimData);

typedef GcDbGripOperations::ReturnValue (*GripInputPointPtr)(
  GcDbGripData* pThis,
  const GcDbObjectId& entId,
  bool& changedPoint,
  GcGePoint3d& newPoint,
  const GcGiViewport& viewContext,
  const GcDbObjectId& viewportId,
  bool pointComputed,
  int history,
  const GcGePoint3d& lastPoint,
  const GcGePoint3d& rawPoint,
  const GcGePoint3d& grippedPoint,
  const GcGePoint3d& cartesianSnappedPoint,
  const GcGePoint3d& osnappedPoint,
  ...
  const GcArray<GcDbObjectIdArray, GcArrayObjectCopyReallocator<GcDbObjectIdArray>>& nestedPickedEntities,
  const GcArray<Gsoft::GsMarker>& gsSelectionMark,
  const GcArray<GcDbObjectId>& keyPointEntities,
  const GcArray<GcDbObjectIdArray, GcArrayObjectCopyReallocator<GcDbObjectIdArray>>& nestedKeyPointEntities,
  const GcArray<Gsoft::GsMarker>& keyPointGsSelectionMark,
  const GcArray<GcGeCurve3d*>& alignmentPaths,
  const GcGePoint3d& computedPoint);

class GcDbGripData
{
public:
  GcDbGripData();
  GcDbGripData(const GcGePoint3d&,
               void*,
               GripOperationPtr hotGrip = NULL,
               GripOperationPtr hoverGrip = NULL,
               GripRtClkHandler RtClk = NULL,
               GripWorldDrawPtr wd = NULL,
               GripViewportDrawPtr vd = NULL,
               GripOpStatusPtr stat = NULL,
               GripToolTipPtr tt = NULL,
               GripDimensionPtr hoverDim = NULL,
               GripDimensionPtr hotGripDim = NULL,
               unsigned int bitFlags = 0,
               GcGePoint3d* altBasePt = NULL,
  ...
  void setAllData(const GcGePoint3d&,
                  void*,
                  GripOperationPtr hotGrip = NULL,
                  GripOperationPtr hoverGrip = NULL,
                  GripRtClkHandler RtClk = NULL,
...
inline GcDbGripData::GcDbGripData(const GcGePoint3d& pt,
                                  void* AppData,
...
inline void GcDbGripData::setAllData(const GcGePoint3d& pt,
                                     void* AppData,
                                     GripOperationPtr hotGrip,
                                     GripOperationPtr hoverGrip,
                                     GripRtClkHandler RtClk,
...
inline const GcGePoint3d& GcDbGripData::gripPoint() const
{
  return m_gripPt;
}

inline void GcDbGripData::setGripPoint(const GcGePoint3d& pt)
{
  m_gripPt = pt;
}

inline void* GcDbGripData::appData() const
{
  return m_pAppData;
}

inline void GcDbGripData::setAppData(void* appData)
{
  m_pAppData = appData;
}

inline GcRxClass* GcDbGripData::appDataGcRxClass() const
{
  return m_pAppDataClass;
}

inline void GcDbGripData::setAppDataGcRxClass(GcRxClass* appDataClass)
{
  m_pAppDataClass = appDataClass;
}

inline GripOperationPtr GcDbGripData::hotGripFunc() const
{
  return m_pHotGripFunc;
}

inline void GcDbGripData::setHotGripFunc(GripOperationPtr pFunc)
{
  m_pHotGripFunc = pFunc;
}

inline GripOperationPtr GcDbGripData::hoverFunc() const
{
  return m_pHoverFunc;
}

inline void GcDbGripData::setHoverFunc(GripOperationPtr pFunc)
{
  m_pHoverFunc = pFunc;
}

inline GripRtClkHandler GcDbGripData::rtClk() const
{
  return m_pRtClk.oldHandler;
}

inline void GcDbGripData::setRtClk(GripRtClkHandler pFunc)
{
  m_bitFlags &= ~GcDbGripOperations::kGripRightClickIsNewStyle;
  m_pRtClk.oldHandler = pFunc;
}

inline GripRightClickHandler GcDbGripData::righClick() const
{
  return m_pRtClk.newHandler;
}

inline void GcDbGripData::setRightClick(GripRightClickHandler pFunc)
{
  m_bitFlags |= GcDbGripOperations::kGripRightClickIsNewStyle;
  m_pRtClk.newHandler = pFunc;
}

inline GripWorldDrawPtr GcDbGripData::worldDraw() const
{
  return m_pWorldDraw;
}

inline void GcDbGripData::setWorldDraw(GripWorldDrawPtr pFunc)
{
  m_pWorldDraw = pFunc;
}

inline GripViewportDrawPtr GcDbGripData::viewportDraw() const
{
  return m_pViewportDraw;
}

inline void GcDbGripData::setViewportDraw(GripViewportDrawPtr pFunc)
{
  m_pViewportDraw = pFunc;
}

inline GripOpStatusPtr GcDbGripData::gripOpStatFunc() const
{
  return m_pGripOpStatFunc;
}

inline void GcDbGripData::setGripOpStatFunc(GripOpStatusPtr pFunc)
{
  m_pGripOpStatFunc = pFunc;
}

inline GripToolTipPtr GcDbGripData::toolTipFunc() const
{
  return m_pToolTipFunc;
}

inline void GcDbGripData::setToolTipFunc(GripToolTipPtr pFunc)
{
  m_pToolTipFunc = pFunc;
}

inline GripDimensionPtr GcDbGripData::hoverDimensionFunc() const
{
  return m_pHoverDimensionFunc;
}

inline void GcDbGripData::setHoverDimensionFunc(GripDimensionPtr pFunc)
{
  m_pHoverDimensionFunc = pFunc;
}

inline GripDimensionPtr GcDbGripData::hotGripDimensionFunc() const
{
  return m_pHotGripDimensionFunc;
}

inline void GcDbGripData::setHotGripDimensionFunc(GripDimensionPtr pFunc)
{
  m_pHotGripDimensionFunc = pFunc;
}

inline GcGePoint3d* GcDbGripData::alternateBasePoint() const
{
  return m_pAltBasePt;
}

inline void GcDbGripData::setAlternateBasePoint(GcGePoint3d* altBasePt)
{
  m_pAltBasePt = altBasePt;
}

inline unsigned int GcDbGripData::bitFlags() const
{
  return m_bitFlags;
}

inline void GcDbGripData::setBitFlags(unsigned int flags)
{
  m_bitFlags = flags;
}

inline bool GcDbGripData::skipWhenShared() const
{
  return !!(m_bitFlags & GcDbGripOperations::kSkipWhenShared);
}

inline void GcDbGripData::setSkipWhenShared(bool skip)
{
  if (skip)
...
inline bool GcDbGripData::isRubberBandLineDisabled() const
{
  return !!(m_bitFlags & GcDbGripOperations::kDisableRubberBandLine);
}

inline void GcDbGripData::disableRubberBandLine(bool disable)
{
  if (disable)
...
inline bool GcDbGripData::areModeKeywordsDisabled() const
{
  return !!(m_bitFlags & GcDbGripOperations::kDisableModeKeywords);
}

inline void GcDbGripData::disableModeKeywords(bool disable)
{
  if (disable)
...
inline bool GcDbGripData::drawAtDragImageGripPoint() const
{
  return !!(m_bitFlags & GcDbGripOperations::kDrawAtDragImageGripPoint);
}

inline void GcDbGripData::setDrawAtDragImageGripPoint(bool atDragPoint)
{
  if (atDragPoint)
...
inline bool GcDbGripData::triggerGrip() const
{
  return !!(m_bitFlags & GcDbGripOperations::kTriggerGrip);
}

inline void GcDbGripData::setTriggerGrip(bool trigger)
{
  if (trigger)
    m_bitFlags |= GcDbGripOperations::kTriggerGrip | GcDbGripOperations::kSkipWhenShared;
  else
    m_bitFlags &= ~(GcDbGripOperations::kTriggerGrip | GcDbGripOperations::kSkipWhenShared);
}

inline GripInputPointPtr GcDbGripData::inputPointFunc() const
{
  return m_pInputPointFunc;
}

inline void GcDbGripData::setInputPointFunc(GripInputPointPtr pFunc)
{
  m_pInputPointFunc = pFunc;
}

inline bool GcDbGripData::forcedPickOn() const
{
  return !!(m_bitFlags & GcDbGripOperations::kTurnOnForcedPick);
}

inline void GcDbGripData::setForcedPickOn(bool on)
{
  if (on)
...
inline bool GcDbGripData::mapGripHotToRtClk() const
{
  return !!(m_bitFlags & GcDbGripOperations::kMapGripHotToRtClk);
}

inline void GcDbGripData::setMapGripHotToRtClk(bool on)
{
  if (on)
...
inline bool GcDbGripData::gizmosEnabled() const
{
  return !!(m_bitFlags & GcDbGripOperations::kGizmosEnabled);
}

inline void GcDbGripData::setGizmosEnabled(bool on)
{
  if (on)
...
inline bool GcDbGripData::gripIsPerViewport() const
{
  return !!(m_bitFlags & GcDbGripOperations::kGripIsPerViewport);
}

inline void GcDbGripData::setGripIsPerViewport(bool on)
{
  if (on)
...
inline bool GcDbGripData::gripIsDisabled() const
{
  return !!(m_bitFlags & GcDbGripOperations::kGripIsDisabled);
}

inline void GcDbGripData::disableGrip(bool disable)
{
  if (disable)
...
inline bool GcDbGripData::gripRightClickIsNewStyle() const
{
  return !!(m_bitFlags & GcDbGripOperations::kGripRightClickIsNewStyle);
}

inline GripCLIPromptPtr GcDbGripData::getCLIPromptFunc() const
{
  return m_pCLIPromptFunc;
}

inline void GcDbGripData::setCLIPromptFunc(GripCLIPromptPtr pFunc)
{
  m_pCLIPromptFunc = pFunc;
}

inline GripCLIDisplayStringPtr GcDbGripData::getCLIDisplayStringFunc() const
{
  return m_pCLIDisplayStringFunc;
}

inline void GcDbGripData::setCLIDisplayStringFunc(GripCLIDisplayStringPtr pFunc)
{
