...
public:
  ...
  Gcad::ErrorStatus addDependency(const GcDbObjectId& dependencyId, bool setThisActionAsOwningAction = true) const;
  ...
  Gcad::ErrorStatus removeDependency(const GcDbObjectId& dependencyId, bool alsoEraseIt) const;
  ...
  Gcad::ErrorStatus addParam(const GcString& paramName,
                             GcRxClass* pParamClass,
  ...
  Gcad::ErrorStatus setValueParamControlledObjectDep(const GcString& paramName,
                                                     const GcDbObjectId& controlledObjectDepId) const;
  ...
  static Gcad::ErrorStatus createActionAndActionBodyAndPostToDatabase(GcRxClass* pActionBodyClass,
...
public:
  ...
  virtual Gcad::ErrorStatus addMoreObjectsToDeepCloneOverride(GcDbIdMapping&, GcDbObjectIdArray&) const
  {
    return Gcad::eNotImplemented;
  }
  ...
  virtual Gcad::ErrorStatus getDependentActionsToEvaluateOverride(
    GcDbActionsToEvaluateCallback* pActionsToEvaluateCallback) const
  {
