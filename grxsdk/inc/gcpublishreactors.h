...
public:
  ...
  GcNameValuePair(const GcNameValuePair& src) : m_pName(NULL), m_pValue(NULL)
  {
    *this = src;
  }
...
inline void GcPublishReactor::OnAboutToBeginBackgroundPublishing(GcPublishBeforeJobInfo* pInfo){};

inline void GcPublishReactor::OnAboutToBeginPublishing(GcPublishBeginJobInfo* pInfo){};

inline void GcPublishReactor::OnBeginPublishingSheet(GcPublishSheetInfo* pInfo){};

inline void GcPublishReactor::OnBeginAggregation(GcPublishAggregationInfo* pInfo){};

inline void GcPublishReactor::OnAboutToEndPublishing(GcPublishReactorInfo* pInfo){};

inline void GcPublishReactor::OnAboutToMoveFile(GcPublishReactorInfo* pInfo){};

inline void GcPublishReactor::OnEndPublish(GcPublishReactorInfo* pInfo){};

inline void GcPublishReactor::OnCancelledOrFailedPublishing(GcPublishReactorInfo* pInfo){};
