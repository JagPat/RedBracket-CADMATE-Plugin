...
public:
  ...
  virtual void addHead(const GCHAR* sName, const GCHAR* sDescription, const GCHAR* sSubLocation = NULL) = 0;
  virtual void addTail(const GCHAR* sName, const GCHAR* sDescription, const GCHAR* sSubLocation = NULL) = 0;
  virtual void addAt(const int nIndex,
                     const GCHAR* sName,
...
public:
  ...
  virtual Gcad::ErrorStatus setHyperlinkCollection(GcDbObject* pObj, GcDbHyperlinkCollection* pcHCL) = 0;
  ...
  virtual Gcad::ErrorStatus hasHyperlink(GcDbObject* pObj, bool& bHasHyperlink, bool bIgnoreBlockDefinition = true) = 0;
