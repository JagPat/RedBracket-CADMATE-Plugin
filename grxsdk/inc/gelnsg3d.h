...
class GE_DLLEXPIMPORT GcGeLineSeg3d : public GcGeLinearEnt3d
{
public:
  GcGeLineSeg3d();
  ...
  GcGeLineSeg3d& set(
    const GcGeCurve3d& curve1, const GcGeCurve3d& curve2, double& param1, double& param2, Gsoft::Boolean& success);
  GcGeLineSeg3d& set(const GcGeCurve3d& curve, const GcGePoint3d& point, double& param, Gsoft::Boolean& success);
