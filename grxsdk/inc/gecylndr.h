...
class GX_DLLEXPIMPORT GcGeCylinder : public GcGeSurface
{
public:
  GcGeCylinder();
  GcGeCylinder(double radius, const GcGePoint3d& origin, const GcGeVector3d& axisOfSymmetry);
  GcGeCylinder(double radius,
  ...
  GcGeCylinder& set(double radius, const GcGePoint3d& origin, const GcGeVector3d& axisOfSym);
  GcGeCylinder& set(double radius,
                    const GcGePoint3d& origin,
