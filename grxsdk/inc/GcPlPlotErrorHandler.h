...
public:
  ...
  GCPL_PORT virtual int messageBox(const GCHAR* pText, const GCHAR* pCaption, unsigned int uType, int defaultReturn);
...
protected:
  ...
  GCPL_PORT int appMessageBox(const GCHAR* pText, const GCHAR* pCaption, unsigned int uType, int defaultReturn);
