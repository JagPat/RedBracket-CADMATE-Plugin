...
GCCORE_PORT Gcad::ErrorStatus gcdbDetachXref(GcDbDatabase* pHostDb, const GcDbObjectId& xrefBlkId);
...
GCCORE_PORT Gcad::ErrorStatus gcdbGetHostDwgXrefGraph(GcDbDatabase* pHostDb,
                                                      GcDbXrefGraph& graph,
