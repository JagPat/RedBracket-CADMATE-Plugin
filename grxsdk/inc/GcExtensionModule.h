...
inline CGcExtensionModule::CGcExtensionModule() : m_bAttached(FALSE), m_hDefaultResource(NULL), m_hModuleResource(NULL)
{
#ifndef _GSOFT_MAC_
...
inline CGcModuleResourceOverride::CGcModuleResourceOverride() : CGcModuleResourceOverride(NULL)
{
}
...
#define GC_DECLARE_EXTENSION_MODULE(exm) extern CGcExtensionModule exm;
