...
public:
  ...
  GCDB_PORT Gcad::ErrorStatus setSubDMesh(const GcGePoint3dArray& vertexArray,
                                          ...
                                          int subDLevel);
  GCDB_PORT Gcad::ErrorStatus setSphere(double radius, int divAxis, int divHeight, int subDLevel);
  GCDB_PORT Gcad::ErrorStatus setCylinder(
    double majorRadius, double minorRadius, double height, int divAxis, int divHeight, int divCap, int subDLevel);
  ...
  GCDB_PORT Gcad::ErrorStatus setTorus(double majorRadius,
                                       ...
                                       int subDLevel);
  GCDB_PORT Gcad::ErrorStatus setBox(
    double xLen, double yLen, double zLen, int divX, int divY, int divZ, int subDLevel);
  ...
  GCDB_PORT Gcad::ErrorStatus numOfSubDividedFacesAt(const GcDbFullSubentPathArray& subentPaths,
                                                     Gsoft::Int32& result) const;
  ...
  GCDB_PORT Gcad::ErrorStatus getSubentPath(Gsoft::Int32 nIndex,
                                            GcDb::SubentType type,
                                            GcDbFullSubentPathArray& subentPaths) const;
  GCDB_PORT Gcad::ErrorStatus convertToSurface(bool bConvertAsSmooth,
                                               const GcDbSubentId& id,
                                               GcDbSurface*& pSurface) const;
  ...
  GCDB_PORT Gcad::ErrorStatus setSphere(const GcGeMatrix3d& xForm, int divAxis, int divHeight, int subDLevel);
  GCDB_PORT Gcad::ErrorStatus setCylinder(
    const GcGeMatrix3d& xForm, int divAxis, int divHeight, int divCap, int subDLevel);
  GCDB_PORT Gcad::ErrorStatus setCone(
    const GcGeMatrix3d& xForm, int divAxis, int divHeight, int divCap, double radiusRatio, int subDLevel);
  GCDB_PORT Gcad::ErrorStatus setTorus(const GcGeMatrix3d& xForm,
                                       ...
                                       double sectionRotate,
                                       int subDLevel);
  GCDB_PORT Gcad::ErrorStatus setBox(const GcGeMatrix3d& xForm, int divX, int divY, int divZ, int subDLevel);
  GCDB_PORT Gcad::ErrorStatus setWedge(
    const GcGeMatrix3d& xForm, int divLength, int divWidth, int divHeight, int divSlope, int divCap, int subDLevel);
  GCDB_PORT Gcad::ErrorStatus setPyramid(
    const GcGeMatrix3d& xForm, int divLength, int divHeight, int divCap, int nSides, double radiusRatio, int subDLevel);
