...
public:
  ...
  GE_DLLEXPIMPORT static GcGeMatrix3d translation(const GcGeVector3d& vec);
  GE_DLLEXPIMPORT static GcGeMatrix3d rotation(double angle,
                                               const GcGeVector3d& axis,
                                               const GcGePoint3d& center = GcGePoint3d::kOrigin);
  GE_DLLEXPIMPORT static GcGeMatrix3d scaling(double scaleAll, const GcGePoint3d& center = GcGePoint3d::kOrigin);
  GE_DLLEXPIMPORT static GcGeMatrix3d mirroring(const GcGePlane& pln);
  GE_DLLEXPIMPORT static GcGeMatrix3d mirroring(const GcGePoint3d& pnt);
  GE_DLLEXPIMPORT static GcGeMatrix3d mirroring(const GcGeLine3d& line);
  GE_DLLEXPIMPORT static GcGeMatrix3d projection(const GcGePlane& projectionPlane, const GcGeVector3d& projectDir);
  GE_DLLEXPIMPORT static GcGeMatrix3d alignCoordSys(const GcGePoint3d& fromOrigin,
                                                    const GcGeVector3d& fromXAxis,
                                                    const GcGeVector3d& fromYAxis,
                                                    const GcGeVector3d& fromZAxis,
                                                    const GcGePoint3d& toOrigin,
  ...
  GE_DLLEXPIMPORT static GcGeMatrix3d worldToPlane(const GcGeVector3d& normal);
  GE_DLLEXPIMPORT static GcGeMatrix3d worldToPlane(const GcGePlane&);
  GE_DLLEXPIMPORT static GcGeMatrix3d planeToWorld(const GcGeVector3d& normal);
  GE_DLLEXPIMPORT static GcGeMatrix3d planeToWorld(const GcGePlane&);
