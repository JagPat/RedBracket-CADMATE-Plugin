...
public:
  ...
  bool operator!=(const GcDbCompoundObjectId& other) const
  {
    return !(*this == other);
  }
...
public:
  ...
  virtual Gcad::ErrorStatus getParentTransformOfChild(const GcDbObject* pThisParent,
                                                      const GcDbObjectId& childId,
                                                      GcGeMatrix3d&) = 0;
};
