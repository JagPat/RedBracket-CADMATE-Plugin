...
public:
  ...
  GcGeCurve2d* intParamCurve(int num,
                             Gsoft::Boolean isExternal,
                             Gsoft::Boolean isFirst,
  ...
  GcGeSurfSurfInt& set(const GcGeSurface& srf1, const GcGeSurface& srf2, const GcGeTol& tol = GcGeContext::gTol);
