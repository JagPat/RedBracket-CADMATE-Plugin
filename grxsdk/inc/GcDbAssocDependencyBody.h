...
public:
  ...
  DBCONSTRAINTS_PORT virtual Gcad::ErrorStatus isDependentOnTheSameThingAsOverride(
    const GcDbAssocDependency* pOtherDependency, bool& isDependentOnSameThing) const
  {
  ...
  DBCONSTRAINTS_PORT virtual Gcad::ErrorStatus isEqualToOverride(const GcDbAssocDependency* pOtherDependency,
                                                                 bool& isEqual) const
  {
    GSOFT_UNREFED_PARAM(pOtherDependency);
