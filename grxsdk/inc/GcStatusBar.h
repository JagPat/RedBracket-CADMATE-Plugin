...
public:
  ...
  SB_DEPRECATED void SetCallback(GcTrayItemAnimationCallbackFunc pCallbackFunc,
                                 GcTrayItemAnimationCallbackData pCallbackData)
  {
  ...
  SB_DEPRECATED GcTrayItemAnimationCallbackFunc GetCallbackFunc() const
  {
    return m_pCallbackFunc;
  }
  SB_DEPRECATED GcTrayItemAnimationCallbackData GetCallbackData() const
  {
...
public:
  ...
  GcTrayItemBubbleWindowControl(const CString& strTitle,
  ...
  void SetCallback(GcTrayItemBubbleWindowCallbackFunc pCallbackFunc,
                   GcTrayItemBubbleWindowCallbackData pCallbackData = 0)
  {
    m_pCallbackFunc = pCallbackFunc;
    m_pCallbackData = pCallbackData;
  }
  ...
  GcTrayItemBubbleWindowCallbackFunc GetCallbackFunc() const
  {
    return m_pCallbackFunc;
  }
  GcTrayItemBubbleWindowCallbackData GetCallbackData() const
  {
    return m_pCallbackData;
  }
