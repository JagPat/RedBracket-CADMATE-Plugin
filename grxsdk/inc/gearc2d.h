...
class GE_DLLEXPIMPORT GcGeCircArc2d : public GcGeCurve2d
{
public:
  GcGeCircArc2d();
  GcGeCircArc2d(const GcGeCircArc2d& arc);
  GcGeCircArc2d(const GcGePoint2d& cent, double radius);
  GcGeCircArc2d(const GcGePoint2d& cent,
                double radius,
                double startAngle,
                double endAngle,
                const GcGeVector2d& refVec = GcGeVector2d::kXAxis,
                Gsoft::Boolean isClockWise = Gsoft::kFalse);
  GcGeCircArc2d(const GcGePoint2d& startPoint, const GcGePoint2d& point, const GcGePoint2d& endPoint);
  GcGeCircArc2d(const GcGePoint2d& startPoint,
  ...
  Gsoft::Boolean intersectWith(const GcGeCircArc2d& arc,
                               int& intn,
                               GcGePoint2d& p1,
                               GcGePoint2d& p2,
                               const GcGeTol& tol = GcGeContext::gTol) const;

  Gsoft::Boolean tangent(const GcGePoint2d& pnt, GcGeLine2d& line, const GcGeTol& tol = GcGeContext::gTol) const;
  Gsoft::Boolean tangent(const GcGePoint2d& pnt, GcGeLine2d& line, const GcGeTol& tol, GcGeError& error) const;

  Gsoft::Boolean isInside(const GcGePoint2d& pnt, const GcGeTol& tol = GcGeContext::gTol) const;
  ...
  GcGeCircArc2d& set(const GcGePoint2d& cent,
                     double radius,
                     double ang1,
                     double ang2,
                     const GcGeVector2d& refVec = GcGeVector2d::kXAxis,
                     Gsoft::Boolean isClockWise = Gsoft::kFalse);
  GcGeCircArc2d& set(const GcGePoint2d& startPoint, const GcGePoint2d& pnt, const GcGePoint2d& endPoint);
  GcGeCircArc2d& set(const GcGePoint2d& startPoint,
                     const GcGePoint2d& pnt,
                     const GcGePoint2d& endPoint,
                     GcGeError& error);
  GcGeCircArc2d& set(const GcGePoint2d& startPoint,
                     const GcGePoint2d& endPoint,
