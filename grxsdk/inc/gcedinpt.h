...
public:
  ...
  GCCORE_PORT const GcArray<GcDbObjectIdArray, GcArrayObjectCopyReallocator<GcDbObjectIdArray>>& nestedPickedEntities()
    const;
...
public:
  ...
  virtual GcEdInputPointFilter* revokeInputFilter(GcEdInputPointFilter*)
  {
    return this;
  }
};
...
public:
  ...
  virtual bool excludeFromOsnapCalculation(const GcArray<GcDbObjectId>&, Gsoft::GsMarker)
  {
    return false;
  }
};
...
public:
  ...
  virtual void beginGetPoint(const GcGePoint3d*, const GCHAR*, int, const GCHAR*)
  {
  }
  virtual void endGetPoint(Gcad::PromptStatus, const GcGePoint3d&, const GCHAR*&)
  {
  }

  virtual void beginGetAngle(const GcGePoint3d*, const GCHAR*, int, const GCHAR*)
  {
  }
  virtual void endGetAngle(Gcad::PromptStatus, double&, const GCHAR*&)
  {
  }

  virtual void beginGetDistance(const GcGePoint3d*, const GCHAR*, int, const GCHAR*)
  {
  }
  virtual void endGetDistance(Gcad::PromptStatus, double&, const GCHAR*&)
  {
  }

  virtual void beginGetOrientation(const GcGePoint3d*, const GCHAR*, int, const GCHAR*)
  {
  }
  virtual void endGetOrientation(Gcad::PromptStatus, double&, const GCHAR*&)
  {
  }

  virtual void beginGetCorner(const GcGePoint3d*, const GCHAR*, int, const GCHAR*)
  {
  }
  virtual void endGetCorner(Gcad::PromptStatus, GcGePoint3d&, const GCHAR*&)
  {
  }

  virtual void beginGetScaleFactor(const GcGePoint3d*, const GCHAR*, int, const GCHAR*)
  {
  }
  virtual void endGetScaleFactor(Gcad::PromptStatus, double&, const GCHAR*&)
  {
  }

  virtual void beginGetString(const GCHAR*, int)
  {
  }
  virtual void endGetString(Gcad::PromptStatus, GCHAR*)
  {
  }

  virtual void beginGetKeyword(const GCHAR*, int, const GCHAR*)
  {
  }
  virtual void endGetKeyword(Gcad::PromptStatus, const GCHAR*&)
  {
  }

  virtual void beginGetInteger(const int*, const GCHAR*, int, const GCHAR*)
  {
  }
  virtual void endGetInteger(Gcad::PromptStatus, int&, const GCHAR*&)
  {
  }

  virtual void beginGetColor(const int*, const GCHAR*, int, const GCHAR*)
  {
  }
  virtual void endGetColor(Gcad::PromptStatus, int&, const GCHAR*&)
  {
  }
  virtual void beginGetReal(const double*, const GCHAR*, int, const GCHAR*)
  {
  }

  virtual void endGetReal(Gcad::PromptStatus, double&, const GCHAR*&)
  {
  }

  virtual void beginEntsel(const GCHAR*, int, const GCHAR*)
  {
  }
  virtual void endEntsel(Gcad::PromptStatus, GcDbObjectId&, GcGePoint3d&, const GCHAR*)
  {
  }

  virtual void beginNentsel(const GCHAR*, Gsoft::Boolean, int, const GCHAR*)
  {
  }
  virtual void endNentsel(
    Gcad::PromptStatus, GcDbObjectId, const GcGePoint3d&, const GcGeMatrix3d&, const resbuf*, const GCHAR*)
  {
  }

  virtual void beginSSGet(const GCHAR*, int, const GCHAR*, const GCHAR*, const GcArray<GcGePoint3d>&, const resbuf*)
  {
  }
  virtual void endSSGet(Gcad::PromptStatus, const GcArray<GcDbObjectId>&)
  {
  }
  ...
  virtual void endDragSequence(Gcad::PromptStatus, GcGePoint3d&, GcGeVector3d&)
  {
  }
