...
class GE_DLLEXPIMPORT GcGeCurveCurveInt2d : public GcGeEntity2d
{
public:
  GcGeCurveCurveInt2d();
  GcGeCurveCurveInt2d(const GcGeCurve2d& curve1, const GcGeCurve2d& curve2, const GcGeTol& tol = GcGeContext::gTol);
  GcGeCurveCurveInt2d(const GcGeCurve2d& curve1,
  ...
  void getIntRanges(GcGeInterval& range1, GcGeInterval& range2) const;
  ...
  void getIntConfigs(int intNum, GcGe::GcGeXConfig& config1wrt2, GcGe::GcGeXConfig& config2wrt1) const;
  ...
  void getOverlapRanges(int overlapNum, GcGeInterval& range1, GcGeInterval& range2) const;
