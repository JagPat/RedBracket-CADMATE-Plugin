...
public:
  ...
  GCPL_PORT void getUnrecognizedData(GcArray<GCHAR*>& sectionArray, GcArray<GCHAR*>& dataArray) const;
  GCPL_PORT void setUnrecognizedData(const GcArray<GCHAR*>& sectionArray, const GcArray<GCHAR*>& dataArray);
  GCPL_PORT void setUnrecognizedData(const GCHAR* pSectionName, const GCHAR* pSectionData);

  GCPL_PORT void setUnrecognizedData(const GcStringArray& sectionArray, const GcStringArray& dataArray);
  GCPL_PORT void getUnrecognizedData(GcStringArray& sectionArray, GcStringArray& dataArray) const;
  ...
  GCPL_PORT void setPwdProtectPublishedDWF(bool bPwdProtectPublishedDWF);
