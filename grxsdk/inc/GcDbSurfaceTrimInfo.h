...
public:
  ...
  DBCONSTRAINTS_PORT void setTrimInfo(const GcDbCompoundObjectId& curveId,
                                      const GcGeVector3d& projVector,
  ...
  DBCONSTRAINTS_PORT void setTrimInfo(const GcDbCompoundObjectId& surfaceId,
                                      TrimRelation relation,
