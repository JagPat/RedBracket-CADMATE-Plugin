...
public:
  ...
  virtual Gcad::ErrorStatus setFieldId(
    int nRow, int nCol, int nIndex, const GcDbObjectId& idField, GcDb::CellOption nFlag);
  ...
  virtual Gcad::ErrorStatus setGridLineStyle(int nRow,
                                             int nCol,
  ...
  virtual Gcad::ErrorStatus setGridVisibility(int nRow,
                                              int nCol,
                                              GcDb::GridLineType nGridLineTypes,
                                              GcDb::Visibility nVisibility);
  virtual double gridDoubleLineSpacing(int nRow, int nCol, GcDb::GridLineType nGridLineType) const;
  virtual Gcad::ErrorStatus setGridDoubleLineSpacing(int nRow,
                                                     int nCol,
                                                     GcDb::GridLineType nGridLineTypes,
                                                     double fSpacing);
  virtual Gcad::ErrorStatus getGridProperty(int nRow,
                                            int nCol,
                                            GcDb::GridLineType nGridLineType,
                                            GcGridProperty& gridProp) const;
  virtual Gcad::ErrorStatus setGridProperty(int nRow,
                                            int nCol,
                                            GcDb::GridLineType nGridLineTypes,
                                            const GcGridProperty& gridProp);
  virtual Gcad::ErrorStatus setGridProperty(const GcCellRange& range,
                                            GcDb::GridLineType nGridLineTypes,
                                            const GcGridProperty& gridProp);
  ...
  virtual Gcad::ErrorStatus setOverride(int nRow,
                                        int nCol,
                                        GcDb::GridLineType nGridLineType,
