...
public:
  ...
  virtual Gcad::ErrorStatus getOsnapInfo(GcDbEntity* pickedObject,
...
protected:
  ...
  Gsoft::Boolean subWorldDraw(GcGiWorldDraw*) override
  {
    return Gsoft::kFalse;
  };
...
extern "C" __declspec(dllexport) bool gcedIsOsnapOverride();
