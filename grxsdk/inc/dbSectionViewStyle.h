...
public:
  ...
  GCDB_PORT Gcad::ErrorStatus getViewLabelPattern(GcString& pattern, GcDbField* pField = NULL) const;
  GCDB_PORT Gcad::ErrorStatus setViewLabelPattern(const GCHAR* pattern, const GcDbField* pField = NULL);
...
protected:
  GCDB_PORT Gcad::ErrorStatus subDeepClone(GcDbObject* pOwner,
                                           GcDbObject*& pClonedObject,
                                           GcDbIdMapping& idMap,
                                           Gsoft::Boolean isPrimary = true) const override;
  GCDB_PORT Gcad::ErrorStatus subWblockClone(GcRxObject* pOwner,
                                             GcDbObject*& pClonedObject,
                                             GcDbIdMapping& idMap,
                                             Gsoft::Boolean isPrimary = true) const override;
};
