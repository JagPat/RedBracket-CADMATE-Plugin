...
inline GcDb::SubentType GcDbSubentId::type() const
{
  return mType;
}

inline void GcDbSubentId::setType(GcDb::SubentType type)
{
  mType = type;
...
inline Gsoft::GsMarker GcDbSubentId::index() const
{
  return mIndex;
}

inline void GcDbSubentId::setIndex(Gsoft::GsMarker index)
{
  mIndex = index;
}

inline GcRxClass* GcDbSubentId::typeClass() const
{
  return mpTypeClass;
}

inline void GcDbSubentId::setTypeClass(GcRxClass* pTypeClass)
{
...
inline GcDbSubentId::GcDbSubentId() : mType(GcDb::kNullSubentType), mIndex(kNullSubentIndex), mpTypeClass(nullptr)
{
}

inline GcDbSubentId::GcDbSubentId(GcDb::SubentType t, Gsoft::GsMarker i) : mType(t), mIndex(i), mpTypeClass(nullptr)
{
}

inline GcDbSubentId::GcDbSubentId(GcRxClass* pTypeClass, Gsoft::GsMarker i)
  : mType(GcDb::kClassSubentType), mIndex(i), mpTypeClass(pTypeClass)
{
}

inline bool GcDbSubentId::operator==(const GcDbSubentId& id) const
{
...
inline GcDbFullSubentPath::GcDbFullSubentPath() : mpUserAppData(NULL)
{
}

inline GcDbFullSubentPath::GcDbFullSubentPath(GcDb::SubentType type, Gsoft::GsMarker index)
  : mSubentId(type, index), mpUserAppData(NULL)
{
}

inline void GcDbFullSubentPath::objectIds(GcDbObjectIdArray& objectIds) const
{
  objectIds = mObjectIds;
}

inline GcDbObjectIdArray& GcDbFullSubentPath::objectIds()
{
  return mObjectIds;
}

inline const GcDbObjectIdArray& GcDbFullSubentPath::objectIds() const
{
  return mObjectIds;
}

inline const GcDbSubentId GcDbFullSubentPath::subentId() const
{
  return mSubentId;
}

inline GcDbSubentId& GcDbFullSubentPath::subentId()
{
  return mSubentId;
}

inline void* GcDbFullSubentPath::userAppData() const
{
  return mpUserAppData;
}

inline void GcDbFullSubentPath::setUserAppData(void* pData)
{
  mpUserAppData = pData;
}

inline void GcDbFullSubentPath::setObjectIds(const GcDbObjectIdArray& objectIds)
{
  mObjectIds = objectIds;
}

inline void GcDbFullSubentPath::setSubentId(const GcDbSubentId& subentId)
{
  mSubentId = subentId;
}
