...
class GX_DLLEXPIMPORT GcGeCurveBoundary
{
public:
  GcGeCurveBoundary();
  GcGeCurveBoundary(int numberOfCurves,
                    const GcGeEntity3d* const* crv3d,
  ...
  void getContour(int& n,
                  GcGeEntity3d*** crv3d,
                  GcGeCurve2d*** paramGeometry,
                  Gsoft::Boolean** orientation3d,
                  Gsoft::Boolean** orientation2d) const;
  GcGeCurveBoundary& set(int numElements,
                         const GcGeEntity3d* const* crv3d,
                         const GcGeCurve2d* const* crv2d,
                         Gsoft::Boolean* orientation3d,
                         Gsoft::Boolean* orientation2d,
