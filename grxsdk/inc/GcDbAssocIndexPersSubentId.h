...
public:
  ...
  DBCONSTRAINTS_PORT explicit GcDbAssocIndexPersSubentId(GcDb::SubentType subentType = GcDb::kNullSubentType,
  ...
  DBCONSTRAINTS_PORT GcDb::SubentType subentType(const GcDbEntity*, GcDbDatabase*) const override
  {
    return mSubentType;
  }

  DBCONSTRAINTS_PORT bool isNull() const override
  {
    return mSubentType == GcDb::kNullSubentType;
  }
  ...
  DBCONSTRAINTS_PORT unsigned int index() const
  {
    return mIndex;
  }

  DBCONSTRAINTS_PORT void setSubentType(GcDb::SubentType subentType)
  {
    mSubentType = subentType;
  }
  DBCONSTRAINTS_PORT void setIndex(unsigned int newIndex)
  {
    mIndex = newIndex;
  }
...
public:
  ...
  DBCONSTRAINTS_PORT explicit GcDbAssocExternalIndexPersSubentId(GcDb::SubentType subentType = GcDb::kNullSubentType,
                                                                 unsigned int index = 0)
...
public:
  ...
  DBCONSTRAINTS_PORT GcDbAssocObjectAndIndexPersSubentId(const GcDbObjectId& objId,
  ...
  DBCONSTRAINTS_PORT GcDbObjectId objectId() const
  {
    return mObjectId;
  }
  DBCONSTRAINTS_PORT void setObjectId(const GcDbObjectId& objId)
  {
    mObjectId = objId;
  }
