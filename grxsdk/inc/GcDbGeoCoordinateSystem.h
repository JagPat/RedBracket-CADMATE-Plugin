...
public:
  ...
  static Gcad::ErrorStatus create(const GcString& coordSysIdOrFullDef, GcDbGeoCoordinateSystem*& pCoordSys);

  static Gcad::ErrorStatus createAll(const GcGePoint3d& geoPt, GcArray<GcDbGeoCoordinateSystem*>& allCoordSys);
