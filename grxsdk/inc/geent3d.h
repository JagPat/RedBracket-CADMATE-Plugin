...
class GE_DLLEXPIMPORT GcGeEntity3d
{
public:
  ~GcGeEntity3d();
  ...
  Gsoft::Boolean operator!=(const GcGeEntity3d& entity) const;
  Gsoft::Boolean isEqualTo(const GcGeEntity3d& ent, const GcGeTol& tol = GcGeContext::gTol) const;
  GcGeEntity3d& transformBy(const GcGeMatrix3d& xfm);
  GcGeEntity3d& translateBy(const GcGeVector3d& translateVec);
  GcGeEntity3d& rotateBy(double angle, const GcGeVector3d& vec, const GcGePoint3d& wrtPoint = GcGePoint3d::kOrigin);
  GcGeEntity3d& mirror(const GcGePlane& plane);
  GcGeEntity3d& scaleBy(double scaleFactor, const GcGePoint3d& wrtPoint = GcGePoint3d::kOrigin);
...
inline GcGeEntity2d* GcGeEntity3d::newEntity2d(GcGeImpEntity3d* impEnt) const
{
  return GENEWLOC(GcGeEntity2d, this)(impEnt);
}

inline GcGeEntity3d* GcGeEntity3d::newEntity3d(GcGeImpEntity3d* impEnt) const
{
  return GENEWLOC(GcGeEntity3d, this)(impEnt);
}

inline GcGeEntity3d* GcGeEntity3d::newEntity3d(GcGeImpEntity3d& impEnt, int dummy) const
{
  return GENEWLOC(GcGeEntity3d, this)(impEnt, dummy);
}

inline GcGeEntity2d* GcGeEntity3d::newEntity2d(GcGeImpEntity3d& impEnt, int dummy) const
{
