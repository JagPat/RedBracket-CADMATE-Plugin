...
public:
  union RGBM
  {
    ...
    struct
    {
      Gsoft::UInt8 blue, green, red, colorMethod;
    } mdata;
...
public:
  ...
  static Gcad::ErrorStatus setRGB(RGBM* rgbm, Gsoft::UInt8 red, Gsoft::UInt8 green, Gsoft::UInt8 blue);
...
inline GcCmEntityColor::GcCmEntityColor()
{
  mRGBM.whole = 0;
  mRGBM.mdata.colorMethod = kByColor;
}

inline GcCmEntityColor::GcCmEntityColor(const GcCmEntityColor& color)
{
  mRGBM.whole = color.mRGBM.whole;
}

inline GcCmEntityColor::GcCmEntityColor(ColorMethod eColorMethod)
{
  mRGBM.whole = 0;
  mRGBM.mdata.colorMethod = static_cast<Gsoft::UInt8>(eColorMethod);
}

inline GcCmEntityColor::GcCmEntityColor(Gsoft::UInt8 red, Gsoft::UInt8 green, Gsoft::UInt8 blue)
{
  mRGBM.mdata.red = red;
...
inline GcCmEntityColor& GcCmEntityColor::operator=(const GcCmEntityColor& color)
{
  mRGBM.whole = color.mRGBM.whole;
  return *this;
}

inline bool GcCmEntityColor::operator==(const GcCmEntityColor& color) const
{
...
inline GcCmEntityColor::ColorMethod GcCmEntityColor::colorMethod() const
{
  return (ColorMethod)mRGBM.mdata.colorMethod;
}

inline Gsoft::UInt32 GcCmEntityColor::color() const
{
  return mRGBM.whole;
}
...
inline Gsoft::UInt8 GcCmEntityColor::red() const
{
  return mRGBM.mdata.red;
}

inline Gsoft::UInt8 GcCmEntityColor::green() const
{
  return mRGBM.mdata.green;
}

inline Gsoft::UInt8 GcCmEntityColor::blue() const
{
  return mRGBM.mdata.blue;
}

inline bool GcCmEntityColor::isByColor() const
{
  return mRGBM.mdata.colorMethod == kByColor;
}

inline bool GcCmEntityColor::isByLayer() const
{
  return (mRGBM.mdata.colorMethod == kByLayer || (mRGBM.mdata.colorMethod == kByACI && mRGBM.indirect == kACIbyLayer)) ?
           true :
           false;
}

inline bool GcCmEntityColor::isByBlock() const
{
  return (mRGBM.mdata.colorMethod == kByBlock || (mRGBM.mdata.colorMethod == kByACI && mRGBM.indirect == kACIbyBlock)) ?
           true :
           false;
}

inline bool GcCmEntityColor::isByACI() const
{
  return mRGBM.mdata.colorMethod == kByACI;
}

inline bool GcCmEntityColor::isByPen() const
{
  return mRGBM.mdata.colorMethod == kByPen;
}

inline bool GcCmEntityColor::isForeground() const
{
  return (mRGBM.mdata.colorMethod == kForeground ||
          (mRGBM.mdata.colorMethod == kByACI && mRGBM.indirect == kACIforeground)) ?
           true :
           false;
}

inline bool GcCmEntityColor::isLayerOff() const
{
  return (mRGBM.mdata.colorMethod == kLayerOff ||
          (mRGBM.mdata.colorMethod == kByACI && mRGBM.indirect < 0 && mRGBM.indirect != kACIfrozenLayer)) ?
           true :
           false;
}

inline bool GcCmEntityColor::isLayerFrozen() const
{
  return (mRGBM.mdata.colorMethod == kLayerFrozen ||
          (mRGBM.mdata.colorMethod == kByACI && mRGBM.indirect == kACIfrozenLayer)) ?
           true :
           false;
}

inline bool GcCmEntityColor::isLayerFrozenOrOff() const
{
  return isLayerFrozen() || isLayerOff();
}

inline bool GcCmEntityColor::isNone() const
{
  return (mRGBM.mdata.colorMethod == kNone || (mRGBM.mdata.colorMethod == kByACI && mRGBM.indirect == kACInone)) ?
           true :
           false;
}

inline Gcad::ErrorStatus GcCmEntityColor::setRGB(Gsoft::UInt8 red, Gsoft::UInt8 green, Gsoft::UInt8 blue)
{
...
public:
  ...
  GcCmTransparency(const GcCmTransparency& other)
  {
  ...
  Gsoft::UInt32 serializeOut(void) const
  {
    return mAM.whole;
  }
