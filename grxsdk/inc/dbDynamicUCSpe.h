...
public:
  ...
  virtual Gcad::ErrorStatus getCandidatePlanes(GcArray<GcGePlane>& results,
                                               ...
                                               GcDbDynamicUCSPE::Flags flags = kDefault) const = 0;
};
...
public:
  ...
  virtual Gcad::ErrorStatus getCandidatePlane(GcDbEntity* Ent,
                                              const CPoint& pt,
                                              GcGePlane& result,
                                              double& distToEdge,
                                              double& objWidth,
                                              double& objHeight,
                                              void*& context) = 0;
  virtual Gcad::ErrorStatus highlightPlane(GcDbEntity* Ent, void* context) = 0;
  virtual Gcad::ErrorStatus dehighlightPlane(GcDbEntity* Ent, void* context) = 0;
};
#pragma pack(pop)