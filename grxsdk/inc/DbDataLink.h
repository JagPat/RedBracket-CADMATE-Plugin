...
public:
  ...
  Gcad::ErrorStatus getUpdateStatus(GcDb::UpdateDirection* pDir, std::tm* pTime, GcString* pErrMessage) const;
...
public:
  ...
  Gcad::ErrorStatus getDataLink(const GCHAR* pszName, GcDbDataLink*& pDataLink, GcDb::OpenMode mode) const;
  ...
  Gcad::ErrorStatus update(const GcDbObjectIdArray& dataIds, GcDb::UpdateDirection nDir, GcDb::UpdateOption nOption);
  Gcad::ErrorStatus update(GcDb::UpdateDirection nDir, GcDb::UpdateOption nOption);
