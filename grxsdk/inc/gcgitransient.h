...
public:
  ...
  virtual bool eraseTransient(GcGiDrawable* pDrawable, const GcArray<int>& viewportNumbers) = 0;
  virtual bool eraseTransients(GcGiTransientDrawingMode mode,
                               int subDrawingMode,
                               const GcArray<int>& viewportNumbers) = 0;

  virtual void updateTransient(GcGiDrawable* pDrawable, const GcArray<int>& viewportNumbers) = 0;
  virtual bool addChildTransient(GcGiDrawable* pDrawable, GcGiDrawable* pParentDrawable) = 0;
  virtual bool eraseChildTransient(GcGiDrawable* pDrawable, GcGiDrawable* pParentDrawable) = 0;
  virtual void updateChildTransient(GcGiDrawable* pDrawable, GcGiDrawable* pParentDrawable) = 0;
