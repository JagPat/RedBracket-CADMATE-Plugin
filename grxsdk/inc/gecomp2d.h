...
class GE_DLLEXPIMPORT GcGeCompositeCurve2d : public GcGeCurve2d
{
public:
  GcGeCompositeCurve2d();
  GcGeCompositeCurve2d(const GcGeVoidPointerArray& curveList);
  GcGeCompositeCurve2d(const GcGeVoidPointerArray& curveList, const GcGeIntArray& isOwnerOfCurves);
  ...
  GcGeCompositeCurve2d& setCurveList(const GcGeVoidPointerArray& curveList, const GcGeIntArray& isOwnerOfCurves);
