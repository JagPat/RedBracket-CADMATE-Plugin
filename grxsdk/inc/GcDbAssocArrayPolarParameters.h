...
public:
  ...
  DBCONSTRAINTS_PORT GcDbAssocArrayPolarParameters(double angle = 15,
                                                   double rowSpacing = 1,
  ...
  DBCONSTRAINTS_PORT Gcad::ErrorStatus setItemCount(int nItems,
                                                    const GcString& expression = GcString(),
                                                    const GcString& evaluatorId = GcString(),
                                                    GcString& errorMessage = dummyString());
  DBCONSTRAINTS_PORT Gcad::ErrorStatus setAngleBetweenItems(double angle,
                                                            const GcString& expression = GcString(),
                                                            const GcString& evaluatorId = GcString(),
                                                            GcString& errorMessage = dummyString());
  DBCONSTRAINTS_PORT Gcad::ErrorStatus setFillAngle(double fillAngle,
                                                    const GcString& expression = GcString(),
                                                    const GcString& evaluatorId = GcString(),
                                                    GcString& errorMessage = dummyString());
  DBCONSTRAINTS_PORT Gcad::ErrorStatus setStartAngle(double angle,
                                                     const GcString& expression = GcString(),
                                                     const GcString& evaluatorId = GcString(),
                                                     GcString& errorMessage = dummyString());
  ...
  DBCONSTRAINTS_PORT Gcad::ErrorStatus setRadius(double radius,
                                                 const GcString& expression = GcString(),
                                                 const GcString& evaluatorId = GcString(),
                                                 GcString& errorMessage = dummyString());
  ...
  DBCONSTRAINTS_PORT Gcad::ErrorStatus getItemPosition(const GcDbItemLocator& locator,
                                                       GcGePoint3d& position,
                                                       GcGeMatrix3d& xform) const override;
