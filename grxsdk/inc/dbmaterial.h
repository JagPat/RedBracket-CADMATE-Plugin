...
public:
  ...
  virtual void setSpecular(const GcGiMaterialColor& color, const GcGiMaterialMap& map, double dGloss);
  virtual void specular(GcGiMaterialColor& color, GcGiMaterialMap& map, double& dGloss) const;
