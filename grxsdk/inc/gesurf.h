...
class GE_DLLEXPIMPORT GcGeSurface : public GcGeEntity3d
{
public:
  GcGePoint2d paramOf(const GcGePoint3d& pnt, const GcGeTol& tol = GcGeContext::gTol) const;

  Gsoft::Boolean isOn(const GcGePoint3d& pnt, const GcGeTol& tol = GcGeContext::gTol) const;
  Gsoft::Boolean isOn(const GcGePoint3d& pnt, GcGePoint2d& paramPoint, const GcGeTol& tol = GcGeContext::gTol) const;
  ...
  GcGePoint3d evalPoint(const GcGePoint2d& param, int derivOrd, GcGeVector3dArray& derivatives) const;
