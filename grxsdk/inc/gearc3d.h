...
class GE_DLLEXPIMPORT GcGeCircArc3d : public GcGeCurve3d
{
public:
  GcGeCircArc3d();
  GcGeCircArc3d(const GcGeCircArc3d& arc);
  GcGeCircArc3d(const GcGePoint3d& cent, const GcGeVector3d& nrm, double radius);
  ...
  Gsoft::Boolean intersectWith(const GcGeLinearEnt3d& line,
                               ...
                               GcGePoint3d& p2,
                               const GcGeTol& tol = GcGeContext::gTol) const;
  Gsoft::Boolean intersectWith(const GcGeCircArc3d& arc,
                               int& intn,
                               GcGePoint3d& p1,
                               GcGePoint3d& p2,
                               const GcGeTol& tol = GcGeContext::gTol) const;
  ...
  Gsoft::Boolean projIntersectWith(const GcGeLinearEnt3d& line,
                                   ...
                                   const GcGeTol& tol = GcGeContext::gTol) const;
  Gsoft::Boolean tangent(const GcGePoint3d& pnt, GcGeLine3d& line, const GcGeTol& tol = GcGeContext::gTol) const;
  Gsoft::Boolean tangent(const GcGePoint3d& pnt, GcGeLine3d& line, const GcGeTol& tol, GcGeError& error) const;
  void getPlane(GcGePlane& plane) const;
  Gsoft::Boolean isInside(const GcGePoint3d& pnt, const GcGeTol& tol = GcGeContext::gTol) const;
  ...
  GcGeCircArc3d& setAxes(const GcGeVector3d& normal, const GcGeVector3d& refVec);
  GcGeCircArc3d& setRadius(double);
  GcGeCircArc3d& setAngles(double startAngle, double endAngle);

  GcGeCircArc3d& set(const GcGePoint3d& cent, const GcGeVector3d& nrm, double radius);
  GcGeCircArc3d& set(const GcGePoint3d& cent,
                     ...
                     double startAngle,
                     double endAngle);
  GcGeCircArc3d& set(const GcGePoint3d& startPoint, const GcGePoint3d& pnt, const GcGePoint3d& endPoint);
  GcGeCircArc3d& set(const GcGePoint3d& startPoint,
                     const GcGePoint3d& pnt,
