...
public:
  ...
  virtual Gcad::ErrorStatus dwgVersion(GcDb::GcDbDwgVersion& ver, GcDb::MaintenanceReleaseVersion& maintVer) const;
  virtual Gcad::ErrorStatus extendedDwgMaintenanceReleaseVersion(GcDb::MaintenanceReleaseVersion& maintVer) const;
...
inline Gcad::ErrorStatus GcDbDwgFiler::writeItem(const void* buf, Gsoft::UIntPtr cnt)
{
...
inline Gcad::ErrorStatus GcDbDwgFiler::writeItem(const void* p)
{
  return writeAddress(p);
}

inline Gcad::ErrorStatus GcDbDxfFiler::readItem(resbuf* pVal)
{
  return readResBuf(pVal);
}

inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(const resbuf& val)
{
  return writeResBuf(val);
}

inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(GcDb::DxfCode dc, const GcDbObjectId& id)
{
  return writeObjectId(dc, id);
}

inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(GcDb::DxfCode dc, const GCHAR* val)
{
  return writeString(dc, val);
}

inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(GcDb::DxfCode dc, const gds_binary& val)
{
  return writeBChunk(dc, val);
}

inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(GcDb::DxfCode dc, const GcDbHandle& val)
{
  return writeGcDbHandle(dc, val);
}

inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(GcDb::DxfCode dc, Gsoft::Int32 val)
{
  return writeInt32(dc, val);
}

inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(GcDb::DxfCode dc, Gsoft::Int16 val)
{
  return writeInt16(dc, val);
}

inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(GcDb::DxfCode dc, Gsoft::Int8 val)
{
  return this->writeInt8(dc, val);
}

inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(GcDb::DxfCode dc, Gsoft::UInt32 val)
{
  return writeUInt32(dc, val);
}

inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(GcDb::DxfCode dc, Gsoft::UInt16 val)
{
  return writeUInt16(dc, val);
}

inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(GcDb::DxfCode dc, Gsoft::UInt8 val)
{
  return writeUInt8(dc, val);
}

#if !defined(Gsoft_Boolean_is_bool)
inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(GcDb::DxfCode dc, Gsoft::Boolean val)
{
  return writeBoolean(dc, val);
}
#endif

inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(GcDb::DxfCode dc, bool val)
{
  return writeBool(dc, val);
}

inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(GcDb::DxfCode dc, double val, int prec)
{
  return writeDouble(dc, val, prec);
}

inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(GcDb::DxfCode dc, const GcGePoint2d& val, int prec)
{
  return writePoint2d(dc, val, prec);
}

inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(GcDb::DxfCode dc, const GcGePoint3d& val, int prec)
{
  return writePoint3d(dc, val, prec);
}

inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(GcDb::DxfCode dc, const GcGeVector2d& val, int prec)
{
  return writeVector2d(dc, val, prec);
}

inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(GcDb::DxfCode dc, const GcGeVector3d& val, int prec)
{
  return writeVector3d(dc, val, prec);
}

inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(GcDb::DxfCode dc, const GcGeScale3d& val, int prec)
{
...
inline Gcad::ErrorStatus GcDbDxfFiler::writeItem(GcDb::DxfCode dc, const GcString& val)
{
  return writeString(dc, val);
}
