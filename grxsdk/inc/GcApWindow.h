...
protected:
  ...
  GCCORE_PORT virtual bool subPreRouteMessage(
    HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam, Gsoft::LongPtr& lResult);
  GCCORE_PORT virtual bool subRouteMessage(
    HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam, Gsoft::LongPtr& lResult);
  GCCORE_PORT virtual bool subPostRouteMessage(
    HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam, Gsoft::LongPtr& lResult);
