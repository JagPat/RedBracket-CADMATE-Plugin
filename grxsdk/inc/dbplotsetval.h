...
public:
  ...
  virtual Gcad::ErrorStatus setCanonicalMediaName(GcDbPlotSettings* pPlotSet, const GCHAR* mediaName) = 0;
  ...
  virtual Gcad::ErrorStatus setPlotType(GcDbPlotSettings* pPlotSet, const PlotType plotAreaType) = 0;
  virtual Gcad::ErrorStatus setPlotWindowArea(
    GcDbPlotSettings* pPlotSet, const double xmin, const double ymin, const double xmax, const double ymax) = 0;
  virtual Gcad::ErrorStatus setPlotViewName(GcDbPlotSettings* pPlotSet, const GCHAR* viewName) = 0;
  virtual Gcad::ErrorStatus setUseStandardScale(GcDbPlotSettings* pPlotSet, Gsoft::Boolean useStandard) = 0;
  ...
  virtual Gcad::ErrorStatus getLocaleMediaName(GcDbPlotSettings* pPlotSet, int index, const GCHAR*& localeName) = 0;
