...
public:
  ...
  Gcad::ErrorStatus getWidthsAt(unsigned int index, double& startWidth, double& endWidth) const;
  ...
  virtual Gcad::ErrorStatus setWidthsAt(unsigned int index, double startWidth, double endWidth);

  Gcad::ErrorStatus minimizeMemory();
  Gcad::ErrorStatus maximizeMemory();
  virtual void reset(Gsoft::Boolean reuse, unsigned int numVerts);
