...
public:
  ...
  virtual Gcad::ErrorStatus createSectionObjects(const GcGePlane& sectionPlane,
                                                 GcArray<GcDbEntity*>& sectionObjects) const;
  virtual Gcad::ErrorStatus sliceByPlane(const GcGePlane& slicePlane,
                                         GcDbSurface*& pNegHalfSurface,
                                         GcDbSurface*& pNewSurface);
  virtual Gcad::ErrorStatus sliceBySurface(const GcDbSurface* pSlicingSurface,
                                           GcDbSurface*& pNegHalfSurface,
                                           GcDbSurface*& pNewSurface);
  ...
  Gcad::ErrorStatus extendEdges(GcDbFullSubentPathArray& edges,
                                ...
                                EdgeExtensionType extOption,
                                bool bAssociativeEnabled);
  Gcad::ErrorStatus rayTest(const GcGePoint3d& rayBasePoint,
                            const GcGeVector3d& rayDir,
                            double rayRadius,
                            GcArray<GcDbSubentId>& subEntIds,
                            GcGeDoubleArray& parameters) const;
