...
class GX_DLLEXPIMPORT GcGeCurveSurfInt : public GcGeEntity3d
{
public:
  GcGeCurveSurfInt();
  GcGeCurveSurfInt(const GcGeCurve3d& crv, const GcGeSurface& srf, const GcGeTol& tol = GcGeContext::gTol);
  ...
  void getIntParams(int intNum, double& param1, GcGePoint2d& param2, GcGeIntersectError& err) const;
  ...
  void getIntConfigs(int intNum,
                     GcGe::csiConfig& lower,
                     GcGe::csiConfig& higher,
                     Gsoft::Boolean& smallAngle,
                     GcGeIntersectError& err) const;
  GcGeCurveSurfInt& set(const GcGeCurve3d& cvr, const GcGeSurface& srf, const GcGeTol& tol = GcGeContext::gTol);
