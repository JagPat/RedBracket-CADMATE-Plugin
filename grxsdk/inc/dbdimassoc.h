...
public:
  ...
  Gcad::ErrorStatus post(GcDbObjectId dimId, GcDbObjectId& dimAssocId, bool isActive = true);
...
protected:
  Gcad::ErrorStatus setPointRefReactor(int ptType, bool isAdd = true);
  ...
  Gcad::ErrorStatus updateDimension(GcDbRotatedDimension* pRotDim, GcGePoint3d* pNewPts, bool bUpdate = true);
  Gcad::ErrorStatus updateDimension(GcDbAlignedDimension* pAlnDim, GcGePoint3d* pNewPts, bool bUpdate = true);
  Gcad::ErrorStatus updateDimension(GcDbRadialDimension* pRadDim, GcGePoint3d* pNewPts, bool bUpdate = true);
  Gcad::ErrorStatus updateDimension(GcDbRadialDimensionLarge* pRadDimLarge, GcGePoint3d* pNewPts, bool bUpdate = true);
  Gcad::ErrorStatus updateDimension(GcDbDiametricDimension* pDiaDim, GcGePoint3d* pNewPts, bool bUpdate = true);
  Gcad::ErrorStatus updateDimension(GcDb2LineAngularDimension* pA2Dim, GcGePoint3d* pNewPts, bool bUpdate = true);
  Gcad::ErrorStatus updateDimension(GcDb3PointAngularDimension* pA3Dim, GcGePoint3d* pNewPts, bool bUpdate = true);
  Gcad::ErrorStatus updateDimension(GcDbOrdinateDimension* pOrdDim, GcGePoint3d* pNewPts, bool bUpdate = true);
  Gcad::ErrorStatus updateDimension(GcDbArcDimension* pArcDim, GcGePoint3d* pNewPts, bool bUpdate = true);
  Gcad::ErrorStatus updateDimension(GcDbLeader* pLeader, GcGePoint3d* pNewPts, bool bUpdate = true);
  Gcad::ErrorStatus updateDimension(GcDbMLeader* pMLeader, GcGePoint3d* pNewPts, bool bUpdate = true);
...
GCCORE_PORT
Gcad::ErrorStatus gcdbPostDimAssoc(GcDbObjectId dimId,
                                   GcDbDimAssoc* pDimAssoc,
                                   GcDbObjectId& dimAssocId,
                                   bool isActive = true);

GCCORE_PORT
Gcad::ErrorStatus gcdbUpdateDimension(GcDbObjectId dimId);

GCCORE_PORT
Gcad::ErrorStatus gcdbUpdateAllDimensions(GcDbDatabase* pDb);

GCCORE_PORT
Gcad::ErrorStatus gcdbGetDimAssocId(GcDbObjectId dimId, GcDbObjectId& dimAssocId);

GCCORE_PORT
Gcad::ErrorStatus gcdbGetDimAssocIds(GcDbObjectId entId, GcDbObjectIdArray& dimAssocIds);

GCCORE_PORT
bool gcdbIsTransSpatial(const GcDbFullSubentPath& idPath);

GCCORE_PORT Gcad::ErrorStatus gcdbGetAssocAnnotationActionBody(const GcDbObjectId& idDim, GcDbObjectId& idActionBody);

GCCORE_PORT Gcad::ErrorStatus gcdbGetNonAssocAnnotations(GcDbDatabase* pDb,
                                                         bool isPaperSpace,
                                                         GcDbObjectId& blockId,
                                                         GcDbObjectIdArray& annoIds,
                                                         bool ignoreOffOrFrozenLayers = false);

GCCORE_PORT bool gcdbIsEntityInBlockOrXref(const GcDbEntity* pEnt);

GCCORE_PORT bool gcdbIsAnnoMonitorOn();

GCCORE_PORT bool gcdbIsAssociativityAlertIconDisabled(GcDbEntity* pEnt);

GCCORE_PORT bool gcdbDisableAssociativityAlertIcon(GcDbEntity* pEnt, bool disable);

GCCORE_PORT bool gcdbIsAssociativeAnnotation(GcDbObject* pObj, bool* pIsPartialAssoc = NULL);
...
GCCORE_PORT bool gcdbGetAssociativityOverride(GcDbEntity* pEnt, int& nValue);

GCCORE_PORT bool gcdbSetAssociativityOverride(GcDbEntity* pEnt, int nValue);
