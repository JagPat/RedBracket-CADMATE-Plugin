...
public:
  ...
  GCCORE_PORT Gcad::ErrorStatus makeSelection(const GcDbTextEditorLocation* pStart, const GcDbTextEditorLocation* pEnd);
  GCCORE_PORT Gcad::ErrorStatus findText(const GCHAR* text,
                                         int flags,
