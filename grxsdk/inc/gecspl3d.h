...
class GE_DLLEXPIMPORT GcGeCubicSplineCurve3d : public GcGeSplineEnt3d
{
public:
  GcGeCubicSplineCurve3d();
  GcGeCubicSplineCurve3d(const GcGeCubicSplineCurve3d& spline);
  GcGeCubicSplineCurve3d(const GcGePoint3dArray& fitPnts, const GcGeTol& tol = GcGeContext::gTol);
  ...
  GcGeCubicSplineCurve3d(const GcGeCurve3d& curve, double epsilon = GcGeContext::gTol.equalPoint());
