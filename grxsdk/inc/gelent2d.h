...
class GE_DLLEXPIMPORT GcGeLinearEnt2d : public GcGeCurve2d
{
public:
  ...
  Gsoft::Boolean overlap(const GcGeLinearEnt2d& line,
                         ...
                         const GcGeTol& tol = GcGeContext::gTol) const;
  Gsoft::Boolean isParallelTo(const GcGeLinearEnt2d& line, const GcGeTol& tol = GcGeContext::gTol) const;
  Gsoft::Boolean isPerpendicularTo(const GcGeLinearEnt2d& line, const GcGeTol& tol = GcGeContext::gTol) const;
  Gsoft::Boolean isColinearTo(const GcGeLinearEnt2d& line, const GcGeTol& tol = GcGeContext::gTol) const;
