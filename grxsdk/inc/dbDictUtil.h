...
namespace GcDbDictUtil
{
  ...
  {
    GcString sName;
    return ::gcutGcStringToGChar(sName, pName, GcDbDictUtil::dictionaryNameAt(sName, itemId, ownerDictId));
  }
...
#define DBDICTUTIL_MAKE_DICTIONARY_UTILS(LOWERNAME, UPPERNAME)                                        \
  inline Gcad::ErrorStatus get##UPPERNAME##Id(GcDbObjectId& id, const GCHAR* name, GcDbDatabase* pDb) \
  {                                                                                                   \
    id.setNull();                                                                                     \
    if (pDb == nullptr)                                                                               \
  ...
  inline Gcad::ErrorStatus get##UPPERNAME##Name(GcString& name, GcDbObjectId itemId)                  \
  {                                                                                                   \
    name.setEmpty();                                                                                  \
  ...
  inline Gcad::ErrorStatus get##UPPERNAME##Name(GCHAR*& name, GcDbObjectId itemId)                    \
  {                                                                                                   \
    GcString sName;                                                                                   \
    return ::gcutGcStringToGChar(sName, name, GcDbDictUtil::get##UPPERNAME##Name(sName, itemId));     \
  }                                                                                                   \
  inline bool has##UPPERNAME(const GCHAR* name, GcDbDatabase* pDb)                                    \
  {                                                                                                   \
    GcDbObjectId id;                                                                                  \
