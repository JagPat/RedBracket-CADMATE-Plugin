...
#define gcrxClassDictionary GcRxDictionary::cast(gcrxSysRegistry()->at(GCRX_CLASS_DICTIONARY))

#define gcrxServiceDictionary GcRxDictionary::cast(gcrxSysRegistry()->at(GCRX_SERVICE_DICTIONARY))
