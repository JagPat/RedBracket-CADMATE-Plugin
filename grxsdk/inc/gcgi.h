...
{
public:
  GcGiColorRGB(void) : red(0.0), green(0.0), blue(0.0)
  {
  }

  GcGiColorRGB(double r, double g, double b) : red(r), green(g), blue(b)
  {
  }
...
{
  return GcGiColorRGB(c1.red * c2.red, c1.green * c2.green, c1.blue * c2.blue);
}

inline GcGiColorRGB operator*(const GcGiColorRGB& c, double s)
{
  return GcGiColorRGB(s * c.red, s * c.green, s * c.blue);
}
...
{
public:
  GcGiColorRGBA(void) : red(0.0), green(0.0), blue(0.0), alpha(1.0)
  {
  }

  GcGiColorRGBA(double r, double g, double b, double a) : red(r), green(g), blue(b), alpha(a)
  {
  }
...
{
  return GcGiColorRGBA(c1.red * c2.red, c1.green * c2.green, c1.blue * c2.blue, c1.alpha * c2.alpha);
}

inline GcGiColorRGBA operator*(const GcGiColorRGBA& c, double s)
{
  return GcGiColorRGBA(s * c.red, s * c.green, s * c.blue, s * c.alpha);
}
...
public:
  ...
  GcGiPixelBGRA32(Gsoft::UInt32 bgra) : m_whole(bgra)
  {
  }

  GcGiPixelBGRA32(Gsoft::UInt8 blue, Gsoft::UInt8 green, Gsoft::UInt8 red, Gsoft::UInt8 alpha)
  {
    m_bgra.b = blue;
    m_bgra.g = green;
    m_bgra.r = red;
  ...
  void setBGRA(Gsoft::UInt8 blue, Gsoft::UInt8 green, Gsoft::UInt8 red, Gsoft::UInt8 alpha);
  void setRGBA(Gsoft::UInt32 rgba);
  void setRGBA(Gsoft::UInt8 red, Gsoft::UInt8 green, Gsoft::UInt8 blue, Gsoft::UInt8 alpha);
...
{
  return (Gsoft::UInt32)(m_bgra.a) << 24 | (Gsoft::UInt32)(m_bgra.b) << 16 | (Gsoft::UInt32)(m_bgra.g) << 8 |
...
inline void GcGiPixelBGRA32::setBGRA(Gsoft::UInt8 blue, Gsoft::UInt8 green, Gsoft::UInt8 red, Gsoft::UInt8 alpha)
{
  m_bgra.b = blue;
  m_bgra.g = green;
  m_bgra.r = red;
...
inline void GcGiPixelBGRA32::setRGBA(Gsoft::UInt8 red, Gsoft::UInt8 green, Gsoft::UInt8 blue, Gsoft::UInt8 alpha)
{
  m_bgra.r = red;
  m_bgra.g = green;
  m_bgra.b = blue;
...
{
public:
  GcGiImageBGRA32() : m_nImageWidth(0), m_nImageHeight(0), m_pImageData(NULL)
  {
  }

  GcGiImageBGRA32(Gsoft::UInt32 imageWidth, Gsoft::UInt32 imageHeight, GcGiPixelBGRA32* imageData)
    : m_nImageWidth(imageWidth), m_nImageHeight(imageHeight), m_pImageData(imageData)
  {
  }
  ...
  void setImage(Gsoft::UInt32 imageWidth, Gsoft::UInt32 imageHeight, GcGiPixelBGRA32* imageData);
...
inline void GcGiImageBGRA32::setImage(Gsoft::UInt32 imageWidth, Gsoft::UInt32 imageHeight, GcGiPixelBGRA32* imageData)
{
...
public:
  ...
  virtual const GcGiKernelDescriptor& getDescriptor(void) const
  {
    return m_descriptor;
  }
...
public:
  ...
  virtual class GcGiGraphicsKernel& graphicsKernel()
  {
    static GcGiGraphicsKernel kernel;
    return kernel;
  }
  ...
  virtual GcCmEntityColor effectiveColor() const
  {
    return GcCmEntityColor();
  }
  virtual GcDb::LineWeight byBlockLineWeight() const
  {
    return GcDb::kLnWt000;
  }
  virtual GcDbObjectId byBlockPlotStyleNameId() const
  {
    return GcDbObjectId::kNull;
  }
  virtual GcDbObjectId byBlockMaterialId() const
  {
    return GcDbObjectId::kNull;
  }
  ...
  virtual Gsoft::Boolean supportsFastRenderBuffer() const
  {
    return Gsoft::kFalse;
  }

  virtual Gsoft::Boolean supportsNativePointCloudRender() const
  {
    return Gsoft::kFalse;
  }

  virtual GcGiContextImp* getImpPtr()
  {
    return nullptr;
  }
  virtual const GcGiContextImp* getConstImpPtr() const
  {
    return nullptr;
  }
...
protected:
  ...
  virtual GcGiWorldSegmentCallback wSegTaker() const
  {
    return nullptr;
  }
  virtual int getTrueTypeBoundingBox(GcGePoint3d const&, const wchar_t*, int, TextParams const*, GcGePoint3d*, float*)
  {
    return 0;
  }

  virtual int getTrueTypeTextExtents(
    GCHAR const*, Charset, double, int, int, int, short, short, double, double, GcGePoint2d&, GcGePoint2d&)
  {
    return -1;
  }

  virtual int setTrueTypeTransform(const GcGePoint3d&, const GcGeVector3d&, double, double, double, bool, bool)
  {
    return 0;
  }

  virtual int drawTrueTypeText(const GCHAR*, double, int, bool, const TextParams&, Charset)
  {
    return 0;
  }
  ...
  virtual GcFontHandle* loadTrueTypeFont(const GCHAR*, bool, bool, Charset, int, FontInfo&)
  {
    return nullptr;
  }
};
...
public:
  ...
  virtual double deviation(const GcGiDeviationType, const GcGePoint3d&) const = 0;
...
public:
  ...
  virtual void getViewportDcCorners(GcGePoint2d& lower_left, GcGePoint2d& upper_right) const = 0;
  ...
  virtual Gsoft::Boolean layerVisible(const GcDbObjectId&) const
  {
    return Gsoft::kTrue;
  }
  virtual GcGeVector3d viewDir() const
  {
    return GcGeVector3d::kZAxis;
  }
  virtual const GcGiContextualColors* contextualColors() const
  {
    return NULL;
  }
};
...
public:
  ...
  virtual void setPlotStyleName(GcDb::PlotStyleNameType, const GcDbObjectId& = GcDbObjectId::kNull)
  {
  }
...
inline void GcGiSubEntityTraits::setMaterial(const GcDbObjectId)
{
}

inline GcDbObjectId GcGiSubEntityTraits::materialId(void) const
{
  return GcDbObjectId::kNull;
}

inline void GcGiSubEntityTraits::setMapper(const GcGiMapper*)
{
}

inline const GcGiMapper* GcGiSubEntityTraits::mapper(void) const
{
  return NULL;
}

inline void GcGiSubEntityTraits::setVisualStyle(GcDbObjectId)
{
}

inline GcDbObjectId GcGiSubEntityTraits::visualStyle(void) const
{
  return GcDbObjectId::kNull;
}

inline void GcGiSubEntityTraits::setSectionable(bool)
{
}

inline bool GcGiSubEntityTraits::sectionable(void) const
{
  return false;
}

inline Gcad::ErrorStatus GcGiSubEntityTraits::setDrawFlags(Gsoft::UInt32)
{
  return Gcad::eNotImplementedYet;
}

inline Gsoft::UInt32 GcGiSubEntityTraits::drawFlags(void) const
{
  return 0;
}

inline Gcad::ErrorStatus GcGiSubEntityTraits::setShadowFlags(ShadowFlags)
{
  return Gcad::eNotImplementedYet;
}

inline GcGiSubEntityTraits::ShadowFlags GcGiSubEntityTraits::shadowFlags(void) const
{
  return kShadowsCastAndReceive;
}

inline void GcGiSubEntityTraits::setSelectionGeom(bool)
{
}

inline bool GcGiSubEntityTraits::selectionGeom(void) const
{
  return false;
}

inline void GcGiSubEntityTraits::setTransparency(const GcCmTransparency&)
{
}

inline GcCmTransparency GcGiSubEntityTraits::transparency(void) const
{
...
public:
  ...
  virtual Gcad::ErrorStatus setHighlightProperty(HighlightProperty property, GcGiVariant& value);
  virtual GcGiVariant highlightProperty(HighlightProperty property) const;

  virtual GcGiContext* context(void) const
  {
    return nullptr;
  }
...
inline void GcGiDrawableTraits::addLight(const GcDbObjectId&)
{
}

inline void GcGiDrawableTraits::setLinePattern(const GcGiLineType)
{
}

inline GcGiLineType GcGiDrawableTraits::linePattern(void) const
{
  return kLineTypeSolid;
}

inline Gcad::ErrorStatus GcGiDrawableTraits::setSelectionFlags(const SelectionFlags)
{
  return Gcad::eOk;
}

inline GcGiSubEntityTraits::SelectionFlags GcGiDrawableTraits::selectionFlags(void) const
{
  return kNoSelectionFlags;
}

inline Gcad::ErrorStatus GcGiDrawableTraits::setHighlightProperty(HighlightProperty, GcGiVariant&)
{
  return Gcad::eOk;
}

inline GcGiVariant GcGiDrawableTraits::highlightProperty(HighlightProperty) const
{
  return GcGiVariant();
}
...
inline void GcGiNonEntityTraits::setupForEntity(GcDbEntity*)
{
  assert(false);
}

inline void GcGiNonEntityTraits::addLight(const GcDbObjectId&)
{
  assert(false);
}

inline void GcGiNonEntityTraits::setColor(const Gsoft::UInt16)
{
  assert(false);
}

inline Gsoft::UInt16 GcGiNonEntityTraits::color(void) const
{
  assert(false);
  return 0;
}

inline void GcGiNonEntityTraits::setTrueColor(const GcCmEntityColor&)
{
  assert(false);
}

inline GcCmEntityColor GcGiNonEntityTraits::trueColor(void) const
{
  assert(false);
  return GcCmEntityColor();
}

inline void GcGiNonEntityTraits::setLayer(const GcDbObjectId)
{
  assert(false);
}

inline GcDbObjectId GcGiNonEntityTraits::layerId(void) const
{
  assert(false);
  return GcDbObjectId::kNull;
}

inline void GcGiNonEntityTraits::setLineType(const GcDbObjectId)
{
  assert(false);
}
...
inline void GcGiNonEntityTraits::setMaterial(const GcDbObjectId)
{
  assert(false);
}
...
inline void GcGiNonEntityTraits::setSelectionMarker(const Gsoft::LongPtr)
{
  assert(false);
}

inline void GcGiNonEntityTraits::setFillType(const GcGiFillType)
{
  assert(false);
}

inline GcGiFillType GcGiNonEntityTraits::fillType(void) const
{
  assert(false);
  return kGcGiFillAlways;
}

inline void GcGiNonEntityTraits::setLineWeight(const GcDb::LineWeight)
{
  assert(false);
}

inline GcDb::LineWeight GcGiNonEntityTraits::lineWeight(void) const
{
  assert(false);
  return GcDb::kLnWt000;
}

inline void GcGiNonEntityTraits::setThickness(double)
{
  assert(false);
}

inline double GcGiNonEntityTraits::thickness(void) const
{
  assert(false);
  return 0.0;
}

inline void GcGiNonEntityTraits::setLineTypeScale(double)
{
  assert(false);
}

inline double GcGiNonEntityTraits::lineTypeScale(void) const
{
  assert(false);
  return 0.0;
}

inline void GcGiNonEntityTraits::setSelectionGeom(bool)
{
  assert(false);
}

inline bool GcGiNonEntityTraits::selectionGeom(void) const
{
  assert(false);
  return false;
}

inline void GcGiNonEntityTraits::setTransparency(const GcCmTransparency&)
{
  assert(false);
}

inline GcCmTransparency GcGiNonEntityTraits::transparency(void) const
{
  assert(false);
  return GcCmTransparency();
}
...
public:
  ...
  GCBASE_PORT GcGiPolyline(Gsoft::UInt32 nbPoints,
                           GcGePoint3d* pVertexList,
                           GcGeVector3d* pNormal = NULL,
                           Gsoft::LongPtr lBaseSubEntMarker = -1);
  GCBASE_PORT ~GcGiPolyline();
...
public:
  ...
  virtual Gsoft::Boolean circle(const GcGePoint3d& center, const double radius, const GcGeVector3d& normal) const = 0;
  virtual Gsoft::Boolean circle(const GcGePoint3d&, const GcGePoint3d&, const GcGePoint3d&) const = 0;
  ...
  virtual Gsoft::Boolean polyPolyline(Gsoft::UInt32 nbPolylines, const GcGiPolyline* pPolylines) const = 0;

  virtual Gsoft::Boolean polygon(const Gsoft::UInt32 nbPoints, const GcGePoint3d* pVertexList) const = 0;
  ...
  virtual Gsoft::Boolean text(const GcGePoint3d& position,
                              ...
                              const GcGiTextStyle& pTextStyle) const = 0;

  virtual Gsoft::Boolean xline(const GcGePoint3d&, const GcGePoint3d&) const = 0;

  virtual Gsoft::Boolean ray(const GcGePoint3d&, const GcGePoint3d&) const = 0;

  virtual Gsoft::Boolean pline(const GcDbPolyline& lwBuf,
                               Gsoft::UInt32 fromIndex = 0,
                               Gsoft::UInt32 numSegs = 0) const = 0;
  ...
  virtual Gsoft::Boolean rowOfDots(int count, const GcGePoint3d& start, const GcGeVector3d& step) const = 0;
  ...
  virtual Gsoft::Boolean ellipticalArc(const GcGePoint3d& center,
                                       ...
                                       GcGiArcType arcType = kGcGiArcSimple) const = 0;
...
public:
  ...
  virtual Gsoft::Boolean polylineEye(const Gsoft::UInt32 nbPoints, const GcGePoint3d* pPoints) const = 0;
  virtual Gsoft::Boolean polygonEye(const Gsoft::UInt32 nbPoints, const GcGePoint3d* pPoints) const = 0;

  virtual Gsoft::Boolean polylineDc(const Gsoft::UInt32 nbPoints, const GcGePoint3d* pPoints) const = 0;
  virtual Gsoft::Boolean polygonDc(const Gsoft::UInt32 nbPoints, const GcGePoint3d* pPoints) const = 0;
  ...
  virtual Gsoft::Boolean rasterImageDc(const GcGePoint3d& origin,
                                       const GcGeVector3d& u,
                                       const GcGeVector3d& v,
                                       ...
                                       const Gsoft::UInt32 unrotatedImageHeight) const = 0;

  virtual Gsoft::Boolean ownerDrawDc(Gsoft::Int32 vpnumber,
                                     Gsoft::Int32 left,
                                     Gsoft::Int32 top,
                                     Gsoft::Int32 right,
                                     Gsoft::Int32 bottom,
                                     const OwnerDraw* pOwnerDraw) const = 0;

  virtual Gsoft::Boolean ownerDraw3d(GcGePoint3d&, GcGePoint3d&, OwnerDraw3d*) const
  {
    return Gsoft::kFalse;
  };
};
...
public:
  ...
  GcGiTextStyle(const GCHAR* fontName,
...
public:
  ...
  GCBASE_PORT GcGiHatchPatternDefinition(
    double angle, double baseX, double baseY, double offsetX, double offsetY, const GcGeDoubleArray& dashList);
  GCBASE_PORT ~GcGiHatchPatternDefinition();
