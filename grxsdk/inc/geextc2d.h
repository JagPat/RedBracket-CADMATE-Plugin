...
class GX_DLLEXPIMPORT GcGeExternalCurve2d : public GcGeCurve2d
{
public:
  GcGeExternalCurve2d();
  GcGeExternalCurve2d(const GcGeExternalCurve2d&);
  GcGeExternalCurve2d(void* curveDef, GcGe::ExternalEntityKind curveKind, Gsoft::Boolean makeCopy = Gsoft::kTrue);
  ...
  GcGeExternalCurve2d& set(void* curveDef, GcGe::ExternalEntityKind curveKind, Gsoft::Boolean makeCopy = Gsoft::kTrue);
