...
class GX_DLLEXPIMPORT GcGeSphere : public GcGeSurface
{
public:
  GcGeSphere();
  ...
  Gsoft::Boolean intersectWith(
    const GcGeLinearEnt3d&, int& intn, GcGePoint3d& p1, GcGePoint3d& p2, const GcGeTol& tol = GcGeContext::gTol) const;
};
