...
public:
  ...
  GcDbSpline();
  ~GcDbSpline();
  GcDbSpline(const GcGePoint3dArray& fitPoints, int order = 4, double fitTolerance = 0.0);
  ...
  Gcad::ErrorStatus getFitTangents(GcGeVector3d& startTangent, GcGeVector3d& endTangent) const;
  Gcad::ErrorStatus setFitTangents(const GcGeVector3d& startTangent, const GcGeVector3d& endTangent);
  ...
  Gcad::ErrorStatus toPolyline(GcDbCurve*& pCurve,
                               int precision = 10,
