...
public:
  ...
  bool hitTest(const GcGePoint3d& ptHit,
               int* pSegmentIndex,
...
public:
  ...
  Gcad::ErrorStatus setGenerationOptions(GcDbSectionSettings::SectionType nSecType,
                                         GcDbSectionSettings::Generation nOptions);
  ...
  Gcad::ErrorStatus setVisibility(GcDbSectionSettings::SectionType nSecType,
                                  ...
                                  bool bVisible);
  GcCmColor color(GcDbSectionSettings::SectionType nSecType, GcDbSectionSettings::Geometry nGeometry) const;
  Gcad::ErrorStatus setColor(GcDbSectionSettings::SectionType nSecType,
                             GcDbSectionSettings::Geometry nGeometry,
                             const GcCmColor& color);
  const GCHAR* layer(GcDbSectionSettings::SectionType nSecType, GcDbSectionSettings::Geometry nGeometry) const;
  Gcad::ErrorStatus setLayer(GcDbSectionSettings::SectionType nSecType,
                             GcDbSectionSettings::Geometry nGeometry,
                             const GCHAR* pszLayer);
  const GCHAR* linetype(GcDbSectionSettings::SectionType nSecType, GcDbSectionSettings::Geometry nGeometry) const;
  Gcad::ErrorStatus setLinetype(GcDbSectionSettings::SectionType nSecType,
                                GcDbSectionSettings::Geometry nGeometry,
                                const GCHAR* pszLinetype);
  double linetypeScale(GcDbSectionSettings::SectionType nSecType, GcDbSectionSettings::Geometry nGeometry) const;
  Gcad::ErrorStatus setLinetypeScale(GcDbSectionSettings::SectionType nSecType,
                                     GcDbSectionSettings::Geometry nGeometry,
                                     double fScale);
  const GCHAR* plotStyleName(GcDbSectionSettings::SectionType nSecType, GcDbSectionSettings::Geometry nGeometry) const;
  Gcad::ErrorStatus setPlotStyleName(GcDbSectionSettings::SectionType nSecType,
                                     GcDbSectionSettings::Geometry nGeometry,
                                     const GCHAR* pszPlotStyleName);
  GcDb::LineWeight lineWeight(GcDbSectionSettings::SectionType nSecType, GcDbSectionSettings::Geometry nGeometry) const;
  Gcad::ErrorStatus setLineWeight(GcDbSectionSettings::SectionType nSecType,
                                  GcDbSectionSettings::Geometry nGeometry,
                                  GcDb::LineWeight nLineWeight);
  int faceTransparency(GcDbSectionSettings::SectionType nSecType, GcDbSectionSettings::Geometry nGeometry) const;
  Gcad::ErrorStatus setFaceTransparency(GcDbSectionSettings::SectionType nSecType,
                                        GcDbSectionSettings::Geometry nGeometry,
                                        int nTransparency);
  int edgeTransparency(GcDbSectionSettings::SectionType nSecType, GcDbSectionSettings::Geometry nGeometry) const;
  Gcad::ErrorStatus setEdgeTransparency(GcDbSectionSettings::SectionType nSecType,
                                        GcDbSectionSettings::Geometry nGeometry,
                                        int nTransparency);
  bool hatchVisibility(GcDbSectionSettings::SectionType nSecType, GcDbSectionSettings::Geometry nGeometry) const;
  ...
  double hatchAngle(GcDbSectionSettings::SectionType nSecType, GcDbSectionSettings::Geometry nGeometry) const;
  Gcad::ErrorStatus setHatchAngle(GcDbSectionSettings::SectionType nSecType,
                                  GcDbSectionSettings::Geometry nGeometry,
                                  double fAngle);
  double hatchSpacing(GcDbSectionSettings::SectionType nSecType, GcDbSectionSettings::Geometry nGeometry) const;
  Gcad::ErrorStatus setHatchSpacing(GcDbSectionSettings::SectionType nSecType,
                                    GcDbSectionSettings::Geometry nGeometry,
                                    double fSpacing);
  double hatchScale(GcDbSectionSettings::SectionType nSecType, GcDbSectionSettings::Geometry nGeometry) const;
  Gcad::ErrorStatus setHatchScale(GcDbSectionSettings::SectionType nSecType,
                                  GcDbSectionSettings::Geometry nGeometry,
                                  double fScale);
  bool hiddenLine(GcDbSectionSettings::SectionType nSecType, GcDbSectionSettings::Geometry nGeometry) const;
  Gcad::ErrorStatus setHiddenLine(GcDbSectionSettings::SectionType nSecType,
                                  GcDbSectionSettings::Geometry nGeometry,
                                  bool bHiddenLine);
  bool divisionLines(GcDbSectionSettings::SectionType nSecType, GcDbSectionSettings::Geometry nGeometry) const;
