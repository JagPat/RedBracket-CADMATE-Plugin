...
class GX_DLLEXPIMPORT GcGeExternalCurve3d : public GcGeCurve3d
{
public:
  GcGeExternalCurve3d();
  GcGeExternalCurve3d(const GcGeExternalCurve3d& src);
  GcGeExternalCurve3d(void* curveDef, GcGe::ExternalEntityKind curveKind, Gsoft::Boolean makeCopy = Gsoft::kTrue);
  ...
  GcGeExternalCurve3d& set(void* curveDef, GcGe::ExternalEntityKind curveKind, Gsoft::Boolean makeCopy = Gsoft::kTrue);
