...
GCCORE_PORT Gcad::ErrorStatus gcdbGetDgnFileReferences(const GCHAR* fileName,
                                                       const GCHAR* pwd,
...
public:
  ...
  Gcad::ErrorStatus rePath(const GcDbDgnRefFileIdArray& refFileIds, const GcStringArray& newRefFileNames);
