...
public:
  ...
  virtual Gcad::ErrorStatus transferPersSubentToAnotherEntity(GcDbEntity* pToEntity,
  ...
  virtual Gcad::ErrorStatus getRigidSetTransform(const GcDbEntity* pEntity, GcGeMatrix3d& trans)
  {
    GSOFT_UNREFED_PARAM(pEntity);
    GSOFT_UNREFED_PARAM(trans);
  ...
  virtual Gcad::ErrorStatus setRigidSetTransform(GcDbEntity* pEntity, const GcGeMatrix3d& trans)
  {
    GSOFT_UNREFED_PARAM(pEntity);
    GSOFT_UNREFED_PARAM(trans);
    return Gcad::eNotApplicable;
