...
public:
  ...
  Gcad::ErrorStatus setGradientColors(unsigned int count, GcCmColor* colors, float* values);
  ...
  virtual Gcad::ErrorStatus getMPolygonLoopAt(int loopIndex, GcGePoint2dArray& vertices, GcGeDoubleArray& bulges) const;
  ...
  virtual int isPointInsideMPolygon(const GcGePoint3d& worldPt,
                                    GcGeIntArray& loopsArray,
                                    double tol = GcDbMPolygonCrossingFuzz) const;
  virtual bool isPointOnLoopBoundary(const GcGePoint3d& worldPt, int loop, double tol = GcDbMPolygonCrossingFuzz) const;

  virtual Gcad::ErrorStatus loopCrossesItself(bool& crosses,
                                              bool findAll,
  ...
  virtual bool loopCrossesItself(const GcGePoint2dArray& vertexPts,
                                 const GcGeDoubleArray& vertexBulges,
                                 double tol = GcDbMPolygonCrossingFuzz) const;
  virtual Gcad::ErrorStatus loopCrossesMPolygon(bool& crosses,
                                                bool findAll,
                                                GcDbMPolygonCrossingArray& crossingsArray,
  ...
  virtual Gcad::ErrorStatus createLoopsFromBoundaries(const GcDbObjectIdArray& ids,
                                                      ...
                                                      bool excludeCrossing = true,
                                                      double tol = GcDbMPolygonCrossingFuzz);
  virtual Gcad::ErrorStatus createLoops(
    const GcArray<GcGePoint2dArray, GcArrayObjectCopyReallocator<GcGePoint2dArray>>& vertices,
    const GcArray<GcGeDoubleArray, GcArrayObjectCopyReallocator<GcGeDoubleArray>>& bulges,
    GcDbIntArray& rejectedObjs,
    bool excludeCrossing = true,
    double tol = GcDbMPolygonCrossingFuzz);
...
inline GcDbMpolygonLoops::GcDbMpolygonLoops(int lindex, int gindex, int gcnt)
{
  mLoopIndex = lindex;
  mGripIndex = gindex;
  mGripCount = gcnt;
...
inline GcDbMPolygonCrossingArray::~GcDbMPolygonCrossingArray()
{
...
inline GcDbMPolygonNode::GcDbMPolygonNode() : mLoopIndex(-1), mParent(NULL)
{
}