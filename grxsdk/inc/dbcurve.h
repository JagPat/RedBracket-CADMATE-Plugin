...
public:
  ...
  virtual Gcad::ErrorStatus getProjectedCurve(const GcGePlane&, const GcGeVector3d& projDir, GcDbCurve*& projCrv) const;

  virtual Gcad::ErrorStatus getOffsetCurves(double offsetDist, GcDbVoidPtrArray& offsetCurves) const;
  virtual Gcad::ErrorStatus getOffsetCurvesGivenPlaneNormal(const GcGeVector3d& normal,
                                                            double offsetDist,
  ...
  static Gcad::ErrorStatus createFromGcGeCurve(const GcGeCurve3d& geCurve,
                                               GcDbCurve*& pDbCurve,
...
#define DBCURVE_METHODS                                                                                          \
  ...
  Gcad::ErrorStatus getClosestPointTo(const GcGePoint3d&, GcGePoint3d&, Gsoft::Boolean = Gsoft::kFalse)          \
    const override;                                                                                              \
  Gcad::ErrorStatus getClosestPointTo(                                                                           \
    const GcGePoint3d&, const GcGeVector3d&, GcGePoint3d&, Gsoft::Boolean = Gsoft::kFalse) const override;       \
  ...
  Gcad::ErrorStatus getGcGeCurve(GcGeCurve3d*& pGeCurve, const GcGeTol& tol = GcGeContext::gTol) const override; \
  Gcad::ErrorStatus setFromGcGeCurve(                                                                            \
    const GcGeCurve3d& geCurve, GcGeVector3d* normal = NULL, const GcGeTol& tol = GcGeContext::gTol) override;
