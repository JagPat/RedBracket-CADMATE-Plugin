...
class GX_DLLEXPIMPORT GcGeExternalSurface : public GcGeSurface
{
public:
  GcGeExternalSurface();
  GcGeExternalSurface(void* surfaceDef, GcGe::ExternalEntityKind surfaceKind, Gsoft::Boolean makeCopy = Gsoft::kTrue);
