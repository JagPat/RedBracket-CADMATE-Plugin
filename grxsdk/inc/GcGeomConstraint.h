...
public:
  ...
  DBCONSTRAINTS_PORT virtual Gcad::ErrorStatus getConnectedGeometries(
    GcArray<GcConstrainedGeometry*>& apConsGeoms) const;
  DBCONSTRAINTS_PORT virtual Gcad::ErrorStatus getConnectedHelpParameters(
    GcArray<GcHelpParameter*>& apHelpParameters) const;
  DBCONSTRAINTS_PORT virtual GcHelpParameter* getConnectedHelpParameterFor(
    const GcConstrainedGeometry* pConsGeom) const;
...
public:
  ...
  DBCONSTRAINTS_PORT Gcad::ErrorStatus getConnectedEqualparamConstraints(
    GcArray<GcEqualHelpParameterConstraint*>& apEqualParamConstrs) const;
