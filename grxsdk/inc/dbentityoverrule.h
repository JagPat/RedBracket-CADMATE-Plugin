...
public:
  ...
  GcDbOsnapOverrule();
  virtual Gcad::ErrorStatus getOsnapPoints(const GcDbEntity* pSubject,
...
public:
  ...
  virtual Gcad::ErrorStatus getTransformedCopy(const GcDbEntity* pSubject,
...
public:
  ...
  virtual Gcad::ErrorStatus moveGripPointsAt(GcDbEntity* pSubject,
                                             ...
                                             const GcGeVector3d& offset,
                                             const int bitflags);
  virtual Gcad::ErrorStatus getStretchPoints(const GcDbEntity* pSubject, GcGePoint3dArray& stretchPoints);
...
public:
  ...
  virtual Gcad::ErrorStatus transformSubentPathsBy(GcDbEntity* pSubject,
                                                   ...
                                                   const GcGeMatrix3d& xform);
  virtual Gcad::ErrorStatus getGripPointsAtSubentPath(const GcDbEntity* pSubject,
                                                      ...
                                                      const GcGeVector3d& curViewDir,
                                                      const int bitflags);
  virtual Gcad::ErrorStatus moveGripPointsAtSubentPaths(GcDbEntity* pSubject,
                                                        const GcDbFullSubentPathArray& paths,
                                                        const GcDbVoidPtrArray& gripAppData,
                                                        const GcGeVector3d& offset,
                                                        const int bitflags);
  virtual Gcad::ErrorStatus getSubentPathsAtGsMarker(const GcDbEntity* pSubject,
  ...
  virtual Gcad::ErrorStatus getGsMarkersAtSubentPath(const GcDbEntity* pSubject,
  ...
  virtual void subentGripStatus(GcDbEntity* pSubject, const GcDb::GripStat status, const GcDbFullSubentPath& subentity);
  ...
  virtual Gcad::ErrorStatus getSubentPathGeomExtents(const GcDbEntity* pSubject,
                                                     const GcDbFullSubentPath& path,
                                                     GcDbExtents& extents);
  virtual Gcad::ErrorStatus getSubentClassId(const GcDbEntity* pSubject, const GcDbFullSubentPath& path, CLSID* clsId);
};
...
public:
  ...
  virtual Gcad::ErrorStatus highlight(const GcDbEntity* pSubject,
                                      const GcDbFullSubentPath& subId = kNullSubent,
                                      const Gsoft::Boolean highlightAll = false);
  virtual Gcad::ErrorStatus unhighlight(const GcDbEntity* pSubject,
                                        const GcDbFullSubentPath& subId = kNullSubent,
                                        const Gsoft::Boolean highlightAll = false);
};
...
public:
  ...
  virtual Gcad::ErrorStatus pushHighlight(GcDbEntity* pSubject,
                                          const GcDbFullSubentPath& subId,
                                          GcGiHighlightStyle highlightStyle);
  virtual Gcad::ErrorStatus popHighlight(GcDbEntity* pSubject, const GcDbFullSubentPath& subId);
  virtual GcGiHighlightStyle highlightState(GcDbEntity* pSubject, const GcDbFullSubentPath& subId);
};
...
public:
  ...
  virtual Gcad::ErrorStatus intersectWith(const GcDbEntity* pSubject,
