...
public:
  ...
  virtual Gcad::ErrorStatus getValue(const GcDbObject* pObject, const GcString& valueName, GcDbEvalVariant& value) = 0;

  virtual Gcad::ErrorStatus setValue(GcDbObject* pObject, const GcString& valueName, const GcDbEvalVariant& newValue)
  {
    GSOFT_UNREFED_PARAM(pObject);
    GSOFT_UNREFED_PARAM(valueName);
