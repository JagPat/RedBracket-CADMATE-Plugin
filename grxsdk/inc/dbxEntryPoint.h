...
#  else
#    define GCDB_REGISTER_OBJECT_ENTRY_PRAGMA(classname) \
      __pragma(comment(linker, "/include:___pDbxCustObjMap_" #classname));
#  endif
#else
#  define GCDB_REGISTER_OBJECT_ENTRY_PRAGMA(classname)
#endif
...
#define GCDB_REGISTER_OBJECT_ENTRY_AUTO(classname)                                                                     \
  ...
  extern "C" __declspec(allocate("DBXCUSTOBJ$__m")) __declspec(selectany)                                              \
    _DBX_REGISTER_OBJECT_ENTRY* __pDbxCustObjMap_##classname = &__DbxCustObjMap_##classname;                           \
  GCDB_REGISTER_OBJECT_ENTRY_PRAGMA(classname)

#define DISPATCH_PKTMSG(pktmsg) \
  case GcRx::pktmsg:            \
    return (On_##pktmsg(pkt))
...
public:
  ...
  virtual GcRx::AppRetCode On_kInitAppMsg(void* pkt)
  {
    ...
    for (_DBX_REGISTER_OBJECT_ENTRY** ppEntry = ppDbxCustObjMapEntryFirst; ppEntry < ppDbxCustObjMapEntryLast;
         ppEntry++)
    {
      if (*ppEntry != NULL)
      {
  ...
  virtual GcRx::AppRetCode On_kCfgMsg(void* pkt)
  {
    return (GcRx::kRetOK);
  }
  virtual GcRx::AppRetCode On_kEndMsg(void* pkt)
  {
    return (GcRx::kRetOK);
  }
  virtual GcRx::AppRetCode On_kQuitMsg(void* pkt)
  {
    return (GcRx::kRetOK);
  }
  virtual GcRx::AppRetCode On_kSaveMsg(void* pkt)
  {
    return (GcRx::kRetOK);
  }
  virtual GcRx::AppRetCode On_kDependencyMsg(void* pkt)
  {
    return (GcRx::kRetOK);
  }
  virtual GcRx::AppRetCode On_kNoDependencyMsg(void* pkt)
  {
    return (GcRx::kRetOK);
  }
  virtual GcRx::AppRetCode On_kOleUnloadAppMsg(void* pkt)
  {
    return (GcRx::kRetOK);
  }
  virtual GcRx::AppRetCode On_kPreQuitMsg(void* pkt)
  {
    return (GcRx::kRetOK);
  }
  virtual GcRx::AppRetCode On_kInitDialogMsg(void* pkt)
  {
    return (GcRx::kRetOK);
  }
  virtual GcRx::AppRetCode On_kEndDialogMsg(void* pkt)
  {
    return (GcRx::kRetOK);
  }
  virtual GcRx::AppRetCode On_kNullMsg(void* pkt)
  {
    return (GcRx::kRetOK);
  }
...
private:
  void DeleteClassAndDescendant(_DBX_REGISTER_OBJECT_ENTRY** ppEntry)
  {
    _DBX_REGISTER_OBJECT_ENTRY** ppDbxCustObjMapEntryFirst = &__pDbxCustObjMapEntryFirst + 1;
    _DBX_REGISTER_OBJECT_ENTRY** ppDbxCustObjMapEntryLast = &__pDbxCustObjMapEntryLast;
    for (_DBX_REGISTER_OBJECT_ENTRY** ppEntry2 = ppDbxCustObjMapEntryFirst; ppEntry2 < ppDbxCustObjMapEntryLast;
         ppEntry2++)
    {
