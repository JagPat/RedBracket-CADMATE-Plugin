...
protected:
  ...
  Gcad::ErrorStatus subDeepClone(GcDbObject* pOwner,
  ...
  Gcad::ErrorStatus subWblockClone(GcRxObject* pOwnerObject,
                                   GcDbObject*& pClonedObject,
                                   GcDbIdMapping& idMap,
                                   Gsoft::Boolean isPrimary) const override;
  Gcad::ErrorStatus subHighlight(const GcDbFullSubentPath& subId, const Gsoft::Boolean highlightAll) const override;
  Gcad::ErrorStatus subUnhighlight(const GcDbFullSubentPath& subId, const Gsoft::Boolean highlightAll) const override;
...
private:
  ...
  Gcad::ErrorStatus baseDeepClone(GcDbObject* pOwner,
                                  GcDbObject*& pClonedObject,
                                  GcDbIdMapping& idMap,
                                  Gsoft::Boolean isPrimary) const;
  Gcad::ErrorStatus baseWblockClone(GcRxObject* pOwnerObject,
                                    GcDbObject*& pClonedObject,
                                    GcDbIdMapping& idMap,
                                    Gsoft::Boolean isPrimary) const;
  Gcad::ErrorStatus baseHighlight(const GcDbFullSubentPath& subId, const Gsoft::Boolean highlightAll) const;
  Gcad::ErrorStatus baseUnhighlight(const GcDbFullSubentPath& subId, const Gsoft::Boolean highlightAll) const;
