...
public:
  ...
  GcDbIdPair(GcDbObjectId key, GcDbObjectId value, bool isCloned, bool isPrimary = false, bool isOwnerXlated = true);
...
inline GcDbObjectId GcDbIdPair::key() const
{
  return mKey;
}

inline GcDbObjectId GcDbIdPair::value() const
{
  return mValue;
}

inline bool GcDbIdPair::isCloned() const
{
  return mIsCloned;
}

inline bool GcDbIdPair::isPrimary() const
{
  return mIsPrimary;
}

inline bool GcDbIdPair::isOwnerXlated() const
{
  return mIsOwnerXlated;
}

inline void GcDbIdPair::setKey(GcDbObjectId key)
{
  mKey = key;
}

inline void GcDbIdPair::setValue(GcDbObjectId value)
{
  mValue = value;
}

inline void GcDbIdPair::setIsCloned(bool isCloned)
{
  mIsCloned = isCloned;
}

inline void GcDbIdPair::setIsPrimary(bool isPrimary)
{
  mIsPrimary = isPrimary;
}

inline void GcDbIdPair::setIsOwnerXlated(bool isOwnerXlated)
{
