...
public:
  ...
  Gcad::ErrorStatus appendLoop(Gsoft::Int32 loopType, const GcGePoint2dArray& vertices, const GcGeDoubleArray& bulges);
  ...
  Gcad::ErrorStatus appendLoop(Gsoft::Int32 loopType, const GcDbObjectIdArray& dbObjIds);
  Gcad::ErrorStatus insertLoopAt(int loopIndex, Gsoft::Int32 loopType, const GcDbObjectIdArray& dbObjIds);
  ...
  Gcad::ErrorStatus getGradientColors(unsigned int& count, GcCmColor*& colors, float*& values);
  ...
  Gcad::ErrorStatus getHatchLineDataAt(int index, GcGePoint2d& startPt, GcGePoint2d& endPt) const;
  Gcad::ErrorStatus getHatchLinesData(GcGePoint2dArray& startPts, GcGePoint2dArray& endPts) const;
